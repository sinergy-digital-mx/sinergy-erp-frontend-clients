...
} from "./chunk-C3CATDP4.js";
import {
  ContractService
} from "./chunk-AAL553UD.js";
import {
  MatTooltip,
  MatTooltipModule
...
import {
  ...
  PropertyService
} from "./chunk-PTG6FPDF.js";
import "./chunk-WDAA42IK.js";
import "./chunk-CQ4BUXG7.js";
import "./chunk-CEL5SWQJ.js";
import "./chunk-5BEAUDFQ.js";
import {
  UserService
} from "./chunk-PJSUQ4Q5.js";
import {
  PERMISSIONS
} from "./chunk-KTMOHJXS.js";
...
import {
  ...
  Tag,
  TagModule
} from "./chunk-SXZRT6OC.js";
import "./chunk-K674FK3S.js";
import "./chunk-DK3SGZQP.js";
import {
  SelectComponent
} from "./chunk-DFLPJ3H7.js";
import {
  PrimeTemplate
} from "./chunk-UHGPMTU3.js";
import {
  InterceptorService
} from "./chunk-FWSYL4PU.js";
import {
  MAT_DIALOG_DATA,
  MatDialog,
  MatDialogModule,
...
// src/app/features/customers/components/customer-sales-orders/customer-sales-orders.component.ts
var _forTrack0 = ($index, $item) => $item.id;
function CustomerSalesOrdersComponent_app_button_4_Template(rf, ctx) {
  if (rf & 1) {
    const _r1 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "app-button", 6);
    \u0275\u0275listener("clicked", function CustomerSalesOrdersComponent_app_button_4_Template_app_button_clicked_0_listener() {
      \u0275\u0275restoreView(_r1);
      const ctx_r1 = \u0275\u0275nextContext();
  ...
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext();
    \u0275\u0275property("fullWidth", false)("icon", ctx_r1.PlusIcon);
  }
}
function CustomerSalesOrdersComponent_Conditional_5_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 4)(1, "p", 7);
    \u0275\u0275text(2, "Cargando \xF3rdenes de venta...");
    \u0275\u0275elementEnd()();
  }
}
function CustomerSalesOrdersComponent_Conditional_6_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 5)(1, "p", 8);
    \u0275\u0275text(2, "No hay \xF3rdenes de venta para este cliente");
    \u0275\u0275elementEnd()();
  }
}
function CustomerSalesOrdersComponent_Conditional_7_For_18_Template(rf, ctx) {
  if (rf & 1) {
    const _r3 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "tr", 16);
    \u0275\u0275listener("click", function CustomerSalesOrdersComponent_Conditional_7_For_18_Template_tr_click_0_listener() {
      const order_r4 = \u0275\u0275restoreView(_r3).$implicit;
      const ctx_r1 = \u0275\u0275nextContext(2);
      return \u0275\u0275resetView(ctx_r1.openOrderDetail(order_r4));
    });
    \u0275\u0275elementStart(1, "td", 17)(2, "span", 18);
    \u0275\u0275text(3);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(4, "td", 19);
    \u0275\u0275text(5);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(6, "td", 17)(7, "span", 20);
    \u0275\u0275text(8);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(9, "td", 21);
    \u0275\u0275text(10);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(11, "td", 17)(12, "span", 20);
    \u0275\u0275text(13);
    \u0275\u0275elementEnd()();
  ...
  if (rf & 2) {
    ...
    const ctx_r1 = \u0275\u0275nextContext(2);
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate1(" ", order_r4.folio || order_r4.id.substring(0, 8), " ");
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate((order_r4.warehouse == null ? null : order_r4.warehouse.name) || "\u2014");
    \u0275\u0275advance(2);
    \u0275\u0275property("ngClass", ctx_r1.getStatusClass(ctx_r1.getOrderStatus(order_r4)));
    \u0275\u0275advance();
    \u0275\u0275textInterpolate(ctx_r1.getOrderStatus(order_r4));
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate(ctx_r1.formatCurrency(ctx_r1.getOrderTotal(order_r4)));
    \u0275\u0275advance(2);
    \u0275\u0275property("ngClass", ctx_r1.getPaymentStatusClass(order_r4.payment_status));
    \u0275\u0275advance();
    \u0275\u0275textInterpolate(order_r4.payment_status || "\u2014");
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate(\u0275\u0275pipeBind2(16, 8, order_r4.created_at, "medium"));
  }
}
function CustomerSalesOrdersComponent_Conditional_7_Conditional_19_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275listener("click", function CustomerSalesOrdersComponent_Conditional_7_Conditional_19_Template_button_click_4_listener($event) {
      \u0275\u0275restoreView(_r5);
      const ctx_r1 = \u0275\u0275nextContext(2);
      ctx_r1.goToPrevPage();
    ...
    \u0275\u0275listener("click", function CustomerSalesOrdersComponent_Conditional_7_Conditional_19_Template_button_click_6_listener($event) {
      \u0275\u0275restoreView(_r5);
      const ctx_r1 = \u0275\u0275nextContext(2);
      ctx_r1.goToNextPage();
      return \u0275\u0275resetView($event.stopPropagation());
  ...
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext(2);
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate3("", ctx_r1.total(), " orden(es) \xB7 P\xE1gina ", ctx_r1.page(), " de ", ctx_r1.totalPages);
    \u0275\u0275advance(2);
    \u0275\u0275property("disabled", !ctx_r1.hasPrevPage);
    \u0275\u0275advance(2);
    \u0275\u0275property("disabled", !ctx_r1.hasNextPage);
  }
}
function CustomerSalesOrdersComponent_Conditional_7_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 9)(1, "table", 10)(2, "thead", 11)(3, "tr")(4, "th", 12);
    \u0275\u0275text(5, "Folio");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(6, "th", 12);
    \u0275\u0275text(7, "Almac\xE9n");
    \u0275\u0275elementEnd();
    ...
    \u0275\u0275repeaterCreate(17, CustomerSalesOrdersComponent_Conditional_7_For_18_Template, 17, 11, "tr", 14, _forTrack0);
    \u0275\u0275elementEnd()()();
    \u0275\u0275conditionalCreate(19, CustomerSalesOrdersComponent_Conditional_7_Conditional_19_Template, 8, 5, "div", 15);
  }
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext();
    \u0275\u0275advance(17);
...
var CustomerSalesOrdersComponent = class _CustomerSalesOrdersComponent {
  salesOrderService;
  taxCalculator;
  dialog;
  interceptorService;
  ...
  createSalesOrderPermissions = [
    PERMISSIONS.salesOrders.create,
    "salesOrders:Create"
  ];
  constructor(salesOrderService, taxCalculator, dialog, interceptorService) {
  ...
  loadOrders(page = 1) {
    this.loading.set(true);
    this.page.set(page);
    const filters = { customer_id: this.customerId };
    const pagination = { page, limit: this.pageSize };
    this.salesOrderService.getOrders(filters, pagination).subscribe({
      ...
      error: () => {
        ...
        this.interceptorService.openSnackbar({
          type: "error",
          title: "Error",
          message: "No se pudieron cargar las \xF3rdenes de venta"
        });
      }
    });
  }
  ...
  static \u0275fac = function CustomerSalesOrdersComponent_Factory(__ngFactoryType__) {
    return new (__ngFactoryType__ || _CustomerSalesOrdersComponent)(\u0275\u0275directiveInject(SalesOrderService), \u0275\u0275directiveInject(TaxCalculatorService), \u0275\u0275directiveInject(MatDialog), \u0275\u0275directiveInject(InterceptorService));
  };
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _CustomerSalesOrdersComponent, selectors: [["app-customer-sales-orders"]], inputs: { customerId: "customerId" }, decls: 8, vars: 3, consts: [[1, "bg-white", "shadow-md", "rounded-xl", "p-6", "border", "border-gray-100"], [1, "flex", "items-center", "justify-between", "mb-4"], [1, "text-lg", "font-semibold", "text-gray-800"], ["text", "Nueva orden", "variant", "primary", "size", "sm", 3, "fullWidth", "icon", "clicked", 4, "hasPermission", "hasPermissionMode"], [1, "text-center", "py-8"], [1, "text-center", "py-8", "text-gray-500"], ["text", "Nueva orden", "variant", "primary", "size", "sm", 3, "clicked", "fullWidth", "icon"], [1, "text-sm", "text-gray-500"], [1, "text-sm"], [1, "overflow-x-auto"], [1, "min-w-full", "divide-y", "divide-gray-200"], [1, "bg-gray-50"], [1, "px-4", "py-3", "text-left", "text-xs", "font-medium", "text-gray-500", "uppercase", "tracking-wider"], [1, "bg-white", "divide-y", "divide-gray-200"], [1, "hover:bg-gray-50", "cursor-pointer"], [1, "flex", "items-center", "justify-between", "mt-4", "pt-4", "border-t", "border-gray-100", "text-sm", "text-gray-600"], [1, "hover:bg-gray-50", "cursor-pointer", 3, "click"], [1, "px-4", "py-3", "whitespace-nowrap"], [1, "inline-flex", "items-center", "px-2", "py-1", "rounded", "text-xs", "font-medium", "bg-indigo-100", "text-indigo-800", "hover:bg-indigo-200", "transition-colors"], [1, "px-4", "py-3", "text-sm", "text-gray-900"], [3, "ngClass"], [1, "px-4", "py-3", "text-sm", "font-medium", "text-gray-900"], [1, "px-4", "py-3", "text-sm", "text-gray-600"], [1, "flex", "gap-2"], ["type", "button", 1, "px-3", "py-1", "rounded", "border", "border-gray-300", "disabled:opacity-50", "hover:bg-gray-50", 3, "click", "disabled"]], template: function CustomerSalesOrdersComponent_Template(rf, ctx) {
    if (rf & 1) {
      \u0275\u0275elementStart(0, "div", 0)(1, "div", 1)(2, "h3", 2);
      \u0275\u0275text(3, "\xD3rdenes de Venta");
      \u0275\u0275elementEnd();
      \u0275\u0275template(4, CustomerSalesOrdersComponent_app_button_4_Template, 1, 2, "app-button", 3);
      \u0275\u0275elementEnd();
      \u0275\u0275conditionalCreate(5, CustomerSalesOrdersComponent_Conditional_5_Template, 3, 0, "div", 4)(6, CustomerSalesOrdersComponent_Conditional_6_Template, 3, 0, "div", 5)(7, CustomerSalesOrdersComponent_Conditional_7_Template, 20, 1);
      \u0275\u0275elementEnd();
    }
    if (rf & 2) {
      \u0275\u0275advance(4);
      \u0275\u0275property("hasPermission", ctx.createSalesOrderPermissions)("hasPermissionMode", "any");
      \u0275\u0275advance();
      \u0275\u0275conditional(ctx.loading() ? 5 : ctx.orders().length === 0 ? 6 : 7);
    }
  }, dependencies: [CommonModule, NgClass, ButtonComponent, HasPermissionDirective, DatePipe], styles: ["\n\n[_nghost-%COMP%] {\n  display: block;\n}\n/*# sourceMappingURL=customer-sales-orders.component.css.map */"] });
};
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && setClassMetadata(CustomerSalesOrdersComponent, [{
    type: Component,
    args: [{ selector: "app-customer-sales-orders", standalone: true, imports: [CommonModule, ButtonComponent, HasPermissionDirective], template: `<div class="bg-white shadow-md rounded-xl p-6 border border-gray-100">\r
  <div class="flex items-center justify-between mb-4">\r
    <h3 class="text-lg font-semibold text-gray-800">\xD3rdenes de Venta</h3>\r
    <app-button\r
      *hasPermission="createSalesOrderPermissions; mode: 'any'"\r
      text="Nueva orden"\r
      variant="primary"\r
      size="sm"\r
      [fullWidth]="false"\r
...
\r
  @if (loading()) {\r
    <div class="text-center py-8">\r
      <p class="text-sm text-gray-500">Cargando \xF3rdenes de venta...</p>\r
    </div>\r
  } @else if (orders().length === 0) {\r
    <div class="text-center py-8 text-gray-500">\r
      <p class="text-sm">No hay \xF3rdenes de venta para este cliente</p>\r
    </div>\r
  } @else {\r
    <div class="overflow-x-auto">\r
      <table class="min-w-full divide-y divide-gray-200">\r
        <thead class="bg-gray-50">\r
          <tr>\r
            <th class="px-4 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Folio</th>\r
            ...
            <th class="px-4 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Total</th>\r
            <th class="px-4 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Pago</th>\r
            <th class="px-4 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Fecha</th>\r
          </tr>\r
        </thead>\r
        <tbody class="bg-white divide-y divide-gray-200">\r
          @for (order of orders(); track order.id) {\r
            <tr class="hover:bg-gray-50 cursor-pointer" (click)="openOrderDetail(order)">\r
              <td class="px-4 py-3 whitespace-nowrap">\r
                <span\r
                  class="inline-flex items-center px-2 py-1 rounded text-xs font-medium bg-indigo-100 text-indigo-800 hover:bg-indigo-200 transition-colors">\r
                  {{ order.folio || order.id.substring(0, 8) }}\r
                </span>\r
              </td>\r
              <td class="px-4 py-3 text-sm text-gray-900">{{ order.warehouse?.name || '\u2014' }}</td>\r
              <td class="px-4 py-3 whitespace-nowrap">\r
                <span [ngClass]="getStatusClass(getOrderStatus(order))">{{ getOrderStatus(order) }}</span>\r
              </td>\r
              <td class="px-4 py-3 text-sm font-medium text-gray-900">{{ formatCurrency(getOrderTotal(order)) }}</td>\r
              <td class="px-4 py-3 whitespace-nowrap">\r
                <span [ngClass]="getPaymentStatusClass(order.payment_status)">{{ order.payment_status || '\u2014' }}</span>\r
              </td>\r
              <td class="px-4 py-3 text-sm text-gray-600">{{ order.created_at | date:'medium' }}</td>\r
            </tr>\r
          }\r
        </tbody>\r
      </table>\r
...
\r
    @if (totalPages > 1) {\r
      <div class="flex items-center justify-between mt-4 pt-4 border-t border-gray-100 text-sm text-gray-600">\r
        <span>{{ total() }} orden(es) \xB7 P\xE1gina {{ page() }} de {{ totalPages }}</span>\r
        <div class="flex gap-2">\r
          <button\r
            type="button"\r
            class="px-3 py-1 rounded border border-gray-300 disabled:opacity-50 hover:bg-gray-50"\r
            [disabled]="!hasPrevPage"\r
            (click)="goToPrevPage(); $event.stopPropagation()">\r
            Anterior\r
          </button>\r
          <button\r
            type="button"\r
            class="px-3 py-1 rounded border border-gray-300 disabled:opacity-50 hover:bg-gray-50"\r
            [disabled]="!hasNextPage"\r
            (click)="goToNextPage(); $event.stopPropagation()">\r
            Siguiente\r
          </button>\r
        </div>\r
      </div>\r
...
`, styles: ["/* src/app/features/customers/components/customer-sales-orders/customer-sales-orders.component.scss */\n:host {\n  display: block;\n}\n/*# sourceMappingURL=customer-sales-orders.component.css.map */\n"] }]
  }], () => [{ type: SalesOrderService }, { type: TaxCalculatorService }, { type: MatDialog }, { type: InterceptorService }], { customerId: [{
    type: Input,
    args: [{ required: true }]
  }] });
})();
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(CustomerSalesOrdersComponent, { className: "CustomerSalesOrdersComponent", filePath: "src/app/features/customers/components/customer-sales-orders/customer-sales-orders.component.ts", lineNumber: 23 });
})();
...
var _c12 = ["leadAutocompleteTrigger"];
var _c22 = (a0, a1, a2, a3) => ({ "bg-green-100 text-green-800": a0, "bg-blue-100 text-blue-800": a1, "bg-red-100 text-red-800": a2, "bg-yellow-100 text-yellow-800": a3 });
...
function ContractDetailModalComponent_span_11_Template(rf, ctx) {
  if (rf & 1) {
...
function ContractDetailModalComponent_Conditional_39_Template(rf, ctx) {
  if (rf & 1) {
  ...
  if (rf & 2) {
    const ctx_r2 = \u0275\u0275nextContext();
    \u0275\u0275advance();
    \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind2(2, 2, ctx_r2.data.contract.down_payment, ctx_r2.data.contract.currency), " ");
    \u0275\u0275advance(4);
    \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind2(6, 5, ctx, ctx_r2.data.contract.currency), " ");
  }
}
function ContractDetailModalComponent_Conditional_40_Template(rf, ctx) {
  if (rf & 1) {
  ...
  if (rf & 2) {
    const ctx_r2 = \u0275\u0275nextContext();
    \u0275\u0275advance();
    \u0275\u0275textInterpolate(\u0275\u0275pipeBind2(2, 1, ctx_r2.data.contract.down_payment, ctx_r2.data.contract.currency));
  }
}
function ContractDetailModalComponent_span_50_Template(rf, ctx) {
  if (rf & 1) {
...
function ContractDetailModalComponent_div_81_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 74)(1, "div", 75)(2, "div")(3, "span", 76);
    ...
    \u0275\u0275pipe(7, "currency");
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(8, "div")(9, "span", 76);
    \u0275\u0275text(10, "Abonado");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(11, "span", 77);
    \u0275\u0275text(12);
    \u0275\u0275pipe(13, "currency");
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(14, "div")(15, "span", 76);
    \u0275\u0275text(16, "Meses cuotas");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(17, "span", 77);
    \u0275\u0275text(18);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(19, "div")(20, "span", 76);
  ...
  if (rf & 2) {
    const ctx_r2 = \u0275\u0275nextContext();
    \u0275\u0275advance(6);
    \u0275\u0275textInterpolate1(" ", ctx_r2.data.contract.down_payment_target != null ? \u0275\u0275pipeBind2(7, 5, ctx_r2.data.contract.down_payment_target, ctx_r2.data.contract.currency) : "Sin definir", " ");
    \u0275\u0275advance(6);
    \u0275\u0275textInterpolate(\u0275\u0275pipeBind2(13, 8, ctx_r2.data.contract.down_payment, ctx_r2.data.contract.currency));
    \u0275\u0275advance(6);
    \u0275\u0275textInterpolate(ctx_r2.data.contract.down_payment_months || "\u2014");
    \u0275\u0275advance(5);
    \u0275\u0275textInterpolate2(" ", ctx_r2.data.contract.down_payment_first_payment_date ? \u0275\u0275pipeBind2(24, 11, ctx_r2.data.contract.down_payment_first_payment_date, "mediumDate") : "\u2014", " / ", ctx_r2.data.contract.down_payment_payment_day || "\u2014", " ");
  }
}
function ContractDetailModalComponent_span_92_Template(rf, ctx) {
  if (rf & 1) {
    const _r4 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "span", 78);
    \u0275\u0275listener("click", function ContractDetailModalComponent_span_92_Template_span_click_0_listener() {
      \u0275\u0275restoreView(_r4);
      const ctx_r2 = \u0275\u0275nextContext();
...
function ContractDetailModalComponent_span_93_Template(rf, ctx) {
  if (rf & 1) {
...
function ContractDetailModalComponent_button_100_Template(rf, ctx) {
  if (rf & 1) {
    const _r5 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "button", 80);
    \u0275\u0275listener("click", function ContractDetailModalComponent_button_100_Template_button_click_0_listener() {
      \u0275\u0275restoreView(_r5);
      const ctx_r2 = \u0275\u0275nextContext();
...
function ContractDetailModalComponent_mat_option_103_Template(rf, ctx) {
  if (rf & 1) {
    const _r6 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "mat-option", 81);
    \u0275\u0275listener("click", function ContractDetailModalComponent_mat_option_103_Template_mat_option_click_0_listener() {
...
function ContractDetailModalComponent_mat_option_104_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "mat-option", 82)(1, "span", 83);
    \u0275\u0275text(2, "No se encontraron vendedores");
    \u0275\u0275elementEnd()();
  }
}
function ContractDetailModalComponent_mat_option_114_Template(rf, ctx) {
  if (rf & 1) {
    const _r8 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "mat-option", 81);
    \u0275\u0275listener("click", function ContractDetailModalComponent_mat_option_114_Template_mat_option_click_0_listener() {
      const lead_r9 = \u0275\u0275restoreView(_r8).$implicit;
      const ctx_r2 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r2.onLeadSelected(lead_r9));
    });
    \u0275\u0275text(1);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    ...
    const ctx_r2 = \u0275\u0275nextContext();
    \u0275\u0275property("value", lead_r9);
    \u0275\u0275advance();
    \u0275\u0275textInterpolate1(" ", ctx_r2.displayLead(lead_r9), " ");
  }
}
function ContractDetailModalComponent_app_button_151_Template(rf, ctx) {
  if (rf & 1) {
    const _r10 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "app-button", 84);
    \u0275\u0275listener("clicked", function ContractDetailModalComponent_app_button_151_Template_app_button_clicked_0_listener() {
      \u0275\u0275restoreView(_r10);
      const ctx_r2 = \u0275\u0275nextContext();
  ...
  if (rf & 2) {
    const ctx_r2 = \u0275\u0275nextContext();
    \u0275\u0275property("customClass", "btn_primary")("fullWidth", false)("loading", ctx_r2.saving());
  }
}
var ContractDetailModalComponent = class _ContractDetailModalComponent {
  ...
  contractListNeedsRefresh = false;
  ...
  constructor(dialog, dialog_ref, data, router, propertyService, contractService, paymentService, userService, interceptorService, fb, cdr, leadService) {
    this.dialog = dialog;
  ...
  loadContractDetails() {
    this.contractService.getContract(this.data.contract.id).subscribe({
      next: (contract) => {
        ...
        this.data.contract = __spreadProps(__spreadValues({}, contract), { status: normalizedStatus });
        if (contract.seller) {
  ...
  initializeLeadSearch() {
    this.form.get("lead_search").valueChanges.pipe(debounceTime(300), distinctUntilChanged()).subscribe((searchTerm) => this.filterLeads(searchTerm || ""));
  }
  ...
  closeDialog() {
    this.dialog_ref.close(this.contractListNeedsRefresh ? true : void 0);
  }
  navigateToCustomer() {
...
\u2022 Todos los documentos asociados`;
  ...
  static \u0275fac = function ContractDetailModalComponent_Factory(__ngFactoryType__) {
    return new (__ngFactoryType__ || _ContractDetailModalComponent)(\u0275\u0275directiveInject(MatDialog), \u0275\u0275directiveInject(MatDialogRef), \u0275\u0275directiveInject(MAT_DIALOG_DATA), \u0275\u0275directiveInject(Router), \u0275\u0275directiveInject(PropertyService), \u0275\u0275directiveInject(ContractService), \u0275\u0275directiveInject(PaymentService), \u0275\u0275directiveInject(UserService), \u0275\u0275directiveInject(InterceptorService), \u0275\u0275directiveInject(FormBuilder), \u0275\u0275directiveInject(ChangeDetectorRef), \u0275\u0275directiveInject(LeadService));
  };
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _ContractDetailModalComponent, selectors: [["app-contract-detail-modal"]], viewQuery: function ContractDetailModalComponent_Query(rf, ctx) {
    if (rf & 1) {
      \u0275\u0275viewQuery(_c03, 5, MatAutocompleteTrigger)(_c12, 5, MatAutocompleteTrigger);
    }
    if (rf & 2) {
      let _t;
    ...
    if (rf & 1) {
      ...
      \u0275\u0275pipe(8, "titlecase");
      \u0275\u0275elementEnd();
      \u0275\u0275template(9, ContractDetailModalComponent_span_9_Template, 2, 0, "span", 9)(10, ContractDetailModalComponent_span_10_Template, 2, 1, "span", 10)(11, ContractDetailModalComponent_span_11_Template, 2, 0, "span", 11);
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(12, "div", 12)(13, "span", 13)(14, "span", 14);
      \u0275\u0275text(15, "Creado:");
      \u0275\u0275elementEnd();
      \u0275\u0275text(16);
      \u0275\u0275pipe(17, "date");
      ...
      \u0275\u0275text(20, "Actualizado:");
      \u0275\u0275elementEnd();
      \u0275\u0275text(21);
      \u0275\u0275pipe(22, "date");
      \u0275\u0275elementEnd()();
      \u0275\u0275elementStart(23, "div", 15)(24, "div")(25, "span", 16);
      \u0275\u0275text(26, "Fecha Contrato");
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(27, "span", 17);
      \u0275\u0275text(28);
      \u0275\u0275pipe(29, "localDate");
      \u0275\u0275elementEnd()();
      \u0275\u0275elementStart(30, "div")(31, "span", 16);
      \u0275\u0275text(32, "Precio Total");
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(33, "span", 17);
      \u0275\u0275text(34);
      \u0275\u0275pipe(35, "currency");
      \u0275\u0275elementEnd()();
      \u0275\u0275elementStart(36, "div")(37, "span", 16);
      \u0275\u0275text(38, "Enganche");
      \u0275\u0275elementEnd();
      \u0275\u0275conditionalCreate(39, ContractDetailModalComponent_Conditional_39_Template, 9, 8)(40, ContractDetailModalComponent_Conditional_40_Template, 3, 4, "span", 17);
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(41, "div")(42, "span", 16);
      \u0275\u0275text(43, "Total Pagado");
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(44, "span", 18);
      \u0275\u0275text(45);
      \u0275\u0275pipe(46, "currency");
      \u0275\u0275elementEnd()();
      \u0275\u0275elementStart(47, "div")(48, "span", 19);
      \u0275\u0275text(49, " Saldo Pendiente ");
      \u0275\u0275template(50, ContractDetailModalComponent_span_50_Template, 2, 1, "span", 20);
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(51, "span", 21);
      \u0275\u0275text(52);
      \u0275\u0275pipe(53, "currency");
      \u0275\u0275elementEnd()();
      \u0275\u0275elementStart(54, "div")(55, "span", 16);
      \u0275\u0275text(56, "Meses de Pago");
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(57, "span", 17);
      \u0275\u0275text(58);
      \u0275\u0275elementEnd()();
      \u0275\u0275elementStart(59, "div")(60, "span", 16);
      \u0275\u0275text(61, "Pago Mensual");
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(62, "span", 17);
      \u0275\u0275text(63);
      \u0275\u0275pipe(64, "currency");
      \u0275\u0275elementEnd()()()();
      \u0275\u0275elementStart(65, "lucide-icon", 22);
      \u0275\u0275listener("click", function ContractDetailModalComponent_Template_lucide_icon_click_65_listener() {
        \u0275\u0275restoreView(_r1);
        return \u0275\u0275resetView(ctx.closeDialog());
      });
      \u0275\u0275elementEnd()();
      \u0275\u0275elementStart(66, "div", 23)(67, "button", 24);
      \u0275\u0275listener("click", function ContractDetailModalComponent_Template_button_click_67_listener() {
        \u0275\u0275restoreView(_r1);
      ...
      \u0275\u0275listener("click", function ContractDetailModalComponent_Template_button_click_69_listener() {
        \u0275\u0275restoreView(_r1);
      ...
      \u0275\u0275listener("click", function ContractDetailModalComponent_Template_button_click_71_listener() {
        \u0275\u0275restoreView(_r1);
        return \u0275\u0275resetView(ctx.setActiveTab("down_payments"));
      });
      \u0275\u0275text(72, " Enganche en Pagos ");
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(73, "button", 24);
      \u0275\u0275listener("click", function ContractDetailModalComponent_Template_button_click_73_listener() {
        \u0275\u0275restoreView(_r1);
      ...
      \u0275\u0275listener("click", function ContractDetailModalComponent_Template_button_click_75_listener() {
        \u0275\u0275restoreView(_r1);
        return \u0275\u0275resetView(ctx.setActiveTab("documents"));
      });
      \u0275\u0275text(76, " Documentos ");
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(77, "button", 24);
      \u0275\u0275listener("click", function ContractDetailModalComponent_Template_button_click_77_listener() {
        \u0275\u0275restoreView(_r1);
        return \u0275\u0275resetView(ctx.setActiveTab("statement"));
      });
      \u0275\u0275text(78, " Estado de Cuenta ");
      \u0275\u0275elementEnd()();
      \u0275\u0275elementStart(79, "div", 25)(80, "div", 26);
      \u0275\u0275template(81, ContractDetailModalComponent_div_81_Template, 25, 14, "div", 27);
      \u0275\u0275elementStart(82, "div", 28)(83, "div", 29)(84, "div")(85, "span", 30);
      \u0275\u0275text(86, "N\xFAmero de Contrato");
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(87, "span", 31);
      \u0275\u0275text(88);
      \u0275\u0275elementEnd()();
      \u0275\u0275elementStart(89, "div")(90, "span", 30);
      \u0275\u0275text(91, "Lote");
      \u0275\u0275elementEnd();
      \u0275\u0275template(92, ContractDetailModalComponent_span_92_Template, 2, 1, "span", 32)(93, ContractDetailModalComponent_span_93_Template, 2, 0, "span", 33);
      \u0275\u0275elementEnd()();
      \u0275\u0275elementStart(94, "div")(95, "label", 34);
      \u0275\u0275text(96, "Vendido Por");
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(97, "div", 35)(98, "input", 36, 0);
      \u0275\u0275listener("focus", function ContractDetailModalComponent_Template_input_focus_98_listener() {
        \u0275\u0275restoreView(_r1);
        return \u0275\u0275resetView(ctx.onSellerSearchFocus());
      })("blur", function ContractDetailModalComponent_Template_input_blur_98_listener() {
        \u0275\u0275restoreView(_r1);
        return \u0275\u0275resetView(ctx.onSellerSearchBlur());
      });
      \u0275\u0275elementEnd();
      \u0275\u0275template(100, ContractDetailModalComponent_button_100_Template, 2, 0, "button", 37);
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(101, "mat-autocomplete", null, 1);
      \u0275\u0275template(103, ContractDetailModalComponent_mat_option_103_Template, 2, 2, "mat-option", 38)(104, ContractDetailModalComponent_mat_option_104_Template, 3, 0, "mat-option", 39);
      \u0275\u0275elementEnd()();
      \u0275\u0275elementStart(105, "div", 29);
      \u0275\u0275element(106, "app-group-select", 40);
      \u0275\u0275elementStart(107, "div")(108, "label", 41);
      \u0275\u0275text(109, "Lead vinculado");
      \u0275\u0275elementEnd();
      \u0275\u0275element(110, "input", 42, 2);
      \u0275\u0275elementStart(112, "mat-autocomplete", 43, 3);
      \u0275\u0275template(114, ContractDetailModalComponent_mat_option_114_Template, 2, 2, "mat-option", 38);
      \u0275\u0275elementEnd()()();
      \u0275\u0275elementStart(115, "div", 29)(116, "div")(117, "span", 30);
      \u0275\u0275text(118, "Precio lista del lote");
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(119, "div", 44);
      \u0275\u0275text(120);
      \u0275\u0275elementEnd()();
      \u0275\u0275element(121, "app-input", 45);
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(122, "div", 29);
      \u0275\u0275element(123, "app-input", 46)(124, "app-select", 47)(125, "app-input", 48)(126, "app-input", 49)(127, "app-input", 50)(128, "app-input", 51)(129, "app-input", 52)(130, "app-input", 53);
      \u0275\u0275elementEnd();
      \u0275\u0275element(131, "app-input", 54);
      \u0275\u0275elementEnd()();
      \u0275\u0275elementStart(132, "div", 26)(133, "app-contract-payments", 55);
      \u0275\u0275listener("dataChanged", function ContractDetailModalComponent_Template_app_contract_payments_dataChanged_133_listener() {
        \u0275\u0275restoreView(_r1);
        return \u0275\u0275resetView(ctx.refreshContractData());
      });
      \u0275\u0275elementEnd()();
      \u0275\u0275elementStart(134, "div", 26)(135, "app-contract-downpayment-payments", 56);
      \u0275\u0275listener("dataChanged", function ContractDetailModalComponent_Template_app_contract_downpayment_payments_dataChanged_135_listener() {
        \u0275\u0275restoreView(_r1);
        return \u0275\u0275resetView(ctx.refreshContractData());
      });
      \u0275\u0275elementEnd()();
      \u0275\u0275elementStart(136, "div", 26)(137, "app-contract-hoa-payments", 55);
      \u0275\u0275listener("dataChanged", function ContractDetailModalComponent_Template_app_contract_hoa_payments_dataChanged_137_listener() {
        \u0275\u0275restoreView(_r1);
        return \u0275\u0275resetView(ctx.refreshContractData());
      });
      \u0275\u0275elementEnd()();
      \u0275\u0275elementStart(138, "div", 26);
      \u0275\u0275element(139, "app-contract-documents", 57);
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(140, "div", 26)(141, "div", 58)(142, "div", 59)(143, "p", 60);
      \u0275\u0275text(144, "Descarga el estado de cuenta en formato PDF");
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(145, "button", 61);
      \u0275\u0275listener("click", function ContractDetailModalComponent_Template_button_click_145_listener() {
        \u0275\u0275restoreView(_r1);
        return \u0275\u0275resetView(ctx.downloadStatement());
      });
      \u0275\u0275text(146, " \u{1F4E5} Descargar Estado de Cuenta ");
      \u0275\u0275elementEnd()()()()();
      \u0275\u0275elementStart(147, "div", 62)(148, "div", 63)(149, "app-button", 64);
      \u0275\u0275listener("clicked", function ContractDetailModalComponent_Template_app_button_clicked_149_listener() {
        \u0275\u0275restoreView(_r1);
        return \u0275\u0275resetView(ctx.deleteContract());
      });
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(150, "div", 65);
      \u0275\u0275template(151, ContractDetailModalComponent_app_button_151_Template, 1, 3, "app-button", 66);
      \u0275\u0275elementEnd()()()();
    }
    if (rf & 2) {
      let tmp_15_0;
      let tmp_36_0;
      const autoSeller_r11 = \u0275\u0275reference(102);
      const autoLead_r12 = \u0275\u0275reference(113);
      \u0275\u0275classProp("dialog--wide", ctx.activeTab() === "payments");
      \u0275\u0275advance(5);
      \u0275\u0275textInterpolate1("Contrato ", ctx.data.contract.contract_number);
      \u0275\u0275advance();
      \u0275\u0275property("ngClass", \u0275\u0275pureFunction4(108, _c22, ctx.badgeStatus === "activo", ctx.badgeStatus === "completado", ctx.badgeStatus === "cancelado", ctx.badgeStatus === "suspendido"));
      \u0275\u0275advance();
      \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind1(8, 85, ctx.badgeStatus), " ");
      \u0275\u0275advance(2);
      \u0275\u0275property("ngIf", ctx.data.contract.customer);
      \u0275\u0275advance();
      \u0275\u0275property("ngIf", ctx.data.contract.customer);
      \u0275\u0275advance();
      \u0275\u0275property("ngIf", ctx.data.contract.down_payment_financed);
      \u0275\u0275advance(5);
      \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind2(17, 87, ctx.data.contract.created_at, "medium"), " ");
      \u0275\u0275advance(5);
      \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind2(22, 90, ctx.data.contract.updated_at, "medium"), " ");
      \u0275\u0275advance(7);
      \u0275\u0275textInterpolate(\u0275\u0275pipeBind2(29, 93, ctx.data.contract.contract_date, "mediumDate"));
      \u0275\u0275advance(6);
      \u0275\u0275textInterpolate(\u0275\u0275pipeBind2(35, 96, ctx.data.contract.total_price, ctx.data.contract.currency));
      \u0275\u0275advance(5);
      \u0275\u0275conditional((tmp_15_0 = ctx.getDownPaymentTarget(ctx.data.contract)) ? 39 : 40, tmp_15_0);
      \u0275\u0275advance(6);
      \u0275\u0275textInterpolate(\u0275\u0275pipeBind2(46, 99, ctx.data.contract.total_price - ctx.data.contract.remaining_balance, ctx.data.contract.currency));
      \u0275\u0275advance(5);
      \u0275\u0275property("ngIf", ctx.paymentStats());
      \u0275\u0275advance(2);
      \u0275\u0275textInterpolate(\u0275\u0275pipeBind2(53, 102, ctx.data.contract.remaining_balance, ctx.data.contract.currency));
      \u0275\u0275advance(6);
      \u0275\u0275textInterpolate1("", ctx.data.contract.payment_months, " meses");
      \u0275\u0275advance(5);
      \u0275\u0275textInterpolate(\u0275\u0275pipeBind2(64, 105, ctx.data.contract.monthly_payment, ctx.data.contract.currency));
      \u0275\u0275advance(2);
      ...
      \u0275\u0275property("ngIf", !ctx.data.contract.property);
      \u0275\u0275advance(5);
      \u0275\u0275property("placeholder", ctx.data.contract.seller ? "Buscar nuevo vendedor..." : "Buscar por nombre o email")("matAutocomplete", autoSeller_r11);
      \u0275\u0275advance(2);
      \u0275\u0275property("ngIf", ctx.data.contract.seller && ((tmp_36_0 = ctx.form.get("seller_search")) == null ? null : tmp_36_0.value));
      \u0275\u0275advance(3);
      ...
      \u0275\u0275advance(4);
      \u0275\u0275property("matAutocomplete", autoLead_r12);
      \u0275\u0275advance(2);
      ...
      \u0275\u0275advance();
      \u0275\u0275property("form_control", ctx.form.controls["list_price"]);
      \u0275\u0275advance(2);
      ...
      \u0275\u0275classProp("active", ctx.activeTab() === "payments");
      \u0275\u0275advance();
      \u0275\u0275property("contractId", ctx.data.contract.id)("currency", ctx.data.contract.currency)("contractStatus", ctx.data.contract.status)("contract", ctx.data.contract);
      \u0275\u0275advance();
      \u0275\u0275classProp("active", ctx.activeTab() === "down_payments");
      \u0275\u0275advance();
      \u0275\u0275property("contractId", ctx.data.contract.id)("currency", ctx.data.contract.currency)("contract", ctx.data.contract);
      \u0275\u0275advance();
      \u0275\u0275classProp("active", ctx.activeTab() === "hoa");
      \u0275\u0275advance();
      \u0275\u0275property("contractId", ctx.data.contract.id)("currency", ctx.data.contract.currency)("contractStatus", ctx.data.contract.status)("contract", ctx.data.contract);
      ...
      \u0275\u0275classProp("active", ctx.activeTab() === "statement");
      \u0275\u0275advance(9);
      \u0275\u0275property("customClass", "btn-outline-danger")("fullWidth", false)("loading", ctx.deleting());
      \u0275\u0275advance(2);
  ...
  <div class="dialog__header">\r
    <div class="flex-1">\r
      <div class="flex items-center gap-2 mb-2">\r
        ...
        <span\r
          *ngIf="data.contract.down_payment_financed"\r
      ...
      <div class="flex items-center gap-2 mb-3 text-xs">\r
        <span class="inline-flex items-center px-2.5 py-1.5 rounded bg-gray-100 text-gray-700">\r
          ...
          {{ data.contract.created_at | date:'medium' }}\r
        </span>\r
        <span class="inline-flex items-center px-2.5 py-1.5 rounded bg-gray-100 text-gray-700">\r
          <span class="font-semibold text-gray-900 mr-1">Actualizado:</span>\r
          {{ data.contract.updated_at | date:'medium' }}\r
        </span>\r
      </div>\r
      \r
      <!-- Stats inline -->\r
      <div class="grid grid-cols-7 gap-3 text-xs pb-3">\r
        ...
        <div>\r
          ...
          @if (getDownPaymentTarget(data.contract); as target) {\r
            <span class="text-gray-900 font-semibold leading-tight">\r
              {{ data.contract.down_payment | currency:data.contract.currency }}\r
              <span class="text-gray-400 font-medium mx-0.5">/</span>\r
              {{ target | currency:data.contract.currency }}\r
            </span>\r
...
\r
  <div class="dialog__body">\r
    ...
    <div class="tab-content" [class.active]="activeTab() === 'edit'">\r
      <div *ngIf="data.contract.down_payment_financed" class="mb-2 p-2 bg-amber-50 rounded-lg border border-amber-200">\r
        <div class="grid grid-cols-4 gap-2 text-xs">\r
          <div>\r
            ...
            <span class="text-amber-900 font-semibold">\r
              {{ data.contract.down_payment_target != null ? (data.contract.down_payment_target | currency:data.contract.currency) : 'Sin definir' }}\r
            </span>\r
          </div>\r
          <div>\r
            <span class="block font-semibold text-amber-700 mb-0.5">Abonado</span>\r
            <span class="text-amber-900 font-semibold">{{ data.contract.down_payment | currency:data.contract.currency }}</span>\r
          </div>\r
          <div>\r
            <span class="block font-semibold text-amber-700 mb-0.5">Meses cuotas</span>\r
            <span class="text-amber-900 font-semibold">{{ data.contract.down_payment_months || '\u2014' }}</span>\r
          </div>\r
          <div>\r
            <span class="block font-semibold text-amber-700 mb-0.5">Primer pago / d\xEDa</span>\r
            <span class="text-amber-900 font-semibold">\r
              {{ data.contract.down_payment_first_payment_date ? (data.contract.down_payment_first_payment_date | localDate:'mediumDate') : '\u2014' }}\r
              / {{ data.contract.down_payment_payment_day || '\u2014' }}\r
            </span>\r
          </div>\r
        </div>\r
      </div>\r
...
\r
          <div>\r
            <label for="lead-search-edit" class="block text-xs font-semibold text-gray-500 mb-1">Lead vinculado</label>\r
            <input\r
              #leadAutocompleteTrigger="matAutocompleteTrigger"\r
              id="lead-search-edit"\r
              type="text"\r
              formControlName="lead_search"\r
              placeholder="Buscar lead (opcional)"\r
              class="w-full rounded-lg border border-gray-300 px-3 py-2 text-sm focus:border-blue-500 focus:outline-none"\r
              [matAutocomplete]="autoLead">\r
            <mat-autocomplete #autoLead="matAutocomplete" [displayWith]="displayLead.bind(this)">\r
              <mat-option *ngFor="let lead of filteredLeads()" [value]="lead" (click)="onLeadSelected(lead)">\r
                {{ displayLead(lead) }}\r
              </mat-option>\r
            </mat-autocomplete>\r
          </div>\r
...
\r
        <div class="grid grid-cols-2 gap-2.5">\r
          <div>\r
            <span class="block text-xs font-semibold text-gray-500 mb-1">Precio lista del lote</span>\r
          ...
          <app-input\r
            ...
            type="number"\r
            [form_control]="form.controls['list_price']">\r
          </app-input>\r
        </div>\r
\r
        <div class="grid grid-cols-2 gap-2.5">\r
...
\r
          <!-- Estado (PUT: status en min\xFAsculas) -->\r
...
\r
    ...
    <div class="tab-content" [class.active]="activeTab() === 'payments'">\r
      <app-contract-payments \r
        ...
        [contractStatus]="data.contract.status"\r
        [contract]="data.contract"\r
...
`, styles: ["/* src/app/features/contracts/components/contract-detail-modal/contract-detail-modal.component.scss */\n.dialog {\n  width: 90vw;\n  max-width: 1400px;\n  height: 90vh;\n  max-height: 95vh;\n  margin: 0.5rem auto;\n  display: flex;\n  flex-direction: column;\n  transition: max-width 0.3s ease;\n}\n.dialog.dialog--wide {\n  max-width: 1400px;\n}\n.dialog__header {\n  padding: 0.9rem 1rem;\n  display: flex;\n  justify-content: space-between;\n  align-items: center;\n  flex-shrink: 0;\n}\n.dialog__header h2 {\n  margin: 0;\n  font-size: 1.125rem;\n  font-weight: 600;\n  color: #111827;\n}\n.dialog__header .close {\n  cursor: pointer;\n  color: #6b7280;\n  transition: color 0.2s;\n}\n.dialog__header .close:hover {\n  color: #111827;\n}\n.dialog__body {\n  flex: 1;\n  overflow-y: auto;\n  padding: 0.75rem 1rem;\n  min-height: 0;\n}\n.dialog__footer {\n  padding: 0.625rem 1rem;\n  border-top: 1px solid #e5e7eb;\n  display: flex;\n  justify-content: flex-end;\n  gap: 0.625rem;\n  flex-shrink: 0;\n}\n.dialog__footer :global(.btn-outline-danger) {\n  background: transparent !important;\n  color: #dc2626 !important;\n  border: 2px solid #dc2626 !important;\n}\n.dialog__footer :global(.btn-outline-danger):hover {\n  background: #fef2f2 !important;\n  border-color: #b91c1c !important;\n  color: #b91c1c !important;\n}\n.dialog__footer :global(.btn-outline-danger):disabled {\n  background: transparent !important;\n  color: #fca5a5 !important;\n  border-color: #fca5a5 !important;\n}\n.tabs {\n  display: flex;\n  border-bottom: 2px solid #e5e7eb;\n  margin-bottom: 0.65rem;\n  gap: 0.25rem;\n  flex-shrink: 0;\n}\n.tab {\n  padding: 0.375rem 0.75rem;\n  font-size: 0.875rem;\n  font-weight: 500;\n  color: #6b7280;\n  background: none;\n  border: none;\n  border-bottom: 2px solid transparent;\n  margin-bottom: -2px;\n  cursor: pointer;\n  transition: all 0.2s;\n}\n.tab:hover {\n  color: #111827;\n}\n.tab.active {\n  color: #6366f1;\n  border-bottom-color: #6366f1;\n}\n.tab-content {\n  display: none;\n}\n.tab-content.active {\n  display: block;\n}\n/*# sourceMappingURL=contract-detail-modal.component.css.map */\n"] }]
    ...
    type: Inject,
    args: [MAT_DIALOG_DATA]
  }] }, { type: Router }, { type: PropertyService }, { type: ContractService }, { type: PaymentService }, { type: UserService }, { type: InterceptorService }, { type: FormBuilder }, { type: ChangeDetectorRef }, { type: LeadService }], { vendorAutocompleteTrigger: [{
    type: ViewChild,
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(ContractDetailModalComponent, { className: "ContractDetailModalComponent", filePath: "src/app/features/contracts/components/contract-detail-modal/contract-detail-modal.component.ts", lineNumber: 52 });
})();

// src/app/features/customers/pages/customer-detail/customer-detail.ts
var _c04 = (a0, a1, a2) => ({ "bg-green-100 text-green-800": a0, "bg-gray-100 text-gray-800": a1, "bg-red-100 text-red-800": a2 });
...
function CustomerDetail_Conditional_3_Conditional_12_Conditional_14_Template(rf, ctx) {
  if (rf & 1) {
...
function CustomerDetail_Conditional_3_Conditional_12_Conditional_15_Template(rf, ctx) {
  if (rf & 1) {
...
function CustomerDetail_Conditional_3_Conditional_12_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 16)(1, "div")(2, "span", 20);
    \u0275\u0275text(3, "Nombre");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(4, "span", 21);
    \u0275\u0275text(5);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(6, "div")(7, "span", 20);
    \u0275\u0275text(8, "Apellido");
    \u0275\u0275elementEnd();
    ...
    \u0275\u0275text(13, "Email");
    \u0275\u0275elementEnd();
    \u0275\u0275conditionalCreate(14, CustomerDetail_Conditional_3_Conditional_12_Conditional_14_Template, 2, 2, "a", 22)(15, CustomerDetail_Conditional_3_Conditional_12_Conditional_15_Template, 2, 0, "span", 21);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(16, "div")(17, "span", 20);
    \u0275\u0275text(18, "Tel\xE9fono");
    \u0275\u0275elementEnd();
    \u0275\u0275element(19, "app-phone", 23);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(20, "div")(21, "span", 20);
    \u0275\u0275text(22, "Empresa");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(23, "span", 21);
    \u0275\u0275text(24);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(25, "div")(26, "span", 20);
    \u0275\u0275text(27, "Grupo");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(28, "span", 21);
    \u0275\u0275text(29);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(30, "div")(31, "span", 20);
    \u0275\u0275text(32, "C\xF3digo legacy de cliente");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(33, "span", 21);
    \u0275\u0275text(34);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(35, "div")(36, "span", 20);
    \u0275\u0275text(37, "Estado");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(38, "div");
    \u0275\u0275element(39, "p-tag", 24);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(40, "div")(41, "span", 20);
    \u0275\u0275text(42, "Creado");
    \u0275\u0275elementEnd();
    ...
    \u0275\u0275pipe(45, "date");
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(46, "div", 25)(47, "span", 20);
    \u0275\u0275text(48, "Actualizado");
    \u0275\u0275elementEnd();
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance(4);
    \u0275\u0275conditional(ctx_r1.customer().email ? 14 : 15);
    \u0275\u0275advance(5);
    ...
    \u0275\u0275advance(5);
    \u0275\u0275textInterpolate(((tmp_9_0 = ctx_r1.customer().group) == null ? null : tmp_9_0.name) || "\u2014");
    \u0275\u0275advance(5);
    \u0275\u0275textInterpolate(ctx_r1.customer().legacy_customer_id ?? "\u2014");
    \u0275\u0275advance(5);
    \u0275\u0275property("value", ((tmp_11_0 = ctx_r1.customer().status) == null ? null : tmp_11_0.name) || ctx_r1.customer().status_id || "Desconocido")("severity", ctx_r1.getSeverity(((tmp_12_0 = ctx_r1.customer().status) == null ? null : tmp_12_0.name) || ctx_r1.customer().status_id || ""));
    \u0275\u0275advance(5);
    \u0275\u0275textInterpolate(\u0275\u0275pipeBind2(45, 13, ctx_r1.customer().created_at, "medium"));
    \u0275\u0275advance(6);
    \u0275\u0275textInterpolate(ctx_r1.customer().updated_at ? \u0275\u0275pipeBind2(51, 16, ctx_r1.customer().updated_at, "medium") : "\u2014");
  }
}
function CustomerDetail_Conditional_3_Conditional_13_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 16)(1, "div", 25)(2, "span", 20);
    \u0275\u0275text(3, "Almac\xE9n");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(4, "span", 21);
    \u0275\u0275text(5);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(6, "div")(7, "span", 20);
    \u0275\u0275text(8, "D\xEDas de cr\xE9dito");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(9, "span", 21);
    \u0275\u0275text(10);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(11, "div")(12, "span", 20);
    \u0275\u0275text(13, "Monto de cr\xE9dito");
    \u0275\u0275elementEnd();
  ...
  if (rf & 2) {
    ...
    const ctx_r1 = \u0275\u0275nextContext(2);
    \u0275\u0275advance(5);
    \u0275\u0275textInterpolate(((tmp_2_0 = ctx_r1.customer().warehouse) == null ? null : tmp_2_0.name) || ctx_r1.customer().warehouse_id || "\u2014");
    \u0275\u0275advance(5);
    \u0275\u0275textInterpolate(ctx_r1.customer().credit_days ?? "\u2014");
    \u0275\u0275advance(5);
    \u0275\u0275textInterpolate(ctx_r1.customer().credit_amount != null ? \u0275\u0275pipeBind2(16, 3, ctx_r1.customer().credit_amount, "1.2-2") : "\u2014");
  }
}
function CustomerDetail_Conditional_3_Conditional_14_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 16)(1, "div")(2, "span", 20);
    \u0275\u0275text(3, "RFC");
    \u0275\u0275elementEnd();
    ...
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(6, "div")(7, "span", 20);
    \u0275\u0275text(8, "R\xE9gimen fiscal");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(9, "span", 21);
    \u0275\u0275text(10);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(11, "div", 25)(12, "span", 20);
    \u0275\u0275text(13, "Raz\xF3n social");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(14, "span", 21);
    \u0275\u0275text(15);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(16, "div", 25)(17, "span", 20);
    \u0275\u0275text(18, "Direcci\xF3n fiscal");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(19, "span", 21);
    \u0275\u0275text(20);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(21, "div")(22, "span", 20);
    \u0275\u0275text(23, "Ciudad");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(24, "span", 21);
    \u0275\u0275text(25);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(26, "div")(27, "span", 20);
    \u0275\u0275text(28, "Estado");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(29, "span", 21);
    \u0275\u0275text(30);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(31, "div", 25)(32, "span", 20);
    \u0275\u0275text(33, "C\xF3digo postal");
    \u0275\u0275elementEnd();
  ...
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext(2);
    \u0275\u0275advance(5);
    \u0275\u0275textInterpolate(ctx_r1.customer().fiscal_rfc || "\u2014");
    \u0275\u0275advance(5);
    \u0275\u0275textInterpolate(ctx_r1.getFiscalRegimenLabel(ctx_r1.customer().fiscal_person_type));
    \u0275\u0275advance(5);
    \u0275\u0275textInterpolate(ctx_r1.customer().fiscal_razon_social || "\u2014");
    \u0275\u0275advance(5);
    \u0275\u0275textInterpolate(ctx_r1.customer().fiscal_address || "\u2014");
    \u0275\u0275advance(5);
    \u0275\u0275textInterpolate(ctx_r1.customer().fiscal_city || "\u2014");
    \u0275\u0275advance(5);
    \u0275\u0275textInterpolate(ctx_r1.customer().fiscal_state || "\u2014");
    \u0275\u0275advance(5);
    \u0275\u0275textInterpolate(ctx_r1.customer().fiscal_postal_code || "\u2014");
  }
}
function CustomerDetail_Conditional_3_Conditional_15_Conditional_6_Conditional_14_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "a", 22);
    \u0275\u0275text(1);
    \u0275\u0275elementEnd();
  ...
  if (rf & 2) {
    ...
    \u0275\u0275property("href", "mailto:" + ctx_r1.customer().additional_email, \u0275\u0275sanitizeUrl);
    \u0275\u0275advance();
    \u0275\u0275textInterpolate1(" ", ctx_r1.customer().additional_email, " ");
  }
}
function CustomerDetail_Conditional_3_Conditional_15_Conditional_6_Conditional_15_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "span", 21);
    \u0275\u0275text(1, "\u2014");
    \u0275\u0275elementEnd();
...
function CustomerDetail_Conditional_3_Conditional_15_Conditional_6_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 29)(1, "div")(2, "span", 20);
    \u0275\u0275text(3, "Nombre");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(4, "span", 21);
    \u0275\u0275text(5);
    ...
    \u0275\u0275text(13, "Email");
    \u0275\u0275elementEnd();
    \u0275\u0275conditionalCreate(14, CustomerDetail_Conditional_3_Conditional_15_Conditional_6_Conditional_14_Template, 2, 2, "a", 22)(15, CustomerDetail_Conditional_3_Conditional_15_Conditional_6_Conditional_15_Template, 2, 0, "span", 21);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(16, "div", 25)(17, "span", 20);
    \u0275\u0275text(18, "Tel\xE9fono");
    \u0275\u0275elementEnd();
  ...
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext(3);
    \u0275\u0275advance(5);
    \u0275\u0275textInterpolate(ctx_r1.customer().additional_name || "\u2014");
    \u0275\u0275advance(5);
    \u0275\u0275textInterpolate(ctx_r1.customer().additional_lastname || "\u2014");
    \u0275\u0275advance(4);
    \u0275\u0275conditional(ctx_r1.customer().additional_email ? 14 : 15);
    \u0275\u0275advance(5);
    \u0275\u0275property("phone", ctx_r1.customer().additional_phone)("countryCode", ctx_r1.customer().additional_phone_country)("countryPhoneCode", ctx_r1.customer().additional_phone_code);
  }
}
function CustomerDetail_Conditional_3_Conditional_15_Template(rf, ctx) {
  if (rf & 1) {
    const _r4 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "div", 17)(1, "button", 26);
    \u0275\u0275listener("click", function CustomerDetail_Conditional_3_Conditional_15_Template_button_click_1_listener() {
      \u0275\u0275restoreView(_r4);
      const ctx_r1 = \u0275\u0275nextContext(2);
      return \u0275\u0275resetView(ctx_r1.toggleAdditionalPerson());
    });
    \u0275\u0275elementStart(2, "span", 27);
    \u0275\u0275text(3, "Persona adicional (opcional)");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(4, "span", 28);
    \u0275\u0275text(5);
    \u0275\u0275elementEnd()();
    \u0275\u0275conditionalCreate(6, CustomerDetail_Conditional_3_Conditional_15_Conditional_6_Template, 20, 6, "div", 29);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext(2);
    \u0275\u0275advance(5);
    \u0275\u0275textInterpolate1(" ", ctx_r1.additionalPersonExpanded() ? "Ocultar" : "Mostrar informaci\xF3n", " ");
    \u0275\u0275advance();
    \u0275\u0275conditional(ctx_r1.additionalPersonExpanded() ? 6 : -1);
  }
}
function CustomerDetail_Conditional_3_div_16_Conditional_4_For_18_Template(rf, ctx) {
  if (rf & 1) {
    const _r5 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "tr", 38)(1, "td", 41)(2, "span", 42);
    \u0275\u0275listener("click", function CustomerDetail_Conditional_3_div_16_Conditional_4_For_18_Template_span_click_2_listener($event) {
      const contract_r6 = \u0275\u0275restoreView(_r5).$implicit;
      const ctx_r1 = \u0275\u0275nextContext(4);
      ctx_r1.openPropertyModal(contract_r6.property.id);
      return \u0275\u0275resetView($event.stopPropagation());
    });
    \u0275\u0275text(3);
    \u0275\u0275elementEnd()();
    ...
    \u0275\u0275pipe(10, "currency");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(11, "td", 41)(12, "span", 45);
    \u0275\u0275listener("click", function CustomerDetail_Conditional_3_div_16_Conditional_4_For_18_Template_span_click_12_listener($event) {
      const contract_r6 = \u0275\u0275restoreView(_r5).$implicit;
      const ctx_r1 = \u0275\u0275nextContext(4);
      ctx_r1.openContractModal(contract_r6);
      return \u0275\u0275resetView($event.stopPropagation());
    });
    \u0275\u0275text(13);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(14, "td", 41)(15, "span", 46);
    \u0275\u0275text(16);
    \u0275\u0275pipe(17, "titlecase");
    \u0275\u0275elementEnd()()();
  }
  if (rf & 2) {
    ...
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate1(" ", contract_r6.property.code, " ");
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate(contract_r6.property.name);
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate1("", contract_r6.property.total_area, " m\xB2");
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate(\u0275\u0275pipeBind2(10, 7, contract_r6.total_price, contract_r6.currency));
    \u0275\u0275advance(4);
    \u0275\u0275textInterpolate1(" ", contract_r6.contract_number, " ");
    \u0275\u0275advance(2);
    \u0275\u0275property("ngClass", \u0275\u0275pureFunction3(12, _c04, contract_r6.status === "activo", contract_r6.status === "completado", contract_r6.status === "cancelado"));
    \u0275\u0275advance();
    \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind1(17, 10, contract_r6.status), " ");
  }
}
function CustomerDetail_Conditional_3_div_16_Conditional_4_For_21_Template(rf, ctx) {
  if (rf & 1) {
    const _r7 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "div", 40)(1, "div", 47)(2, "span", 42);
    \u0275\u0275listener("click", function CustomerDetail_Conditional_3_div_16_Conditional_4_For_21_Template_span_click_2_listener() {
      const contract_r8 = \u0275\u0275restoreView(_r7).$implicit;
      const ctx_r1 = \u0275\u0275nextContext(4);
      return \u0275\u0275resetView(ctx_r1.openPropertyModal(contract_r8.property.id));
    });
    \u0275\u0275text(3);
    \u0275\u0275elementEnd();
    ...
    \u0275\u0275text(8);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(9, "div", 49)(10, "div")(11, "span", 50);
    \u0275\u0275text(12, "\xC1rea");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(13, "span");
    \u0275\u0275text(14);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(15, "div")(16, "span", 50);
    \u0275\u0275text(17, "Precio");
    \u0275\u0275elementEnd();
    ...
    \u0275\u0275pipe(20, "currency");
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(21, "div", 25)(22, "span", 50);
    \u0275\u0275text(23, "Contrato");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(24, "span", 52);
    \u0275\u0275listener("click", function CustomerDetail_Conditional_3_div_16_Conditional_4_For_21_Template_span_click_24_listener() {
      const contract_r8 = \u0275\u0275restoreView(_r7).$implicit;
      const ctx_r1 = \u0275\u0275nextContext(4);
      return \u0275\u0275resetView(ctx_r1.openContractModal(contract_r8));
    });
    \u0275\u0275text(25);
    \u0275\u0275elementEnd()()()();
  }
  if (rf & 2) {
    ...
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate1(" ", contract_r8.property.code, " ");
    \u0275\u0275advance();
    \u0275\u0275property("ngClass", \u0275\u0275pureFunction3(12, _c04, contract_r8.status === "activo", contract_r8.status === "completado", contract_r8.status === "cancelado"));
    \u0275\u0275advance();
    \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind1(6, 7, contract_r8.status), " ");
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate(contract_r8.property.name);
    \u0275\u0275advance(6);
    \u0275\u0275textInterpolate1("", contract_r8.property.total_area, " m\xB2");
    \u0275\u0275advance(5);
    \u0275\u0275textInterpolate(\u0275\u0275pipeBind2(20, 9, contract_r8.total_price, contract_r8.currency));
    \u0275\u0275advance(6);
    \u0275\u0275textInterpolate1(" ", contract_r8.contract_number, " ");
  }
}
function CustomerDetail_Conditional_3_div_16_Conditional_4_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 33)(1, "table", 34)(2, "thead", 35)(3, "tr")(4, "th", 36);
    \u0275\u0275text(5, "C\xF3digo");
    \u0275\u0275elementEnd();
    ...
    \u0275\u0275repeaterCreate(17, CustomerDetail_Conditional_3_div_16_Conditional_4_For_18_Template, 18, 16, "tr", 38, _forTrack02);
    \u0275\u0275elementEnd()()();
    \u0275\u0275elementStart(19, "div", 39);
    \u0275\u0275repeaterCreate(20, CustomerDetail_Conditional_3_div_16_Conditional_4_For_21_Template, 26, 16, "div", 40, _forTrack02);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext(3);
...
function CustomerDetail_Conditional_3_div_16_Conditional_5_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 32)(1, "p", 53);
    \u0275\u0275text(2, "No hay contratos asociados");
    \u0275\u0275elementEnd()();
  }
}
function CustomerDetail_Conditional_3_div_16_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 12)(1, "div", 30)(2, "h3", 31);
    \u0275\u0275text(3, " Propiedades y Contratos ");
    \u0275\u0275elementEnd()();
    \u0275\u0275conditionalCreate(4, CustomerDetail_Conditional_3_div_16_Conditional_4_Template, 22, 0)(5, CustomerDetail_Conditional_3_div_16_Conditional_5_Template, 3, 0, "div", 32);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext(2);
...
function CustomerDetail_Conditional_3_app_customer_sales_orders_17_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275element(0, "app-customer-sales-orders", 54);
  }
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext(2);
...
function CustomerDetail_Conditional_3_app_customer_documents_18_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275element(0, "app-customer-documents", 54);
  }
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext(2);
    \u0275\u0275property("customerId", ctx_r1.customer().id);
...
function CustomerDetail_Conditional_3_div_19_Conditional_5_ng_template_1_Template(rf, ctx) {
  if (rf & 1) {
...
function CustomerDetail_Conditional_3_div_19_Conditional_5_ng_template_2_Template(rf, ctx) {
  if (rf & 1) {
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate(address_r9.type);
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate(address_r9.street_address);
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate(address_r9.city);
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate(address_r9.state);
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate(address_r9.postal_code);
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate(address_r9.country);
  }
}
function CustomerDetail_Conditional_3_div_19_Conditional_5_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "p-table", 57);
    \u0275\u0275template(1, CustomerDetail_Conditional_3_div_19_Conditional_5_ng_template_1_Template, 13, 0, "ng-template", 58)(2, CustomerDetail_Conditional_3_div_19_Conditional_5_ng_template_2_Template, 13, 6, "ng-template", 59);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext(3);
...
function CustomerDetail_Conditional_3_div_19_Conditional_6_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 32)(1, "p", 53);
...
function CustomerDetail_Conditional_3_div_19_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 12)(1, "div", 55)(2, "h3", 31);
    \u0275\u0275text(3, " Direcciones ");
    \u0275\u0275elementEnd();
    \u0275\u0275element(4, "app-button", 56);
    \u0275\u0275elementEnd();
    \u0275\u0275conditionalCreate(5, CustomerDetail_Conditional_3_div_19_Conditional_5_Template, 3, 1, "p-table", 57)(6, CustomerDetail_Conditional_3_div_19_Conditional_6_Template, 3, 0, "div", 32);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext(2);
    \u0275\u0275advance(4);
    \u0275\u0275property("fullWidth", true)("icon", ctx_r1.MapPinIcon);
    \u0275\u0275advance();
    \u0275\u0275conditional(ctx_r1.customer().addresses && ctx_r1.customer().addresses.length > 0 ? 5 : 6);
  }
}
function CustomerDetail_Conditional_3_div_20_Conditional_5_ng_template_1_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "tr")(1, "th");
    \u0275\u0275text(2, "Tipo");
    \u0275\u0275elementEnd();
...
function CustomerDetail_Conditional_3_div_20_Conditional_5_ng_template_2_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "tr")(1, "td", 60);
    \u0275\u0275element(2, "p-tag", 62);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(3, "td")(4, "div", 63);
    \u0275\u0275text(5);
    \u0275\u0275elementEnd();
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance(2);
    \u0275\u0275property("value", activity_r10.type);
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate1(" ", activity_r10.title, " ");
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate1(" ", activity_r10.description, " ");
    \u0275\u0275advance(2);
    \u0275\u0275property("value", activity_r10.status);
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind2(12, 6, activity_r10.activity_date, "medium"), " ");
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate1(" ", activity_r10.duration_minutes, " min ");
  }
}
function CustomerDetail_Conditional_3_div_20_Conditional_5_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "p-table", 57);
    \u0275\u0275template(1, CustomerDetail_Conditional_3_div_20_Conditional_5_ng_template_1_Template, 11, 0, "ng-template", 58)(2, CustomerDetail_Conditional_3_div_20_Conditional_5_ng_template_2_Template, 15, 9, "ng-template", 59);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext(3);
...
function CustomerDetail_Conditional_3_div_20_Conditional_6_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 32)(1, "p", 53);
...
function CustomerDetail_Conditional_3_div_20_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 12)(1, "div", 55)(2, "h3", 31);
    \u0275\u0275text(3, " Actividades ");
    \u0275\u0275elementEnd();
    \u0275\u0275element(4, "app-button", 61);
    \u0275\u0275elementEnd();
    \u0275\u0275conditionalCreate(5, CustomerDetail_Conditional_3_div_20_Conditional_5_Template, 3, 1, "p-table", 57)(6, CustomerDetail_Conditional_3_div_20_Conditional_6_Template, 3, 0, "div", 32);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext(2);
    \u0275\u0275advance(4);
    \u0275\u0275property("fullWidth", true)("icon", ctx_r1.ActivityIcon);
    \u0275\u0275advance();
...
function CustomerDetail_Conditional_3_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(7, "div", 12)(8, "h3", 13);
    \u0275\u0275text(9, " Informaci\xF3n del Cliente ");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(10, "div", 14)(11, "app-tab", 15);
    \u0275\u0275listener("tabChange", function CustomerDetail_Conditional_3_Template_app_tab_tabChange_11_listener($event) {
      \u0275\u0275restoreView(_r3);
      const ctx_r1 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r1.setActiveInfoTab($event));
    });
    \u0275\u0275elementEnd()();
    \u0275\u0275conditionalCreate(12, CustomerDetail_Conditional_3_Conditional_12_Template, 52, 19, "div", 16);
    \u0275\u0275conditionalCreate(13, CustomerDetail_Conditional_3_Conditional_13_Template, 17, 6, "div", 16);
    \u0275\u0275conditionalCreate(14, CustomerDetail_Conditional_3_Conditional_14_Template, 36, 7, "div", 16);
    \u0275\u0275conditionalCreate(15, CustomerDetail_Conditional_3_Conditional_15_Template, 7, 2, "div", 17);
    \u0275\u0275elementEnd();
    \u0275\u0275template(16, CustomerDetail_Conditional_3_div_16_Template, 6, 1, "div", 18)(17, CustomerDetail_Conditional_3_app_customer_sales_orders_17_Template, 1, 1, "app-customer-sales-orders", 19)(18, CustomerDetail_Conditional_3_app_customer_documents_18_Template, 1, 1, "app-customer-documents", 19)(19, CustomerDetail_Conditional_3_div_19_Template, 7, 3, "div", 18)(20, CustomerDetail_Conditional_3_div_20_Template, 7, 3, "div", 18);
  }
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext();
    \u0275\u0275advance(3);
    ...
    \u0275\u0275advance();
    \u0275\u0275property("fullWidth", true)("icon", ctx_r1.PencilIcon);
    \u0275\u0275advance(5);
    \u0275\u0275property("tabs", ctx_r1.infoTabs)("activeTabId", ctx_r1.activeInfoTab());
    \u0275\u0275advance();
    \u0275\u0275conditional(ctx_r1.activeInfoTab() === "customer" ? 12 : -1);
    \u0275\u0275advance();
    \u0275\u0275conditional(ctx_r1.activeInfoTab() === "credit" ? 13 : -1);
    \u0275\u0275advance();
    \u0275\u0275conditional(ctx_r1.activeInfoTab() === "fiscal" ? 14 : -1);
    \u0275\u0275advance();
    \u0275\u0275conditional(ctx_r1.activeInfoTab() === "customer" && ctx_r1.hasAdditionalContact(ctx_r1.customer()) ? 15 : -1);
    \u0275\u0275advance();
...
var CustomerDetail = class _CustomerDetail {
  ...
  activeInfoTab = signal("customer", ...ngDevMode ? [{ debugName: "activeInfoTab" }] : []);
  infoTabs = [
  ...
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _CustomerDetail, selectors: [["app-customer-detail"]], decls: 4, vars: 3, consts: [[1, "space-y-6", "sm:space-y-10", "min-h-screen", "px-0", "sm:px-0"], [1, "flex", "items-center", "justify-center", "py-12"], [1, "bg-red-50", "border", "border-red-200", "rounded-lg", "p-4"], ["diameter", "40"], [1, "ml-4"], [1, "text-red-800"], ["pButton", "", "label", "Reintentar", 1, "p-button-sm", "mt-2", 3, "click"], [1, "flex", "flex-col", "sm:flex-row", "sm:items-center", "sm:justify-between", "gap-4"], [1, "min-w-0"], [1, "text-2xl", "sm:text-3xl", "font-bold", "text-gray-900", "truncate"], [1, "text-sm", "text-gray-500", "truncate"], ["text", "Editar cliente", "variant", "primary", "size", "sm", 3, "clicked", "fullWidth", "icon"], [1, "bg-white", "shadow-md", "rounded-xl", "p-4", "sm:p-6", "border", "border-gray-100"], [1, "text-lg", "font-semibold", "text-gray-800", "mb-4"], [1, "mb-4"], [3, "tabChange", "tabs", "activeTabId"], [1, "grid", "grid-cols-1", "sm:grid-cols-2", "gap-4", "text-sm"], [1, "mt-6", "pt-6", "border-t", "border-gray-100"], ["class", "bg-white shadow-md rounded-xl p-4 sm:p-6 border border-gray-100", 4, "hasPermission"], [3, "customerId", 4, "hasPermission"], [1, "block", "text-xs", "font-semibold", "text-gray-500", "mb-1"], [1, "text-gray-900"], [1, "text-indigo-600", "hover:text-indigo-800", "break-all", 3, "href"], [3, "phone", "countryCode", "countryPhoneCode"], ["rounded", "true", 3, "value", "severity"], [1, "col-span-2"], ["type", "button", 1, "customer-detail__expand-additional", 3, "click"], [1, "customer-detail__expand-additional-label"], [1, "customer-detail__expand-additional-action"], [1, "mt-3", "grid", "grid-cols-1", "sm:grid-cols-2", "gap-4", "text-sm"], [1, "flex", "items-center", "justify-between", "mb-4"], [1, "text-lg", "font-semibold", "text-gray-800"], [1, "text-center", "py-8", "text-gray-500"], [1, "hidden", "md:block", "overflow-x-auto"], [1, "min-w-full", "divide-y", "divide-gray-200"], [1, "bg-gray-50"], [1, "px-4", "py-3", "text-left", "text-xs", "font-medium", "text-gray-500", "uppercase", "tracking-wider"], [1, "bg-white", "divide-y", "divide-gray-200"], [1, "hover:bg-gray-50"], [1, "block", "md:hidden", "space-y-3"], [1, "border", "border-gray-200", "rounded-lg", "p-4", "bg-gray-50"], [1, "px-4", "py-3", "whitespace-nowrap"], [1, "inline-flex", "items-center", "px-2", "py-1", "rounded", "text-xs", "font-medium", "bg-green-100", "text-green-800", "cursor-pointer", "hover:bg-green-200", "transition-colors", 3, "click"], [1, "px-4", "py-3", "text-sm", "text-gray-900"], [1, "px-4", "py-3", "text-sm", "text-gray-600"], [1, "inline-flex", "items-center", "px-2", "py-1", "rounded", "text-xs", "font-medium", "bg-purple-100", "text-purple-800", "cursor-pointer", "hover:bg-purple-200", "transition-colors", 3, "click"], [1, "inline-flex", "items-center", "px-2", "py-1", "rounded-full", "text-xs", "font-medium", 3, "ngClass"], [1, "flex", "items-start", "justify-between", "gap-2", "mb-3"], [1, "text-sm", "font-medium", "text-gray-900", "mb-2"], [1, "grid", "grid-cols-2", "gap-2", "text-sm"], [1, "text-xs", "text-gray-500", "block"], [1, "font-medium"], [1, "inline-flex", "items-center", "px-2", "py-1", "rounded", "text-xs", "font-medium", "bg-purple-100", "text-purple-800", "cursor-pointer", "hover:bg-purple-200", "transition-colors", "mt-0.5", 3, "click"], [1, "text-sm"], [3, "customerId"], [1, "flex", "flex-col", "sm:flex-row", "sm:items-center", "sm:justify-between", "gap-3", "mb-4"], ["text", "Agregar direcci\xF3n", "variant", "primary", "size", "sm", 3, "fullWidth", "icon"], ["responsiveLayout", "scroll", "styleClass", "p-datatable-sm w-full", 3, "value"], ["pTemplate", "header"], ["pTemplate", "body"], [1, "capitalize"], ["text", "Agregar actividad", "variant", "primary", "size", "sm", 3, "fullWidth", "icon"], ["severity", "info", "rounded", "true", 3, "value"], [1, "font-medium", "text-gray-800"], [1, "text-xs", "text-gray-500"], ["severity", "success", "rounded", "true", 3, "value"]], template: function CustomerDetail_Template(rf, ctx) {
    if (rf & 1) {
      ...
      \u0275\u0275conditionalCreate(3, CustomerDetail_Conditional_3_Template, 21, 15);
      \u0275\u0275elementEnd();
    }
    if (rf & 2) {
      \u0275\u0275advance();
    ...
    CurrencyPipe,
    DatePipe
  ], styles: ['@charset "UTF-8";\n\n\n\n.customer-detail__expand-additional[_ngcontent-%COMP%] {\n  display: flex;\n  align-items: center;\n  justify-content: space-between;\n  width: 100%;\n  gap: 0.75rem;\n  padding: 0.375rem 0;\n  margin: 0;\n  background: transparent;\n  border: none;\n  cursor: pointer;\n  text-align: left;\n  border-radius: 0.375rem;\n}\n.customer-detail__expand-additional[_ngcontent-%COMP%]:hover   .customer-detail__expand-additional-action[_ngcontent-%COMP%] {\n  text-decoration: underline;\n}\n.customer-detail__expand-additional[_ngcontent-%COMP%]:focus-visible {\n  outline: 2px solid #3b82f6;\n  outline-offset: 2px;\n}\n.customer-detail__expand-additional-label[_ngcontent-%COMP%] {\n  font-size: 0.875rem;\n  font-weight: 600;\n  color: #1f2937;\n}\n.customer-detail__expand-additional-action[_ngcontent-%COMP%] {\n  flex-shrink: 0;\n  font-size: 0.875rem;\n  font-weight: 600;\n  color: #4f46e5;\n}\n@media (max-width: 639px) {\n  .customer-detail__expand-additional[_ngcontent-%COMP%] {\n    flex-direction: column;\n    align-items: flex-start;\n    gap: 0.25rem;\n  }\n}\n/*# sourceMappingURL=customer-detail.css.map */'] });
};
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && setClassMetadata(CustomerDetail, [{
    ...
    args: [{ selector: "app-customer-detail", standalone: true, schemas: [NO_ERRORS_SCHEMA], imports: [
      ...
      HasPermissionDirective,
      TabComponent
    ], template: `<div class="space-y-6 sm:space-y-10 min-h-screen px-0 sm:px-0">
    ...
    @if (customer() && !isLoading() && !error()) {
      ...
      <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        <div class="min-w-0">
          <h2 class="text-2xl sm:text-3xl font-bold text-gray-900 truncate">{{ customer()!.name }}</h2>
      ...
      <div class="bg-white shadow-md rounded-xl p-4 sm:p-6 border border-gray-100">
        ...
        <div class="mb-4">
          <app-tab
            ...
            (tabChange)="setActiveInfoTab($event)">
          </app-tab>
        </div>

        @if (activeInfoTab() === 'customer') {
        <div class="grid grid-cols-1 sm:grid-cols-2 gap-4 text-sm">
          ...
          <div>
            <span class="block text-xs font-semibold text-gray-500 mb-1">Tel\xE9fono</span>
            <app-phone 
          ...
          <div>
            <span class="block text-xs font-semibold text-gray-500 mb-1">C\xF3digo legacy de cliente</span>
            <span class="text-gray-900">{{ customer()!.legacy_customer_id ?? '\u2014' }}</span>
          </div>
          ...
          <div class="col-span-2">
            ...
            <span class="text-gray-900">{{ customer()!.updated_at ? (customer()!.updated_at | date:'medium') : '\u2014' }}</span>
          </div>

        </div>
        }

        @if (activeInfoTab() === 'credit') {
          <div class="grid grid-cols-1 sm:grid-cols-2 gap-4 text-sm">
            <div class="col-span-2">
              <span class="block text-xs font-semibold text-gray-500 mb-1">Almac\xE9n</span>
              <span class="text-gray-900">{{ customer()!.warehouse?.name || customer()!.warehouse_id || '\u2014' }}</span>
            </div>
            <div>
              <span class="block text-xs font-semibold text-gray-500 mb-1">D\xEDas de cr\xE9dito</span>
              <span class="text-gray-900">{{ customer()!.credit_days ?? '\u2014' }}</span>
            </div>
            <div>
              <span class="block text-xs font-semibold text-gray-500 mb-1">Monto de cr\xE9dito</span>
              <span class="text-gray-900">{{ customer()!.credit_amount != null ? (customer()!.credit_amount | number:'1.2-2') : '\u2014' }}</span>
            </div>
          </div>
        }

        @if (activeInfoTab() === 'fiscal') {
          <div class="grid grid-cols-1 sm:grid-cols-2 gap-4 text-sm">
            <div>
              <span class="block text-xs font-semibold text-gray-500 mb-1">RFC</span>
              <span class="text-gray-900">{{ customer()!.fiscal_rfc || '\u2014' }}</span>
            </div>
            <div>
              <span class="block text-xs font-semibold text-gray-500 mb-1">R\xE9gimen fiscal</span>
              <span class="text-gray-900">{{ getFiscalRegimenLabel(customer()!.fiscal_person_type) }}</span>
            </div>
            <div class="col-span-2">
              <span class="block text-xs font-semibold text-gray-500 mb-1">Raz\xF3n social</span>
              <span class="text-gray-900">{{ customer()!.fiscal_razon_social || '\u2014' }}</span>
            </div>
            <div class="col-span-2">
              <span class="block text-xs font-semibold text-gray-500 mb-1">Direcci\xF3n fiscal</span>
              <span class="text-gray-900">{{ customer()!.fiscal_address || '\u2014' }}</span>
            </div>
            <div>
              <span class="block text-xs font-semibold text-gray-500 mb-1">Ciudad</span>
              <span class="text-gray-900">{{ customer()!.fiscal_city || '\u2014' }}</span>
            </div>
            <div>
              <span class="block text-xs font-semibold text-gray-500 mb-1">Estado</span>
              <span class="text-gray-900">{{ customer()!.fiscal_state || '\u2014' }}</span>
            </div>
            <div class="col-span-2">
              <span class="block text-xs font-semibold text-gray-500 mb-1">C\xF3digo postal</span>
              <span class="text-gray-900">{{ customer()!.fiscal_postal_code || '\u2014' }}</span>
            </div>
          </div>
        }

        @if (activeInfoTab() === 'customer' && hasAdditionalContact(customer()!)) {
          <div class="mt-6 pt-6 border-t border-gray-100">
            <button
              type="button"
              class="customer-detail__expand-additional"
              (click)="toggleAdditionalPerson()">
              <span class="customer-detail__expand-additional-label">Persona adicional (opcional)</span>
              <span class="customer-detail__expand-additional-action">
                {{ additionalPersonExpanded() ? 'Ocultar' : 'Mostrar informaci\xF3n' }}
              </span>
            </button>

            @if (additionalPersonExpanded()) {
              <div class="mt-3 grid grid-cols-1 sm:grid-cols-2 gap-4 text-sm">
                <div>
                  <span class="block text-xs font-semibold text-gray-500 mb-1">Nombre</span>
                  <span class="text-gray-900">{{ customer()!.additional_name || '\u2014' }}</span>
                </div>
                <div>
                  <span class="block text-xs font-semibold text-gray-500 mb-1">Apellido</span>
                  <span class="text-gray-900">{{ customer()!.additional_lastname || '\u2014' }}</span>
                </div>
                <div class="col-span-2">
                  <span class="block text-xs font-semibold text-gray-500 mb-1">Email</span>
                  @if (customer()!.additional_email) {
                    <a [href]="'mailto:' + customer()!.additional_email" class="text-indigo-600 hover:text-indigo-800 break-all">
                      {{ customer()!.additional_email }}
                    </a>
                  } @else {
                    <span class="text-gray-900">\u2014</span>
                  }
                ...
                <div class="col-span-2">
                  <span class="block text-xs font-semibold text-gray-500 mb-1">Tel\xE9fono</span>
                  <app-phone
                    [phone]="customer()!.additional_phone"
                    [countryCode]="customer()!.additional_phone_country"
                    [countryPhoneCode]="customer()!.additional_phone_code">
                  </app-phone>
                </div>
              </div>
            }
      ...
      <div *hasPermission="'contracts:read'" class="bg-white shadow-md rounded-xl p-4 sm:p-6 border border-gray-100">
          ...
          <div class="hidden md:block overflow-x-auto">
            <table class="min-w-full divide-y divide-gray-200">
              <thead class="bg-gray-50">
                <tr>
                  <th class="px-4 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">C\xF3digo</th>
                  <th class="px-4 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Nombre</th>
                  <th class="px-4 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">\xC1rea</th>
                ...
                @for (contract of customer()!.contracts; track contract.id) {
                  <tr class="hover:bg-gray-50">
                    <td class="px-4 py-3 whitespace-nowrap">
                      <span 
                        (click)="openPropertyModal(contract.property.id); $event.stopPropagation()"
                    ...
                    <td class="px-4 py-3 text-sm text-gray-600">{{ contract.property.total_area }} m\xB2</td>
                    <td class="px-4 py-3 text-sm text-gray-900">{{ contract.total_price | currency:contract.currency }}</td>
                    <td class="px-4 py-3 whitespace-nowrap">
                      <span 
                        (click)="openContractModal(contract); $event.stopPropagation()"
                        class="inline-flex items-center px-2 py-1 rounded text-xs font-medium bg-purple-100 text-purple-800 cursor-pointer hover:bg-purple-200 transition-colors">
            ...
            @for (contract of customer()!.contracts; track contract.id) {
              <div class="border border-gray-200 rounded-lg p-4 bg-gray-50">
                <div class="flex items-start justify-between gap-2 mb-3">
                  <span
                    (click)="openPropertyModal(contract.property.id)"
                    class="inline-flex items-center px-2 py-1 rounded text-xs font-medium bg-green-100 text-green-800 cursor-pointer hover:bg-green-200 transition-colors">
                    {{ contract.property.code }}
                  </span>
                  <span class="inline-flex items-center px-2 py-1 rounded-full text-xs font-medium"
                ...
                <p class="text-sm font-medium text-gray-900 mb-2">{{ contract.property.name }}</p>
                <div class="grid grid-cols-2 gap-2 text-sm">
                  <div>
                    <span class="text-xs text-gray-500 block">\xC1rea</span>
                    <span>{{ contract.property.total_area }} m\xB2</span>
                  </div>
                  <div>
                    <span class="text-xs text-gray-500 block">Precio</span>
                    <span class="font-medium">{{ contract.total_price | currency:contract.currency }}</span>
                  </div>
                  <div class="col-span-2">
                    <span class="text-xs text-gray-500 block">Contrato</span>
                    <span
                      (click)="openContractModal(contract)"
                      class="inline-flex items-center px-2 py-1 rounded text-xs font-medium bg-purple-100 text-purple-800 cursor-pointer hover:bg-purple-200 transition-colors mt-0.5">
                      {{ contract.contract_number }}
                    </span>
                  </div>
                </div>
      ...
      <!-- SALES ORDERS SECTION (mismo acceso que documentos; API valida OV) -->
      <app-customer-sales-orders
        *hasPermission="'customers:read'"
        [customerId]="customer()!.id">
      </app-customer-sales-orders>

      <!-- CUSTOMER DOCUMENTS SECTION -->
      <app-customer-documents *hasPermission="'customers:read'" [customerId]="customer()!.id"></app-customer-documents>

      <!-- ADDRESSES SECTION -->
      <div *hasPermission="'customers:read'" class="bg-white shadow-md rounded-xl p-4 sm:p-6 border border-gray-100">
        <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3 mb-4">
          <h3 class="text-lg font-semibold text-gray-800">
            Direcciones
          </h3>
          <app-button
            text="Agregar direcci\xF3n"
            variant="primary"
            size="sm"
            [fullWidth]="true"
            [icon]="MapPinIcon">
...
</div>`, styles: ['@charset "UTF-8";\n\n/* src/app/features/customers/pages/customer-detail/customer-detail.scss */\n.customer-detail__expand-additional {\n  display: flex;\n  align-items: center;\n  justify-content: space-between;\n  width: 100%;\n  gap: 0.75rem;\n  padding: 0.375rem 0;\n  margin: 0;\n  background: transparent;\n  border: none;\n  cursor: pointer;\n  text-align: left;\n  border-radius: 0.375rem;\n}\n.customer-detail__expand-additional:hover .customer-detail__expand-additional-action {\n  text-decoration: underline;\n}\n.customer-detail__expand-additional:focus-visible {\n  outline: 2px solid #3b82f6;\n  outline-offset: 2px;\n}\n.customer-detail__expand-additional-label {\n  font-size: 0.875rem;\n  font-weight: 600;\n  color: #1f2937;\n}\n.customer-detail__expand-additional-action {\n  flex-shrink: 0;\n  font-size: 0.875rem;\n  font-weight: 600;\n  color: #4f46e5;\n}\n@media (max-width: 639px) {\n  .customer-detail__expand-additional {\n    flex-direction: column;\n    align-items: flex-start;\n    gap: 0.25rem;\n  }\n}\n/*# sourceMappingURL=customer-detail.css.map */\n'] }]
  }], () => [{ type: ActivatedRoute }, { type: Router }, { type: CustomerService }, { type: PropertyService }, { type: MatDialog }], null);
})();
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(CustomerDetail, { className: "CustomerDetail", filePath: "src/app/features/customers/pages/customer-detail/customer-detail.ts", lineNumber: 46 });
})();
export {
  CustomerDetail
};
//# sourceMappingURL=chunk-ADEUXQKG.js.map
