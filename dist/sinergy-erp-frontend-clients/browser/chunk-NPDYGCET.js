import {
  LeadEditDialog
} from "./chunk-AXDUHLQS.js";
import {
  LeadService
} from "./chunk-GDXOHYZA.js";
import {
  SearchComponent
} from "./chunk-KYOMMC7F.js";
import {
...
import "./chunk-FWSYL4PU.js";
import {
  MatDialog
} from "./chunk-C44BBKV6.js";
import "./chunk-OQ3D3YSL.js";
import {
  FormsModule
...
function LeadsList_Conditional_15_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 15);
    \u0275\u0275text(1, "Cargando leads...");
    \u0275\u0275elementEnd();
  }
}
function LeadsList_Conditional_16_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 15);
    \u0275\u0275text(1, "No se encontraron leads");
    \u0275\u0275elementEnd();
  }
}
function LeadsList_Conditional_17_For_2_Template(rf, ctx) {
  if (rf & 1) {
    const _r2 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "div", 19);
    \u0275\u0275listener("click", function LeadsList_Conditional_17_For_2_Template_div_click_0_listener() {
    ...
    \u0275\u0275text(5);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(6, "div", 23)(7, "div", 24)(8, "app-status-badge", 25);
    \u0275\u0275listener("statusFilterChange", function LeadsList_Conditional_17_For_2_Template_app_status_badge_statusFilterChange_8_listener($event) {
      \u0275\u0275restoreView(_r2);
      const ctx_r3 = \u0275\u0275nextContext(2);
    ...
    \u0275\u0275listener("click", function LeadsList_Conditional_17_For_2_Template_div_click_19_listener($event) {
      \u0275\u0275restoreView(_r2);
      return \u0275\u0275resetView($event.stopPropagation());
    });
    \u0275\u0275elementStart(20, "app-button", 33);
    \u0275\u0275listener("clicked", function LeadsList_Conditional_17_For_2_Template_app_button_clicked_20_listener() {
      const item_r3 = \u0275\u0275restoreView(_r2).$implicit;
      const ctx_r3 = \u0275\u0275nextContext(2);
      return \u0275\u0275resetView(ctx_r3.viewDetail(item_r3));
    });
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind2(18, 11, item_r3.created_at, "shortDate"), " ");
    \u0275\u0275advance(3);
    \u0275\u0275property("fullWidth", true);
  }
}
function LeadsList_Conditional_17_Conditional_3_Template(rf, ctx) {
  if (rf & 1) {
    const _r5 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "div", 18)(1, "div", 34)(2, "button", 35);
    \u0275\u0275listener("click", function LeadsList_Conditional_17_Conditional_3_Template_button_click_2_listener() {
      \u0275\u0275restoreView(_r5);
      const ctx_r3 = \u0275\u0275nextContext(2);
    ...
    \u0275\u0275listener("click", function LeadsList_Conditional_17_Conditional_3_Template_button_click_6_listener() {
      \u0275\u0275restoreView(_r5);
      const ctx_r3 = \u0275\u0275nextContext(2);
      return \u0275\u0275resetView(ctx_r3.onPageChange({ page: (ctx_r3.table_config().page ?? 1) + 1, limit: ctx_r3.table_config().limit ?? 20 }));
    });
...
function LeadsList_Conditional_17_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 16);
    \u0275\u0275repeaterCreate(1, LeadsList_Conditional_17_For_2_Template, 21, 14, "div", 17, _forTrack0);
    \u0275\u0275elementEnd();
    \u0275\u0275conditionalCreate(3, LeadsList_Conditional_17_Conditional_3_Template, 8, 4, "div", 18);
  }
  if (rf & 2) {
    const ctx_r3 = \u0275\u0275nextContext();
    \u0275\u0275advance();
...
function LeadsList_ng_template_18_Template(rf, ctx) {
  if (rf & 1) {
    const _r6 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "td", 36)(1, "p", 37);
    \u0275\u0275text(2);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(3, "td", 38)(4, "span", 39);
    \u0275\u0275text(5);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(6, "td", 40)(7, "app-status-badge", 25);
    \u0275\u0275listener("statusFilterChange", function LeadsList_ng_template_18_Template_app_status_badge_statusFilterChange_7_listener($event) {
      \u0275\u0275restoreView(_r6);
      const ctx_r3 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r3.onStatusFilterChange($event));
    });
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(8, "td", 41)(9, "span", 42);
    \u0275\u0275text(10);
    \u0275\u0275elementEnd()();
    ...
    \u0275\u0275listener("click", function LeadsList_ng_template_18_Template_button_click_20_listener($event) {
...
var LeadsList = class _LeadsList {
  ...
  }, decls: 20, vars: 9, consts: [["tableTemplate", ""], [1, "leads-list-container"], [1, "leads-content"], [1, "px-0", "sm:px-4"], [1, "flex", "flex-col", "gap-3", "md:flex-row", "md:items-center", "md:justify-between", "mb-4"], [1, "text-xl", "sm:text-2xl", "font-semibold", "text-gray-800"], [1, "flex", "flex-col", "sm:flex-row", "sm:items-center", "gap-3", "w-full", "md:w-auto"], [1, "w-full", "sm:w-auto", 3, "changeOption", "config"], ["param_name", "search", 1, "w-full", "sm:w-64", 3, "searchChange", "param_activate"], ["text", "Crear lead", "custom_class", "btn_primary w-full sm:w-auto", 3, "click"], [3, "filterClear", "activeStatusFilter", "activeGroupId", "activeGroupName"], [3, "filterChange", "activeFilter"], [1, "hidden", "md:block"], [3, "pageChange", "sortChange", "rowClick", "config", "rowTemplate"], [1, "block", "md:hidden"], [1, "py-10", "text-center", "text-gray-500", "text-sm"], [1, "space-y-3"], [1, "bg-white", "border", "border-gray-200", "rounded-lg", "p-4", "shadow-sm", "active:bg-gray-50"], [1, "mt-4", "flex", "justify-center"], [1, "bg-white", "border", "border-gray-200", "rounded-lg", "p-4", "shadow-sm", "active:bg-gray-50", 3, "click"], [1, "flex", "justify-between", "items-start", "gap-2", "mb-2"], [1, "font-semibold", "text-gray-900", "truncate", "flex-1"], [1, "inline-flex", "items-center", "px-1.5", "py-0.5", "rounded", "text-xs", "font-medium", "bg-blue-100", "text-blue-800", "shrink-0"], [1, "space-y-2"], [1, "flex", "items-center", "gap-2", "flex-wrap"], [3, "statusFilterChange", "lead", "isFilterActive"], [1, "inline-flex", "items-center", "px-1.5", "py-0.5", "rounded", "text-xs", "font-medium", "bg-gray-100", "text-gray-600"], [1, "text-sm", "text-gray-600"], [1, "truncate"], [1, "mt-1"], [3, "phone", "countryCode", "countryPhoneCode"], [1, "text-xs", "text-gray-500", "mt-1"], [1, "mt-3", "pt-3", "border-t", "border-gray-100", 3, "click"], ["text", "Ver Detalle", "size", "sm", "custom_class", "btn_primary", 3, "clicked", "fullWidth"], [1, "flex", "items-center", "gap-2"], ["type", "button", 1, "px-3", "py-1.5", "text-sm", "border", "rounded-lg", "disabled:opacity-50", "bg-white", 3, "click", "disabled"], [1, "px-2", "py-2", "w-[100px]"], [1, "truncate", "text-sm", "font-medium", "m-0"], [1, "px-2", "py-2", "w-[75px]"], [1, "inline-flex", "items-center", "px-2", "py-1", "rounded", "text-xs", "font-medium", "bg-blue-100", "text-blue-800", "whitespace-nowrap", "max-w-[70px]", "h-[24px]", "min-h-[24px]", "overflow-hidden", "text-ellipsis"], [1, "px-2", "py-2", "w-[85px]"], [1, "px-2", "py-2", "w-[110px]"], [1, "inline-flex", "items-center", "px-2", "py-1", "rounded", "text-xs", "font-medium", "bg-gray-100", "text-gray-600", "whitespace-nowrap", "max-w-[105px]", "h-[24px]", "min-h-[24px]", "overflow-hidden", "text-ellipsis"], [1, "px-2", "py-2", "w-[140px]"], [1, "truncate", "text-sm", "block", "m-0"], [1, "px-2", "py-2", "w-[75px]", "text-xs"], [1, "px-2", "py-2", "w-[45px]"], ["title", "Ver", 1, "text-blue-600", "hover:text-blue-800", "text-sm", "p-1", 3, "click"], [1, "pi", "pi-arrow-right", "w-4", "h-4"]], template: function LeadsList_Template(rf, ctx) {
    if (rf & 1) {
      const _r1 = \u0275\u0275getCurrentView();
      ...
      \u0275\u0275conditionalCreate(15, LeadsList_Conditional_15_Template, 2, 0, "div", 15)(16, LeadsList_Conditional_16_Template, 2, 0, "div", 15)(17, LeadsList_Conditional_17_Template, 4, 1);
      \u0275\u0275elementEnd()()()();
      \u0275\u0275template(18, LeadsList_ng_template_18_Template, 22, 13, "ng-template", null, 0, \u0275\u0275templateRefExtractor);
    }
    if (rf & 2) {
      let tmp_9_0;
      const tableTemplate_r8 = \u0275\u0275reference(19);
      \u0275\u0275advance(7);
      ...
      \u0275\u0275advance(2);
      \u0275\u0275conditional(ctx.table_config().loading ? 15 : !((tmp_9_0 = ctx.table_config().rows) == null ? null : tmp_9_0.length) ? 16 : 17);
    }
  }, dependencies: [
    CommonModule,
    FormsModule,
...
(() => {
  ...
  <div class="leads-content">\r
    <div class="px-0 sm:px-4">\r
      <div class="flex flex-col gap-3 md:flex-row md:items-center md:justify-between mb-4">\r
        <h2 class="text-xl sm:text-2xl font-semibold text-gray-800">Leads</h2>\r
\r
...
\r
      <div class="block md:hidden">\r
        @if (table_config().loading) {\r
          <div class="py-10 text-center text-gray-500 text-sm">Cargando leads...</div>\r
        } @else if (!table_config().rows?.length) {\r
          <div class="py-10 text-center text-gray-500 text-sm">No se encontraron leads</div>\r
        } @else {\r
          <div class="space-y-3">\r
            @for (item of table_config().rows; track item.id) {\r
              <div\r
                ...
                <div class="flex justify-between items-start gap-2 mb-2">\r
                  <h3 class="font-semibold text-gray-900 truncate flex-1">{{ item.name }}</h3>\r
                  <span class="inline-flex items-center px-1.5 py-0.5 rounded text-xs font-medium bg-blue-100 text-blue-800 shrink-0">\r
...
//# sourceMappingURL=chunk-NPDYGCET.js.map
