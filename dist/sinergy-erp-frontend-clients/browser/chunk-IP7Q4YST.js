...
import {
  PosEquipmentService
} from "./chunk-OBQOIJFD.js";
import {
  BranchService
} from "./chunk-W5BEW64X.js";
import {
  WarehouseService
...
function OpenShiftDialogComponent_Conditional_12_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275elementEnd();
    \u0275\u0275repeaterCreate(3, OpenShiftDialogComponent_Conditional_12_For_4_Template, 2, 2, "option", 25, _forTrack0);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext();
...
function OpenShiftDialogComponent_Conditional_21_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275listener("ngModelChange", function OpenShiftDialogComponent_Conditional_21_Template_select_ngModelChange_0_listener($event) {
      \u0275\u0275restoreView(_r4);
      const ctx_r1 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r1.selectedPosConfigurationId.set($event));
    });
    \u0275\u0275elementStart(1, "option", 24);
    \u0275\u0275text(2, "Selecciona un equipo");
    \u0275\u0275elementEnd();
    \u0275\u0275repeaterCreate(3, OpenShiftDialogComponent_Conditional_21_For_4_Template, 2, 2, "option", 25, _forTrack0);
    \u0275\u0275elementEnd();
...
var OpenShiftDialogComponent = class _OpenShiftDialogComponent {
  ...
  constructor(dialogRef, warehouseService, branchService, posEquipmentService) {
  ...
  static \u0275fac = function OpenShiftDialogComponent_Factory(__ngFactoryType__) {
    return new (__ngFactoryType__ || _OpenShiftDialogComponent)(\u0275\u0275directiveInject(MatDialogRef), \u0275\u0275directiveInject(WarehouseService), \u0275\u0275directiveInject(BranchService), \u0275\u0275directiveInject(PosEquipmentService));
  };
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _OpenShiftDialogComponent, selectors: [["app-open-shift-dialog"]], decls: 42, vars: 6, consts: [[1, "open-pos-dialog"], ["mat-dialog-title", "", 1, "open-pos-dialog__title"], [1, "open-pos-dialog__body"], [1, "open-pos-dialog__fields"], [1, "hint"], [1, "form-field"], ["for", "branch"], [1, "req"], [1, "error-inline"], ["id", "branch", "required", "", 3, "ngModel"], ["for", "equipment"], [1, "hint", "hint--warn"], ["for", "balance"], [1, "currency-input"], [1, "currency-input__sym"], ["type", "number", "id", "balance", "min", "0", "step", "0.01", "required", "", 3, "ngModelChange", "ngModel"], ["for", "notes"], [1, "optional"], ["type", "text", "id", "notes", "placeholder", "Ej. apertura matutina", "maxlength", "200", 3, "ngModelChange", "ngModel"], [1, "open-pos-dialog__info"], ["align", "end", 1, "open-pos-dialog__actions"], ["type", "button", "mat-button", "", 1, "btn-cancel", 3, "click"], ["type", "button", "mat-raised-button", "", 1, "btn-confirm", 3, "click", "disabled"], ["id", "branch", "required", "", 3, "ngModelChange", "ngModel"], ["value", ""], [3, "value"], ["id", "equipment", "required", "", 3, "ngModelChange", "ngModel"]], template: function OpenShiftDialogComponent_Template(rf, ctx) {
    if (rf & 1) {
      ...
      \u0275\u0275text(24, "Efectivo inicial *");
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(25, "div", 13)(26, "span", 14);
      \u0275\u0275text(27, "$");
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(28, "input", 15);
      \u0275\u0275listener("ngModelChange", function OpenShiftDialogComponent_Template_input_ngModelChange_28_listener($event) {
      ...
      \u0275\u0275listener("ngModelChange", function OpenShiftDialogComponent_Template_input_ngModelChange_34_listener($event) {
        return ctx.notes.set($event);
      });
      \u0275\u0275elementEnd()();
      \u0275\u0275elementStart(35, "p", 19);
      \u0275\u0275text(36, " Primero la sucursal, luego el equipo. El almac\xE9n se elige solo si coincide con la sucursal del equipo. ");
      \u0275\u0275elementEnd()()();
      \u0275\u0275elementStart(37, "mat-dialog-actions", 20)(38, "button", 21);
      \u0275\u0275listener("click", function OpenShiftDialogComponent_Template_button_click_38_listener() {
        return ctx.onCancel();
      });
      \u0275\u0275text(39, "Cancelar");
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(40, "button", 22);
      \u0275\u0275listener("click", function OpenShiftDialogComponent_Template_button_click_40_listener() {
        return ctx.onConfirm();
      });
      \u0275\u0275text(41, " Iniciar sesi\xF3n ");
      \u0275\u0275elementEnd()()();
    }
    if (rf & 2) {
      \u0275\u0275advance(5);
...
//# sourceMappingURL=chunk-IP7Q4YST.js.map
