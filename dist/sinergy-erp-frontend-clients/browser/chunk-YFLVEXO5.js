...
var InterceptorService = class _InterceptorService {
  ...
  toast;
  route;
  constructor(router, auth_service, dialog, toast, route) {
    this.router = router;
  ...
  static \u0275fac = function InterceptorService_Factory(__ngFactoryType__) {
    return new (__ngFactoryType__ || _InterceptorService)(\u0275\u0275inject(Router), \u0275\u0275inject(AuthService), \u0275\u0275inject(MatDialog), \u0275\u0275inject(ToastService), \u0275\u0275inject(ActivatedRoute));
  };
...
(() => {
  ...
  }], () => [{ type: Router }, { type: AuthService }, { type: MatDialog }, { type: ToastService }, { type: ActivatedRoute }], null);
})();
...
//# sourceMappingURL=chunk-YFLVEXO5.js.map
