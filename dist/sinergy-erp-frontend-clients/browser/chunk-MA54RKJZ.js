...
} from "./chunk-YFMYHKXM.js";
import {
  VendorService
} from "./chunk-TEQP5W63.js";
import "./chunk-BEZG3W6X.js";
import {
...
import "./chunk-HCYLGR2Q.js";
import "./chunk-U6P37MEJ.js";
...
var CreatePurchaseOrderModalComponent = class _CreatePurchaseOrderModalComponent {
  ...
  loadDropdownData() {
    ...
    Promise.all([
      ...
      this.vendors = vendorRows.map((vendor) => __spreadProps(__spreadValues({}, vendor), {
  ...
  filterVendors(search) {
    const raw = typeof search === "string" ? search : search?.display_name || this.formatVendorLabel(search);
    const term = String(raw || "").toLowerCase().trim();
    if (!term) {
      this.filteredVendors = [...this.vendors];
      return;
    }
    this.filteredVendors = this.vendors.filter((vendor) => String(vendor.display_name || "").toLowerCase().includes(term));
  }
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(CreatePurchaseOrderModalComponent, { className: "CreatePurchaseOrderModalComponent", filePath: "src/app/features/purchase-orders/components/create-purchase-order-modal/create-purchase-order-modal.component.ts", lineNumber: 34 });
})();
...
@angular/core/fesm2022/rxjs-interop.mjs:
   ...
   *)
*/
//# sourceMappingURL=chunk-MA54RKJZ.js.map
