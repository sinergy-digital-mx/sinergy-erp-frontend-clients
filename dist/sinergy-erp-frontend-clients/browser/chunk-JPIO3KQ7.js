...
var PURCHASE_ORDERS_ROUTES = [
  {
    path: "",
    loadComponent: () => import("./chunk-MA54RKJZ.js").then((m) => m.PurchaseOrderListComponent),
  ...
  {
    path: "create",
    loadComponent: () => import("./chunk-FY3BZWGX.js").then((m) => m.PurchaseOrderFormComponent),
    canActivate: [permissionGuard],
    data: {
  ...
  {
    path: ":id",
    loadComponent: () => import("./chunk-BJMW6USN.js").then((m) => m.PurchaseOrderDetailComponent),
    canActivate: [permissionGuard],
    data: {
...
//# sourceMappingURL=chunk-JPIO3KQ7.js.map
