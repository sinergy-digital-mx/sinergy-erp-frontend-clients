...
var AsyncAnimationRendererFactory = class _AsyncAnimationRendererFactory {
  ...
  loadImpl() {
    const loadFn = () => this.moduleImpl ?? import("./chunk-YMDW4MTI.js").then((m5) => m5);
...
function Sidebar_Conditional_8_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275text(1, "Sistema ERP");
    \u0275\u0275elementEnd();
  }
}
function Sidebar_For_13_Conditional_2_Template(rf, ctx) {
  if (rf & 1) {
...
function Sidebar_For_13_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "a", 17);
    \u0275\u0275element(1, "lucide-icon", 11);
    \u0275\u0275conditionalCreate(2, Sidebar_For_13_Conditional_2_Template, 2, 1, "span", 18);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    const item_r1 = ctx.$implicit;
    const ctx_r1 = \u0275\u0275nextContext();
    \u0275\u0275classMap("nav-item flex items-center rounded-lg transition-all duration-200 " + (ctx_r1.isCollapsed() ? "gap-0 px-2 py-2.5 justify-center" : "gap-3 px-3 py-2.5"));
    \u0275\u0275property("routerLink", item_r1.route)("routerLinkActiveOptions", \u0275\u0275pureFunction0(7, _c0))("title", ctx_r1.isCollapsed() ? item_r1.label : "");
    \u0275\u0275advance();
    \u0275\u0275property("img", item_r1.icon);
    \u0275\u0275advance();
    \u0275\u0275conditional(!ctx_r1.isCollapsed() ? 2 : -1);
  }
}
...
function Sidebar_Conditional_21_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "span", 12);
    \u0275\u0275text(1, "Configuraci\xF3n");
    \u0275\u0275elementEnd();
  }
}
function Sidebar_Conditional_23_Conditional_1_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 20);
    \u0275\u0275text(1, " \u{1F1FA}\u{1F1F8}\u{1F1F2}\u{1F1FD} ");
    \u0275\u0275elementEnd();
  }
}
function Sidebar_Conditional_23_Conditional_2_Template(rf, ctx) {
  if (rf & 1) {
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance(6);
    \u0275\u0275textInterpolate(\u0275\u0275pipeBind2(7, 1, ctx_r1.todayUsdMxnRate(), "1.2-4"));
  }
}
function Sidebar_Conditional_23_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "a", 19);
    \u0275\u0275conditionalCreate(1, Sidebar_Conditional_23_Conditional_1_Template, 2, 0, "div", 20)(2, Sidebar_Conditional_23_Conditional_2_Template, 8, 4);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext();
    \u0275\u0275classMap("mb-3 block rounded-md border border-white/15 bg-white/10 text-white hover:bg-white/15 transition-colors " + (ctx_r1.isCollapsed() ? "px-1.5 py-1.5 text-center" : "px-2 py-1.5"));
    \u0275\u0275advance();
    \u0275\u0275conditional(ctx_r1.isCollapsed() ? 1 : 2);
  }
}
function Sidebar_Conditional_24_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275listener("click", function Sidebar_Conditional_24_Template_button_click_3_listener() {
      \u0275\u0275restoreView(_r3);
      const ctx_r1 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r1.auth_service.logout());
    });
    \u0275\u0275element(4, "lucide-icon", 27);
    \u0275\u0275elementEnd()();
  }
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext();
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate1(" ", ctx_r1.getInitials(ctx_r1.auth_service.user_info == null ? null : ctx_r1.auth_service.user_info.email), " ");
    \u0275\u0275advance(2);
    \u0275\u0275property("img", ctx_r1.icons.LogOut);
  }
}
function Sidebar_Conditional_25_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275listener("click", function Sidebar_Conditional_25_Template_button_click_9_listener() {
      \u0275\u0275restoreView(_r4);
      const ctx_r1 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r1.auth_service.logout());
    });
    \u0275\u0275element(10, "lucide-icon", 27);
    \u0275\u0275elementEnd()();
  }
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext();
    ...
    \u0275\u0275advance();
    \u0275\u0275property("title", ctx_r1.auth_service.user_info == null ? null : ctx_r1.auth_service.user_info.email);
    \u0275\u0275advance();
    \u0275\u0275textInterpolate(ctx_r1.auth_service.user_info == null ? null : ctx_r1.auth_service.user_info.email);
    \u0275\u0275advance(2);
    \u0275\u0275property("img", ctx_r1.icons.LogOut);
  }
}
var Sidebar = class _Sidebar {
  ...
  visibleMenuItems = signal([], ...ngDevMode ? [{ debugName: "visibleMenuItems" }] : []);
  ...
  menuIdCounter = 0;
  icons = { Home: House, Users, CreditCard, Bell, Settings, LogOut, FileText, MapPin, FileCheck, DollarSign, Megaphone, LandPlot, ShoppingCart, Package, ShoppingBag, Monitor, ChevronLeft, ChevronRight };
  constructor(auth_service, sidebarService, exchangeRateService) {
  ...
  updateVisibleMenuItems() {
    ...
    this.visibleMenuItems.set(this.menu.filter((item) => {
  ...
  static \u0275fac = function Sidebar_Factory(__ngFactoryType__) {
    return new (__ngFactoryType__ || _Sidebar)(\u0275\u0275directiveInject(AuthService), \u0275\u0275directiveInject(SidebarService), \u0275\u0275directiveInject(ExchangeRateService));
  };
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _Sidebar, selectors: [["app-sidebar"]], decls: 26, vars: 25, consts: [[1, "toggle-btn", "fixed", "top-6", "z-50", "w-7", "h-7", "bg-white", "rounded-full", "shadow-lg", "flex", "items-center", "justify-center", "hover:scale-110", "transition-transform", 3, "click"], [1, "w-4", "h-4", "text-purple-600", 3, "img"], [1, "flex", "flex-col"], [1, "logo-section", "px-6", "py-6", "border-b", "border-white/10"], [1, "text-center"], [1, "text-white/60", "text-sm", "mt-1", "font-light"], [1, "text-base", "font-semibold", "mb-6", "opacity-80", "tracking-tight", "text-white/70"], [1, "flex", "flex-col", "gap-1.5"], ["routerLinkActive", "router-link-active", 3, "routerLink", "routerLinkActiveOptions", "class", "title"], [1, "mt-6", "mb-4", "border-t", "border-white/20"], ["routerLink", "/notifications", 3, "title"], [1, "w-4", "h-4", "shrink-0", 3, "img"], [1, "font-medium"], ["routerLink", "/settings", 3, "title"], ["routerLink", "/settings/exchange-rates", 3, "class"], [1, "flex", "flex-col", "items-center", "gap-3"], [1, "flex", "items-center", "justify-between", "text-[14px]"], ["routerLinkActive", "router-link-active", 3, "routerLink", "routerLinkActiveOptions", "title"], [1, "font-medium", "whitespace-nowrap"], ["routerLink", "/settings/exchange-rates"], ["title", "Tipo de cambio USD/MXN", 1, "text-[11px]"], [1, "text-[9px]", "text-white/65", "uppercase", "tracking-wide", "leading-none"], [1, "flex", "items-center", "justify-between", "mt-1", "leading-none"], [1, "text-[11px]"], [1, "font-semibold", "text-[13px]"], [1, "user-avatar", "w-10", "h-10", "rounded-full", "flex", "items-center", "justify-center", "text-xs", "font-semibold"], ["title", "Cerrar sesi\xF3n", 1, "p-2", "rounded-full", "hover:bg-white/10", "transition-colors", 3, "click"], [1, "w-4", "h-4", 3, "img"], [1, "flex", "items-center", "gap-3", "user-info", "min-w-0"], [1, "user-avatar", "w-8", "h-8", "rounded-full", "flex", "items-center", "justify-center", "text-xs", "font-semibold", "shrink-0"], [1, "min-w-0"], [1, "user-name", "font-medium", "leading-tight"], [1, "user-email", "text-[12px]", "truncate", 3, "title"], ["title", "Cerrar sesi\xF3n", 1, "p-1.5", "rounded-full", "hover:bg-white/10", "transition-colors", "shrink-0", "ml-2", 3, "click"]], template: function Sidebar_Template(rf, ctx) {
    if (rf & 1) {
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && setClassMetadata(Sidebar, [{
    ...
    <div class="flex flex-col">
        ...
        <div class="logo-section px-6 py-6 border-b border-white/10">
            <div class="text-center">
                <h1 [class]="'font-bold text-white tracking-wide transition-all duration-300 ' + (isCollapsed() ? 'text-lg' : 'text-2xl')">
                    {{ isCollapsed() ? 'S' : 'Sinergy' }}
                </h1>
                @if (!isCollapsed()) {
        ...
        <div [class]="'flex flex-col pt-6 transition-all duration-300 ' + (isCollapsed() ? 'px-2' : 'px-4')">
        ...
        <nav class="flex flex-col gap-1.5">
          @for(item of visibleMenuItems(); track item.id) {
            <a [routerLink]="item.route" 
               ...
               [class]="'nav-item flex items-center rounded-lg transition-all duration-200 ' + (isCollapsed() ? 'gap-0 px-2 py-2.5 justify-center' : 'gap-3 px-3 py-2.5')"
        ...
        <nav class="flex flex-col gap-1.5">
            ...
            <a routerLink="/settings" 
               [class]="'nav-item flex items-center rounded-lg transition-all duration-200 ' + (isCollapsed() ? 'gap-0 px-2 py-2.5 justify-center' : 'gap-3 px-3 py-2.5')"
               [title]="isCollapsed() ? 'Configuraci\xF3n' : ''">
                <lucide-icon [img]="icons.Settings" class="w-4 h-4 shrink-0"></lucide-icon>
                @if (!isCollapsed()) {
                    <span class="font-medium">Configuraci\xF3n</span>
                }
            </a>
        </nav>
        </div>
    ...
    <div [class]="'user-section py-5 transition-all duration-300 ' + (isCollapsed() ? 'px-2' : 'px-6')">
        @if (todayUsdMxnRate() !== null) {
            <a
                routerLink="/settings/exchange-rates"
                [class]="'mb-3 block rounded-md border border-white/15 bg-white/10 text-white hover:bg-white/15 transition-colors ' + (isCollapsed() ? 'px-1.5 py-1.5 text-center' : 'px-2 py-1.5')">
                @if (isCollapsed()) {
                    <div class="text-[11px]" title="Tipo de cambio USD/MXN">
                        \u{1F1FA}\u{1F1F8}\u{1F1F2}\u{1F1FD}
                    </div>
                } @else {
...
var MainLayout = class _MainLayout {
  ...
  static \u0275fac = function MainLayout_Factory(__ngFactoryType__) {
    return new (__ngFactoryType__ || _MainLayout)(\u0275\u0275directiveInject(PermissionSyncService));
  };
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _MainLayout, selectors: [["app-main-layout"]], decls: 4, vars: 0, consts: [[1, "flex", "h-screen", "overflow-hidden"], [1, "h-full", "overflow-y-auto"], [1, "flex-1", "p-4", "bg-gray-100", "overflow-y-auto"]], template: function MainLayout_Template(rf, ctx) {
    if (rf & 1) {
  ...
  }, dependencies: [RouterOutlet, Sidebar], encapsulation: 2 });
};
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && setClassMetadata(MainLayout, [{
    type: Component,
    args: [{ selector: "app-main-layout", imports: [RouterOutlet, Sidebar], template: '<div class="flex h-screen overflow-hidden">\r\n  <app-sidebar class="h-full overflow-y-auto"></app-sidebar>\r\n  <main class="flex-1 p-4 bg-gray-100 overflow-y-auto">\r\n      <router-outlet></router-outlet>\r\n  </main>\r\n</div>\r\n' }]
  }], () => [{ type: PermissionSyncService }], null);
})();
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(MainLayout, { className: "MainLayout", filePath: "src/app/layout/main-layout/main-layout.ts", lineNumber: 12 });
})();
...
var routes = [
  // LOGIN (público)
  {
    ...
    loadComponent: () => import("./chunk-VG762OBZ.js").then((m5) => m5.Login)
  },
  // POS - Tomar Orden y Cobrar Orden (pantalla completa, sin layout)
  {
    path: "pos/pending-orders",
    canActivate: [AuthGuard],
    loadComponent: () => import("./chunk-QFY2J5NT.js").then((m5) => m5.PendingOrdersComponent),
    data: {
      permission: "pos:Read",
  ...
  },
  {
    path: "pos/payment",
    canActivate: [AuthGuard],
    loadComponent: () => import("./chunk-XN3NH3CI.js").then((m5) => m5.PaymentComponent),
    data: {
  ...
  // APP PROTEGIDA
  {
    ...
    children: [
      {
        path: "leads",
        loadChildren: () => import("./chunk-JXLV64FU.js").then((m5) => m5.LEADS_ROUTES)
      },
      {
        path: "customers",
        loadChildren: () => import("./chunk-HYRNXVXQ.js").then((m5) => m5.CUSTOMERS_ROUTES)
      },
      {
        path: "properties",
        loadChildren: () => import("./chunk-IX4THMP6.js").then((m5) => m5.PROPERTIES_ROUTES)
      },
      {
        path: "contracts",
        loadChildren: () => import("./chunk-R74KB6S7.js").then((m5) => m5.CONTRACTS_ROUTES)
      },
      {
        path: "settings",
        loadChildren: () => import("./chunk-NDEA37OC.js").then((m5) => m5.RBAC_TENANT_UI_ROUTES)
      },
      {
        path: "marketing",
        loadChildren: () => import("./chunk-BS3V7EHU.js").then((m5) => m5.MARKETING_ROUTES)
      },
      {
        path: "purchase-orders",
        loadChildren: () => import("./chunk-FR7UNO2N.js").then((m5) => m5.PURCHASE_ORDERS_ROUTES)
      },
      {
        path: "inventory",
        loadChildren: () => import("./chunk-55C24KVX.js").then((m5) => m5.INVENTORY_ROUTES)
      },
      {
        path: "sales-orders",
        loadChildren: () => import("./chunk-6ORXP6CY.js").then((m5) => m5.SALES_ORDERS_ROUTES)
      },
      {
        path: "pos",
        loadComponent: () => import("./chunk-Q4YA75U3.js").then((m5) => m5.TakeOrderComponent),
        data: {
      ...
      },
      {
        ...
        loadChildren: () => import("./chunk-VZNWHG5M.js").then((m5) => m5.ZONA_NORTE_REPORTS_ROUTES)
      },
      {
        path: "divino-dashboard",
        loadChildren: () => import("./chunk-GEVPWQ2W.js").then((m5) => m5.DIVINO_DASHBOARD_ROUTES)
      },
      {
        path: "",
