...
} from "./chunk-MHDLACOP.js";
import {
  PERMISSIONS
} from "./chunk-VUEUXNXN.js";
...
import {
  ke,
  providePrimeNG
} from "./chunk-R5B5TFIR.js";
import {
  InterceptorService
} from "./chunk-6WX4EKZ5.js";
import "./chunk-FZGRRB5W.js";
import "./chunk-YLZRJESW.js";
import {
  Bell,
  ChevronLeft,
  ChevronRight,
...
var AsyncAnimationRendererFactory = class _AsyncAnimationRendererFactory {
  ...
  loadImpl() {
    const loadFn = () => this.moduleImpl ?? import("./chunk-EODCWFUD.js").then((m5) => m5);
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(Sidebar, { className: "Sidebar", filePath: "src/app/core/components/sidebar/sidebar.ts", lineNumber: 45 });
})();
...
var routes = [
  // LOGIN (público)
  {
    ...
    loadComponent: () => import("./chunk-2NJMXFM6.js").then((m5) => m5.Login)
  },
  // POS - Tomar Orden y Cobrar Orden (pantalla completa, sin layout)
  {
    path: "pos/pending-orders",
    canActivate: [AuthGuard],
    loadComponent: () => import("./chunk-HOQ7XJDY.js").then((m5) => m5.PendingOrdersComponent),
    data: {
      permission: "pos:Read",
  ...
  },
  {
    path: "pos/payment",
    canActivate: [AuthGuard],
    loadComponent: () => import("./chunk-BS3Y6HJM.js").then((m5) => m5.PaymentComponent),
    data: {
  ...
  // APP PROTEGIDA
  {
    ...
    children: [
      {
        path: "leads",
        loadChildren: () => import("./chunk-JOVBBT37.js").then((m5) => m5.LEADS_ROUTES)
      },
      {
        path: "customers",
        loadChildren: () => import("./chunk-5SGJ2AWT.js").then((m5) => m5.CUSTOMERS_ROUTES)
      },
      {
        path: "properties",
        loadChildren: () => import("./chunk-43P5RZJB.js").then((m5) => m5.PROPERTIES_ROUTES)
      },
      {
        path: "contracts",
        loadChildren: () => import("./chunk-PQOXFVFG.js").then((m5) => m5.CONTRACTS_ROUTES)
      },
      {
        path: "settings",
        loadChildren: () => import("./chunk-5COFHPHX.js").then((m5) => m5.RBAC_TENANT_UI_ROUTES)
      },
      {
        path: "marketing",
        loadChildren: () => import("./chunk-2HECCXXP.js").then((m5) => m5.MARKETING_ROUTES)
      },
      {
        path: "purchase-orders",
        loadChildren: () => import("./chunk-JPIO3KQ7.js").then((m5) => m5.PURCHASE_ORDERS_ROUTES)
      },
      {
        path: "inventory",
        loadChildren: () => import("./chunk-HV6HJJTE.js").then((m5) => m5.INVENTORY_ROUTES)
      },
      {
        path: "sales-orders",
        loadChildren: () => import("./chunk-YGG4KHM3.js").then((m5) => m5.SALES_ORDERS_ROUTES)
      },
      {
        path: "pos",
        loadComponent: () => import("./chunk-4TGZHW2U.js").then((m5) => m5.TakeOrderComponent),
        data: {
      ...
      },
      {
        ...
        loadChildren: () => import("./chunk-XD4XAUD7.js").then((m5) => m5.ZONA_NORTE_REPORTS_ROUTES)
      },
      {
        path: "",
