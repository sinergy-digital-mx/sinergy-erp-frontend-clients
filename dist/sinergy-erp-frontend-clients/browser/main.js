...
var AsyncAnimationRendererFactory = class _AsyncAnimationRendererFactory {
  ...
  loadImpl() {
    const loadFn = () => this.moduleImpl ?? import("./chunk-UI77NJCI.js").then((m5) => m5);
...
function Sidebar_For_12_Conditional_1_Template(rf, ctx) {
  if (rf & 1) {
...
function Sidebar_For_12_Conditional_2_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275element(0, "div", 15);
  }
}
function Sidebar_For_12_For_5_Conditional_2_Template(rf, ctx) {
  if (rf & 1) {
...
function Sidebar_For_12_For_5_Template(rf, ctx) {
  if (rf & 1) {
    const _r2 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "a", 18);
    \u0275\u0275listener("click", function Sidebar_For_12_For_5_Template_a_click_0_listener() {
      \u0275\u0275restoreView(_r2);
      const ctx_r2 = \u0275\u0275nextContext(2);
      return \u0275\u0275resetView(ctx_r2.closeMobileMenu());
    });
    \u0275\u0275element(1, "lucide-icon", 19);
    \u0275\u0275conditionalCreate(2, Sidebar_For_12_For_5_Conditional_2_Template, 2, 1, "span", 20);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    const item_r4 = ctx.$implicit;
    const ctx_r2 = \u0275\u0275nextContext(2);
    \u0275\u0275classMap("nav-item flex items-center rounded-lg transition-all duration-200 " + (ctx_r2.isCollapsed() && !ctx_r2.isMobileOpen() ? "gap-0 px-2 py-2.5 justify-center" : "gap-3 px-3 py-2.5"));
    \u0275\u0275property("routerLink", item_r4.route)("routerLinkActiveOptions", \u0275\u0275pureFunction0(7, _c0))("title", ctx_r2.isCollapsed() && !ctx_r2.isMobileOpen() ? item_r4.label : "");
    \u0275\u0275advance();
    \u0275\u0275property("img", item_r4.icon);
    \u0275\u0275advance();
    \u0275\u0275conditional(!ctx_r2.isCollapsed() || ctx_r2.isMobileOpen() ? 2 : -1);
  }
}
function Sidebar_For_12_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 13);
    \u0275\u0275conditionalCreate(1, Sidebar_For_12_Conditional_1_Template, 2, 1, "h3", 14)(2, Sidebar_For_12_Conditional_2_Template, 1, 0, "div", 15);
    \u0275\u0275elementStart(3, "div", 16);
    \u0275\u0275repeaterCreate(4, Sidebar_For_12_For_5_Template, 3, 8, "a", 17, _forTrack0);
    \u0275\u0275elementEnd()();
  }
  if (rf & 2) {
    ...
    \u0275\u0275classProp("nav-section--first", \u0275$index_23_r5 === 0);
    \u0275\u0275advance();
    \u0275\u0275conditional(!ctx_r2.isCollapsed() || ctx_r2.isMobileOpen() ? 1 : !(\u0275$index_23_r5 === 0) ? 2 : -1);
    \u0275\u0275advance(3);
    \u0275\u0275repeater(section_r1.items);
  }
}
function Sidebar_Conditional_14_Conditional_1_Template(rf, ctx) {
  if (rf & 1) {
  ...
  if (rf & 2) {
    const ctx_r2 = \u0275\u0275nextContext(2);
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate(\u0275\u0275pipeBind2(4, 1, ctx_r2.todayUsdMxnRate(), "1.2-2"));
  }
}
function Sidebar_Conditional_14_Conditional_2_Template(rf, ctx) {
  if (rf & 1) {
  ...
  if (rf & 2) {
    const ctx_r2 = \u0275\u0275nextContext(2);
    \u0275\u0275advance(10);
    \u0275\u0275textInterpolate(\u0275\u0275pipeBind2(11, 1, ctx_r2.todayUsdMxnRate(), "1.2-4"));
  }
}
function Sidebar_Conditional_14_Template(rf, ctx) {
  if (rf & 1) {
    const _r6 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "a", 21);
    \u0275\u0275listener("click", function Sidebar_Conditional_14_Template_a_click_0_listener() {
      \u0275\u0275restoreView(_r6);
      const ctx_r2 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r2.closeMobileMenu());
    });
    \u0275\u0275conditionalCreate(1, Sidebar_Conditional_14_Conditional_1_Template, 5, 4)(2, Sidebar_Conditional_14_Conditional_2_Template, 12, 4);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    const ctx_r2 = \u0275\u0275nextContext();
    \u0275\u0275classProp("fx-card--compact", ctx_r2.isCollapsed() && !ctx_r2.isMobileOpen());
    \u0275\u0275advance();
    \u0275\u0275conditional(ctx_r2.isCollapsed() && !ctx_r2.isMobileOpen() ? 1 : 2);
  }
}
function Sidebar_Conditional_15_Template(rf, ctx) {
  if (rf & 1) {
    const _r7 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "div", 11)(1, "div", 31);
    \u0275\u0275text(2);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(3, "button", 32);
    \u0275\u0275listener("click", function Sidebar_Conditional_15_Template_button_click_3_listener() {
      \u0275\u0275restoreView(_r7);
      const ctx_r2 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r2.auth_service.logout());
    });
    \u0275\u0275element(4, "lucide-icon", 33);
    \u0275\u0275elementEnd()();
  }
  if (rf & 2) {
    const ctx_r2 = \u0275\u0275nextContext();
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate1(" ", ctx_r2.getInitials(ctx_r2.auth_service.user_info == null ? null : ctx_r2.auth_service.user_info.email), " ");
    \u0275\u0275advance(2);
    \u0275\u0275property("img", ctx_r2.icons.LogOut);
  }
}
function Sidebar_Conditional_16_Template(rf, ctx) {
  if (rf & 1) {
    const _r8 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "div", 12)(1, "div", 34)(2, "div", 35);
    \u0275\u0275text(3);
    \u0275\u0275elementEnd();
    ...
    \u0275\u0275listener("click", function Sidebar_Conditional_16_Template_button_click_9_listener() {
      \u0275\u0275restoreView(_r8);
      const ctx_r2 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r2.auth_service.logout());
    });
  ...
  if (rf & 2) {
    ...
    \u0275\u0275textInterpolate1(" ", ctx_r2.getInitials(ctx_r2.auth_service.user_info == null ? null : ctx_r2.auth_service.user_info.email), " ");
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate(ctx_r2.getUserName());
    \u0275\u0275advance();
    \u0275\u0275property("title", ctx_r2.auth_service.user_info == null ? null : ctx_r2.auth_service.user_info.email);
    \u0275\u0275advance();
    \u0275\u0275textInterpolate(ctx_r2.auth_service.user_info == null ? null : ctx_r2.auth_service.user_info.email);
    \u0275\u0275advance(2);
    \u0275\u0275property("img", ctx_r2.icons.LogOut);
  }
}
...
var Sidebar = class _Sidebar {
  ...
  isCollapsed = signal(false, ...ngDevMode ? [{ debugName: "isCollapsed" }] : []);
  isMobileOpen = signal(false, ...ngDevMode ? [{ debugName: "isMobileOpen" }] : []);
  todayUsdMxnRate = signal(null, ...ngDevMode ? [{ debugName: "todayUsdMxnRate" }] : []);
  visibleMenuSections = signal([], ...ngDevMode ? [{ debugName: "visibleMenuSections" }] : []);
  ...
  icons = { Home: House, Users, CreditCard, Bell, Settings, LogOut, FileText, MapPin, FileCheck, DollarSign, Megaphone, LandPlot, ShoppingCart, Package, ShoppingBag, Monitor, ChevronLeft, ChevronRight, X, Landmark };
  constructor(auth_service, sidebarService, exchangeRateService, router) {
  ...
  updateVisibleMenuSections() {
    ...
    const visibleItems = this.getMenuItems().filter((item) => {
      ...
      if (item.id === "menu-pos" && this.auth_service.getPosUserType() === "COBRANZA") {
        return ["pos:Update", "pos:Read", "pos:ViewMenu"].some((p4) => this.auth_service.hasPermission(p4));
      }
      if (!item.permission) {
        return true;
      }
    ...
    this.visibleMenuSections.set(MENU_SECTIONS.map((section) => ({
      id: section.id,
      title: section.title,
      items: section.itemIds.map((id) => itemById.get(id)).filter((item) => item != null)
  ...
  static \u0275fac = function Sidebar_Factory(__ngFactoryType__) {
    return new (__ngFactoryType__ || _Sidebar)(\u0275\u0275directiveInject(AuthService), \u0275\u0275directiveInject(SidebarService), \u0275\u0275directiveInject(ExchangeRateService), \u0275\u0275directiveInject(Router));
  };
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _Sidebar, selectors: [["app-sidebar"]], decls: 17, vars: 13, consts: [[1, "toggle-btn", "hidden", "lg:flex", "fixed", "top-6", "z-50", "w-7", "h-7", "bg-white", "rounded-full", "shadow-lg", "items-center", "justify-center", "hover:scale-110", "transition-transform", 3, "click"], [1, "w-4", "h-4", "text-purple-600", 3, "img"], ["type", "button", "aria-label", "Cerrar men\xFA", 1, "mobile-close-btn", "lg:hidden", 3, "click"], [1, "w-5", "h-5", 3, "img"], [1, "flex", "flex-col", "flex-1", "overflow-y-auto"], [1, "logo-section", "px-6", "py-6", "border-b", "border-white/10"], [1, "text-center"], [3, "compact"], [1, "flex", "flex-col"], [1, "nav-section", 3, "nav-section--first"], ["routerLink", "/settings/exchange-rates", "title", "Cambio USD/MXN", 1, "fx-card", 3, "fx-card--compact"], [1, "flex", "flex-col", "items-center", "gap-3"], [1, "flex", "items-center", "justify-between", "text-[14px]"], [1, "nav-section"], [1, "nav-section-title"], ["aria-hidden", "true", 1, "nav-section-spacer"], [1, "nav-section-items", "flex", "flex-col", "gap-1.5"], ["routerLinkActive", "router-link-active", 3, "routerLink", "routerLinkActiveOptions", "class", "title"], ["routerLinkActive", "router-link-active", 3, "click", "routerLink", "routerLinkActiveOptions", "title"], [1, "w-4", "h-4", "shrink-0", 3, "img"], [1, "font-medium", "whitespace-nowrap"], ["routerLink", "/settings/exchange-rates", "title", "Cambio USD/MXN", 1, "fx-card", 3, "click"], [1, "fx-card__compact-code"], [1, "fx-card__compact-value"], ["aria-hidden", "true", 1, "fx-card__currencies"], [1, "fx-card__badge", "fx-card__badge--usd"], [1, "fx-card__badge-arrow"], [1, "fx-card__badge", "fx-card__badge--mxn"], [1, "fx-card__content"], [1, "fx-card__label"], [1, "fx-card__value"], [1, "user-avatar", "w-10", "h-10", "rounded-full", "flex", "items-center", "justify-center", "text-xs", "font-semibold"], ["title", "Cerrar sesi\xF3n", 1, "p-2", "rounded-full", "hover:bg-white/10", "transition-colors", 3, "click"], [1, "w-4", "h-4", 3, "img"], [1, "flex", "items-center", "gap-3", "user-info", "min-w-0"], [1, "user-avatar", "w-8", "h-8", "rounded-full", "flex", "items-center", "justify-center", "text-xs", "font-semibold", "shrink-0"], [1, "min-w-0"], [1, "user-name", "font-medium", "leading-tight"], [1, "user-email", "text-[12px]", "truncate", 3, "title"], ["title", "Cerrar sesi\xF3n", 1, "p-1.5", "rounded-full", "hover:bg-white/10", "transition-colors", "shrink-0", "ml-2", 3, "click"]], template: function Sidebar_Template(rf, ctx) {
    if (rf & 1) {
      \u0275\u0275elementStart(0, "aside")(1, "button", 0);
      \u0275\u0275listener("click", function Sidebar_Template_button_click_1_listener() {
        return ctx.toggleSidebar();
      });
      \u0275\u0275element(2, "lucide-icon", 1);
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(3, "button", 2);
      \u0275\u0275listener("click", function Sidebar_Template_button_click_3_listener() {
        return ctx.closeMobileMenu();
      });
      \u0275\u0275element(4, "lucide-icon", 3);
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(5, "div", 4)(6, "div", 5)(7, "div", 6);
      \u0275\u0275element(8, "app-pollux-brand-text", 7);
      \u0275\u0275elementEnd()();
      \u0275\u0275elementStart(9, "div")(10, "nav", 8);
      \u0275\u0275repeaterCreate(11, Sidebar_For_12_Template, 6, 3, "div", 9, _forTrack0);
      \u0275\u0275elementEnd()()();
      \u0275\u0275elementStart(13, "div");
      \u0275\u0275conditionalCreate(14, Sidebar_Conditional_14_Template, 3, 3, "a", 10);
      \u0275\u0275conditionalCreate(15, Sidebar_Conditional_15_Template, 5, 2, "div", 11)(16, Sidebar_Conditional_16_Template, 11, 5, "div", 12);
      \u0275\u0275elementEnd()();
    }
    if (rf & 2) {
      \u0275\u0275classMap("sidebar h-screen flex flex-col justify-between text-white text-[14px] shadow-xl transition-all duration-300 " + (ctx.isMobileOpen() ? "sidebar--mobile-open " : "") + (ctx.isCollapsed() ? "w-20" : "w-60"));
      \u0275\u0275advance();
      \u0275\u0275styleProp("left", ctx.isCollapsed() ? "68px" : "228px");
      \u0275\u0275advance();
      \u0275\u0275property("img", ctx.isCollapsed() ? ctx.icons.ChevronRight : ctx.icons.ChevronLeft);
      \u0275\u0275advance(2);
      \u0275\u0275property("img", ctx.icons.X);
      \u0275\u0275advance(4);
      \u0275\u0275property("compact", ctx.isCollapsed() && !ctx.isMobileOpen());
      \u0275\u0275advance();
      \u0275\u0275classMap("flex flex-col pt-6 transition-all duration-300 " + (ctx.isCollapsed() && !ctx.isMobileOpen() ? "px-2" : "px-4"));
      \u0275\u0275advance(2);
      \u0275\u0275repeater(ctx.visibleMenuSections());
      \u0275\u0275advance(2);
      \u0275\u0275classMap("user-section py-5 transition-all duration-300 shrink-0 " + (ctx.isCollapsed() && !ctx.isMobileOpen() ? "px-2" : "px-6"));
      \u0275\u0275advance();
      \u0275\u0275conditional(ctx.todayUsdMxnRate() !== null ? 14 : -1);
      \u0275\u0275advance();
      \u0275\u0275conditional(ctx.isCollapsed() && !ctx.isMobileOpen() ? 15 : 16);
    }
  }, dependencies: [CommonModule, RouterModule, RouterLink, RouterLinkActive, LucideAngularModule, LucideAngularComponent, PolluxBrandTextComponent, DecimalPipe], styles: ['\n\n.sidebar[_ngcontent-%COMP%] {\n  background:\n    linear-gradient(\n      180deg,\n      #1e1b4b 0%,\n      #312e81 50%,\n      #4c1d95 100%);\n  border-right: 1px solid rgba(139, 92, 246, 0.15);\n  position: relative;\n}\n.sidebar[_ngcontent-%COMP%]   .toggle-btn[_ngcontent-%COMP%] {\n  transition: all 0.3s cubic-bezier(0.4, 0, 0.2, 1);\n  box-shadow: 0 2px 8px rgba(0, 0, 0, 0.15);\n}\n.sidebar[_ngcontent-%COMP%]   .toggle-btn[_ngcontent-%COMP%]:hover {\n  box-shadow: 0 4px 12px rgba(139, 92, 246, 0.4);\n}\n.sidebar[_ngcontent-%COMP%]   .logo-section[_ngcontent-%COMP%] {\n  background: rgba(0, 0, 0, 0.1);\n  border-bottom: 1px solid rgba(255, 255, 255, 0.1);\n}\n.sidebar[_ngcontent-%COMP%]   .logo-section[_ngcontent-%COMP%]   h1[_ngcontent-%COMP%] {\n  letter-spacing: 0.05em;\n}\n.sidebar[_ngcontent-%COMP%]   .logo-section[_ngcontent-%COMP%]   p[_ngcontent-%COMP%] {\n  text-transform: uppercase;\n  letter-spacing: 0.15em;\n  font-size: 0.7rem;\n  font-weight: 500;\n}\n.sidebar[_ngcontent-%COMP%]   .nav-section[_ngcontent-%COMP%]:not(.nav-section--first) {\n  margin-top: 0.75rem;\n  padding-top: 0.75rem;\n  border-top: 1px solid rgba(255, 255, 255, 0.08);\n}\n.sidebar[_ngcontent-%COMP%]   .nav-section-title[_ngcontent-%COMP%] {\n  margin: 0 0 0.5rem;\n  padding: 0 0.75rem;\n  font-size: 0.625rem;\n  font-weight: 600;\n  letter-spacing: 0.14em;\n  text-transform: uppercase;\n  color: rgba(255, 255, 255, 0.35);\n  line-height: 1.2;\n}\n.sidebar[_ngcontent-%COMP%]   .nav-section-spacer[_ngcontent-%COMP%] {\n  height: 0;\n  margin: 0.5rem 0.25rem 0.25rem;\n  border-top: 1px solid rgba(255, 255, 255, 0.08);\n}\n.sidebar[_ngcontent-%COMP%]   .nav-item[_ngcontent-%COMP%] {\n  position: relative;\n  font-weight: 500;\n  color: rgba(255, 255, 255, 0.75);\n  transition: all 0.25s cubic-bezier(0.4, 0, 0.2, 1);\n  font-size: 0.9rem;\n}\n.sidebar[_ngcontent-%COMP%]   .nav-item[_ngcontent-%COMP%]:hover {\n  background: rgba(255, 255, 255, 0.08);\n  color: rgba(255, 255, 255, 0.95);\n  transform: translateX(3px);\n}\n.sidebar[_ngcontent-%COMP%]   .nav-item[_ngcontent-%COMP%]   lucide-icon[_ngcontent-%COMP%] {\n  color: rgba(255, 255, 255, 0.65);\n  transition: all 0.25s cubic-bezier(0.4, 0, 0.2, 1);\n}\n.sidebar[_ngcontent-%COMP%]   .nav-item[_ngcontent-%COMP%]:hover   lucide-icon[_ngcontent-%COMP%] {\n  color: rgba(255, 255, 255, 0.9);\n}\n.sidebar[_ngcontent-%COMP%]   .nav-item.router-link-active[_ngcontent-%COMP%] {\n  background: rgba(255, 255, 255, 0.15);\n  color: white;\n  font-weight: 600;\n  box-shadow: inset 0 0 16px rgba(255, 255, 255, 0.08);\n}\n.sidebar[_ngcontent-%COMP%]   .nav-item.router-link-active[_ngcontent-%COMP%]   lucide-icon[_ngcontent-%COMP%] {\n  color: white;\n  filter: drop-shadow(0 0 6px rgba(255, 255, 255, 0.4));\n}\n.sidebar[_ngcontent-%COMP%]   .nav-item.router-link-active[_ngcontent-%COMP%]::before {\n  content: "";\n  position: absolute;\n  left: -16px;\n  top: 50%;\n  transform: translateY(-50%);\n  width: 4px;\n  height: 28px;\n  background: white;\n  border-radius: 0 3px 3px 0;\n  box-shadow: 0 0 12px rgba(255, 255, 255, 0.5);\n}\n.sidebar[_ngcontent-%COMP%]   .nav-item.router-link-active[_ngcontent-%COMP%]::after {\n  content: "";\n  position: absolute;\n  right: 8px;\n  top: 50%;\n  transform: translateY(-50%);\n  width: 6px;\n  height: 6px;\n  background: white;\n  border-radius: 50%;\n  box-shadow: 0 0 8px rgba(255, 255, 255, 0.6);\n}\n.sidebar[_ngcontent-%COMP%]   .user-section[_ngcontent-%COMP%] {\n  background: rgba(0, 0, 0, 0.15);\n  border-top: 1px solid rgba(255, 255, 255, 0.08);\n}\n.sidebar[_ngcontent-%COMP%]   .user-section[_ngcontent-%COMP%]   .fx-card[_ngcontent-%COMP%] {\n  display: flex;\n  align-items: center;\n  gap: 8px;\n  margin-bottom: 10px;\n  padding: 6px 8px;\n  min-height: 0;\n  border-radius: 8px;\n  text-decoration: none;\n  background:\n    linear-gradient(\n      145deg,\n      rgba(255, 255, 255, 0.09) 0%,\n      rgba(255, 255, 255, 0.03) 100%);\n  border: 1px solid rgba(255, 255, 255, 0.09);\n  box-shadow: inset 0 1px 0 rgba(255, 255, 255, 0.05);\n  transition: border-color 0.2s ease, background 0.2s ease;\n}\n.sidebar[_ngcontent-%COMP%]   .user-section[_ngcontent-%COMP%]   .fx-card[_ngcontent-%COMP%]:hover {\n  border-color: rgba(167, 139, 250, 0.3);\n  background:\n    linear-gradient(\n      145deg,\n      rgba(255, 255, 255, 0.11) 0%,\n      rgba(255, 255, 255, 0.05) 100%);\n}\n.sidebar[_ngcontent-%COMP%]   .user-section[_ngcontent-%COMP%]   .fx-card--compact[_ngcontent-%COMP%] {\n  flex-direction: column;\n  gap: 2px;\n  padding: 5px 4px;\n  margin-bottom: 8px;\n}\n.sidebar[_ngcontent-%COMP%]   .user-section[_ngcontent-%COMP%]   .fx-card__currencies[_ngcontent-%COMP%] {\n  display: flex;\n  flex-direction: row;\n  align-items: center;\n  justify-content: center;\n  gap: 4px;\n  flex-shrink: 0;\n  padding: 3px 6px;\n  border-radius: 6px;\n  background: rgba(0, 0, 0, 0.12);\n  border: 1px solid rgba(255, 255, 255, 0.07);\n}\n.sidebar[_ngcontent-%COMP%]   .user-section[_ngcontent-%COMP%]   .fx-card__badge[_ngcontent-%COMP%] {\n  display: block;\n  font-size: 8px;\n  font-weight: 800;\n  line-height: 1;\n  letter-spacing: 0.05em;\n}\n.sidebar[_ngcontent-%COMP%]   .user-section[_ngcontent-%COMP%]   .fx-card__badge--usd[_ngcontent-%COMP%] {\n  color: #93c5fd;\n}\n.sidebar[_ngcontent-%COMP%]   .user-section[_ngcontent-%COMP%]   .fx-card__badge--mxn[_ngcontent-%COMP%] {\n  color: #5eead4;\n}\n.sidebar[_ngcontent-%COMP%]   .user-section[_ngcontent-%COMP%]   .fx-card__badge-arrow[_ngcontent-%COMP%] {\n  display: block;\n  width: 8px;\n  height: 1px;\n  background: rgba(255, 255, 255, 0.25);\n  position: relative;\n  flex-shrink: 0;\n}\n.sidebar[_ngcontent-%COMP%]   .user-section[_ngcontent-%COMP%]   .fx-card__badge-arrow[_ngcontent-%COMP%]::after {\n  content: "";\n  position: absolute;\n  right: -1px;\n  top: 50%;\n  width: 3px;\n  height: 3px;\n  border-right: 1px solid rgba(255, 255, 255, 0.32);\n  border-bottom: 1px solid rgba(255, 255, 255, 0.32);\n  transform: translateY(-50%) rotate(-45deg);\n}\n.sidebar[_ngcontent-%COMP%]   .user-section[_ngcontent-%COMP%]   .fx-card__content[_ngcontent-%COMP%] {\n  display: flex;\n  align-items: center;\n  justify-content: space-between;\n  flex: 1;\n  min-width: 0;\n  gap: 6px;\n}\n.sidebar[_ngcontent-%COMP%]   .user-section[_ngcontent-%COMP%]   .fx-card__label[_ngcontent-%COMP%] {\n  font-size: 8px;\n  font-weight: 600;\n  line-height: 1;\n  letter-spacing: 0.08em;\n  text-transform: uppercase;\n  color: rgba(255, 255, 255, 0.4);\n  white-space: nowrap;\n}\n.sidebar[_ngcontent-%COMP%]   .user-section[_ngcontent-%COMP%]   .fx-card__value[_ngcontent-%COMP%] {\n  font-size: 13px;\n  font-weight: 700;\n  line-height: 1;\n  color: #fff;\n  font-variant-numeric: tabular-nums;\n  letter-spacing: -0.01em;\n  white-space: nowrap;\n}\n.sidebar[_ngcontent-%COMP%]   .user-section[_ngcontent-%COMP%]   .fx-card__compact-code[_ngcontent-%COMP%] {\n  font-size: 7px;\n  font-weight: 800;\n  letter-spacing: 0.06em;\n  color: #93c5fd;\n  line-height: 1;\n}\n.sidebar[_ngcontent-%COMP%]   .user-section[_ngcontent-%COMP%]   .fx-card__compact-value[_ngcontent-%COMP%] {\n  font-size: 10px;\n  font-weight: 700;\n  line-height: 1;\n  color: #fff;\n  font-variant-numeric: tabular-nums;\n}\n.sidebar[_ngcontent-%COMP%]   .user-section[_ngcontent-%COMP%]   .user-info[_ngcontent-%COMP%] {\n  color: rgba(255, 255, 255, 0.9);\n}\n.sidebar[_ngcontent-%COMP%]   .user-section[_ngcontent-%COMP%]   .user-info[_ngcontent-%COMP%]   .user-name[_ngcontent-%COMP%] {\n  color: white;\n  font-weight: 600;\n  font-size: 0.875rem;\n}\n.sidebar[_ngcontent-%COMP%]   .user-section[_ngcontent-%COMP%]   .user-info[_ngcontent-%COMP%]   .user-email[_ngcontent-%COMP%] {\n  color: rgba(255, 255, 255, 0.55);\n  font-size: 0.75rem;\n}\n.sidebar[_ngcontent-%COMP%]   .user-section[_ngcontent-%COMP%]   .user-avatar[_ngcontent-%COMP%] {\n  background:\n    linear-gradient(\n      135deg,\n      rgba(255, 255, 255, 0.25),\n      rgba(255, 255, 255, 0.15));\n  color: white;\n  font-weight: 700;\n  border: 1.5px solid rgba(255, 255, 255, 0.2);\n}\n.sidebar[_ngcontent-%COMP%]   .user-section[_ngcontent-%COMP%]   button[_ngcontent-%COMP%]:hover {\n  background: rgba(255, 255, 255, 0.12);\n}\n.sidebar[_ngcontent-%COMP%]   .user-section[_ngcontent-%COMP%]   button[_ngcontent-%COMP%]   lucide-icon[_ngcontent-%COMP%] {\n  color: rgba(255, 255, 255, 0.65);\n}\n.sidebar[_ngcontent-%COMP%]   .user-section[_ngcontent-%COMP%]   button[_ngcontent-%COMP%]:hover   lucide-icon[_ngcontent-%COMP%] {\n  color: white;\n}\n.sidebar[_ngcontent-%COMP%]   a[_ngcontent-%COMP%], \n.sidebar[_ngcontent-%COMP%]   button[_ngcontent-%COMP%], \n.sidebar[_ngcontent-%COMP%]   .nav-item[_ngcontent-%COMP%], \n.sidebar[_ngcontent-%COMP%]   .toggle-btn[_ngcontent-%COMP%], \n.sidebar[_ngcontent-%COMP%]   .mobile-close-btn[_ngcontent-%COMP%] {\n  transition: all 0.2s cubic-bezier(0.4, 0, 0.2, 1);\n}\n.sidebar[_ngcontent-%COMP%]::-webkit-scrollbar {\n  width: 5px;\n}\n.sidebar[_ngcontent-%COMP%]::-webkit-scrollbar-track {\n  background: rgba(0, 0, 0, 0.1);\n}\n.sidebar[_ngcontent-%COMP%]::-webkit-scrollbar-thumb {\n  background: rgba(255, 255, 255, 0.2);\n  border-radius: 3px;\n}\n.sidebar[_ngcontent-%COMP%]::-webkit-scrollbar-thumb:hover {\n  background: rgba(255, 255, 255, 0.3);\n}\n.mobile-close-btn[_ngcontent-%COMP%] {\n  display: none;\n  position: absolute;\n  top: 1.25rem;\n  right: 1.25rem;\n  z-index: 10;\n  width: 2.5rem;\n  height: 2.5rem;\n  align-items: center;\n  justify-content: center;\n  border-radius: 0.5rem;\n  background: rgba(255, 255, 255, 0.1);\n  border: 1px solid rgba(255, 255, 255, 0.15);\n  color: white;\n  cursor: pointer;\n  transition: background 0.2s ease;\n}\n.mobile-close-btn[_ngcontent-%COMP%]:hover {\n  background: rgba(255, 255, 255, 0.18);\n}\n@media (max-width: 1023px) {\n  .sidebar[_ngcontent-%COMP%] {\n    position: fixed;\n    top: 0;\n    left: 0;\n    width: 100vw !important;\n    height: 100vh;\n    z-index: 1000;\n    transform: translateX(-100%);\n    transition: transform 0.3s cubic-bezier(0.4, 0, 0.2, 1);\n  }\n  .sidebar.sidebar--mobile-open[_ngcontent-%COMP%] {\n    transform: translateX(0);\n  }\n  .sidebar[_ngcontent-%COMP%]   .mobile-close-btn[_ngcontent-%COMP%] {\n    display: inline-flex;\n  }\n  .sidebar[_ngcontent-%COMP%]   .nav-item[_ngcontent-%COMP%] {\n    font-size: 1rem;\n    padding-top: 0.75rem !important;\n    padding-bottom: 0.75rem !important;\n  }\n  .sidebar[_ngcontent-%COMP%]   .nav-item.router-link-active[_ngcontent-%COMP%]::before {\n    left: 0;\n  }\n  .sidebar[_ngcontent-%COMP%]   .logo-section[_ngcontent-%COMP%] {\n    padding-top: 2.5rem;\n  }\n}\n/*# sourceMappingURL=sidebar.css.map */'] });
};
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && setClassMetadata(Sidebar, [{
    type: Component,
    args: [{ selector: "app-sidebar", imports: [CommonModule, RouterModule, LucideAngularModule, PolluxBrandTextComponent], template: `<aside
    ...
    <div class="flex flex-col flex-1 overflow-y-auto">
        ...
        <div class="logo-section px-6 py-6 border-b border-white/10">
            <div class="text-center">
                <app-pollux-brand-text [compact]="isCollapsed() && !isMobileOpen()" />
            </div>
        </div>
        
        <div [class]="'flex flex-col pt-6 transition-all duration-300 ' + (isCollapsed() && !isMobileOpen() ? 'px-2' : 'px-4')">
        <nav class="flex flex-col">
          @for (section of visibleMenuSections(); track section.id; let first = $first) {
            <div class="nav-section" [class.nav-section--first]="first">
              @if (!isCollapsed() || isMobileOpen()) {
                <h3 class="nav-section-title">{{ section.title }}</h3>
              } @else if (!first) {
                <div class="nav-section-spacer" aria-hidden="true"></div>
              }
              <div class="nav-section-items flex flex-col gap-1.5">
    ...
    <div [class]="'user-section py-5 transition-all duration-300 shrink-0 ' + (isCollapsed() && !isMobileOpen() ? 'px-2' : 'px-6')">
        @if (todayUsdMxnRate() !== null) {
            <a
                ...
                (click)="closeMobileMenu()"
                class="fx-card"
                [class.fx-card--compact]="isCollapsed() && !isMobileOpen()"
                title="Cambio USD/MXN">
                @if (isCollapsed() && !isMobileOpen()) {
                    <span class="fx-card__compact-code">USD</span>
                    <span class="fx-card__compact-value">{{ todayUsdMxnRate() | number:'1.2-2' }}</span>
                } @else {
                    <div class="fx-card__currencies" aria-hidden="true">
                        <span class="fx-card__badge fx-card__badge--usd">USD</span>
                        <span class="fx-card__badge-arrow"></span>
                        <span class="fx-card__badge fx-card__badge--mxn">MXN</span>
                    </div>
                    <div class="fx-card__content">
                        <span class="fx-card__label">Cambio</span>
                        <span class="fx-card__value">{{ todayUsdMxnRate() | number:'1.2-4' }}</span>
                    </div>
                }
            </a>
        }
        ...
        @if (isCollapsed() && !isMobileOpen()) {
            <div class="flex flex-col items-center gap-3">
                ...
                <button (click)="auth_service.logout()" class="p-2 rounded-full hover:bg-white/10 transition-colors" title="Cerrar sesi\xF3n">
            ...
            <div class="flex items-center justify-between text-[14px]">
                ...
                <button (click)="auth_service.logout()" class="p-1.5 rounded-full hover:bg-white/10 transition-colors shrink-0 ml-2" title="Cerrar sesi\xF3n">
                    <lucide-icon [img]="icons.LogOut" class="w-4 h-4"></lucide-icon>
                </button>
            </div>
        }
...
`, styles: ['/* src/app/core/components/sidebar/sidebar.scss */\n.sidebar {\n  background:\n    linear-gradient(\n      180deg,\n      #1e1b4b 0%,\n      #312e81 50%,\n      #4c1d95 100%);\n  border-right: 1px solid rgba(139, 92, 246, 0.15);\n  position: relative;\n}\n.sidebar .toggle-btn {\n  transition: all 0.3s cubic-bezier(0.4, 0, 0.2, 1);\n  box-shadow: 0 2px 8px rgba(0, 0, 0, 0.15);\n}\n.sidebar .toggle-btn:hover {\n  box-shadow: 0 4px 12px rgba(139, 92, 246, 0.4);\n}\n.sidebar .logo-section {\n  background: rgba(0, 0, 0, 0.1);\n  border-bottom: 1px solid rgba(255, 255, 255, 0.1);\n}\n.sidebar .logo-section h1 {\n  letter-spacing: 0.05em;\n}\n.sidebar .logo-section p {\n  text-transform: uppercase;\n  letter-spacing: 0.15em;\n  font-size: 0.7rem;\n  font-weight: 500;\n}\n.sidebar .nav-section:not(.nav-section--first) {\n  margin-top: 0.75rem;\n  padding-top: 0.75rem;\n  border-top: 1px solid rgba(255, 255, 255, 0.08);\n}\n.sidebar .nav-section-title {\n  margin: 0 0 0.5rem;\n  padding: 0 0.75rem;\n  font-size: 0.625rem;\n  font-weight: 600;\n  letter-spacing: 0.14em;\n  text-transform: uppercase;\n  color: rgba(255, 255, 255, 0.35);\n  line-height: 1.2;\n}\n.sidebar .nav-section-spacer {\n  height: 0;\n  margin: 0.5rem 0.25rem 0.25rem;\n  border-top: 1px solid rgba(255, 255, 255, 0.08);\n}\n.sidebar .nav-item {\n  position: relative;\n  font-weight: 500;\n  color: rgba(255, 255, 255, 0.75);\n  transition: all 0.25s cubic-bezier(0.4, 0, 0.2, 1);\n  font-size: 0.9rem;\n}\n.sidebar .nav-item:hover {\n  background: rgba(255, 255, 255, 0.08);\n  color: rgba(255, 255, 255, 0.95);\n  transform: translateX(3px);\n}\n.sidebar .nav-item lucide-icon {\n  color: rgba(255, 255, 255, 0.65);\n  transition: all 0.25s cubic-bezier(0.4, 0, 0.2, 1);\n}\n.sidebar .nav-item:hover lucide-icon {\n  color: rgba(255, 255, 255, 0.9);\n}\n.sidebar .nav-item.router-link-active {\n  background: rgba(255, 255, 255, 0.15);\n  color: white;\n  font-weight: 600;\n  box-shadow: inset 0 0 16px rgba(255, 255, 255, 0.08);\n}\n.sidebar .nav-item.router-link-active lucide-icon {\n  color: white;\n  filter: drop-shadow(0 0 6px rgba(255, 255, 255, 0.4));\n}\n.sidebar .nav-item.router-link-active::before {\n  content: "";\n  position: absolute;\n  left: -16px;\n  top: 50%;\n  transform: translateY(-50%);\n  width: 4px;\n  height: 28px;\n  background: white;\n  border-radius: 0 3px 3px 0;\n  box-shadow: 0 0 12px rgba(255, 255, 255, 0.5);\n}\n.sidebar .nav-item.router-link-active::after {\n  content: "";\n  position: absolute;\n  right: 8px;\n  top: 50%;\n  transform: translateY(-50%);\n  width: 6px;\n  height: 6px;\n  background: white;\n  border-radius: 50%;\n  box-shadow: 0 0 8px rgba(255, 255, 255, 0.6);\n}\n.sidebar .user-section {\n  background: rgba(0, 0, 0, 0.15);\n  border-top: 1px solid rgba(255, 255, 255, 0.08);\n}\n.sidebar .user-section .fx-card {\n  display: flex;\n  align-items: center;\n  gap: 8px;\n  margin-bottom: 10px;\n  padding: 6px 8px;\n  min-height: 0;\n  border-radius: 8px;\n  text-decoration: none;\n  background:\n    linear-gradient(\n      145deg,\n      rgba(255, 255, 255, 0.09) 0%,\n      rgba(255, 255, 255, 0.03) 100%);\n  border: 1px solid rgba(255, 255, 255, 0.09);\n  box-shadow: inset 0 1px 0 rgba(255, 255, 255, 0.05);\n  transition: border-color 0.2s ease, background 0.2s ease;\n}\n.sidebar .user-section .fx-card:hover {\n  border-color: rgba(167, 139, 250, 0.3);\n  background:\n    linear-gradient(\n      145deg,\n      rgba(255, 255, 255, 0.11) 0%,\n      rgba(255, 255, 255, 0.05) 100%);\n}\n.sidebar .user-section .fx-card--compact {\n  flex-direction: column;\n  gap: 2px;\n  padding: 5px 4px;\n  margin-bottom: 8px;\n}\n.sidebar .user-section .fx-card__currencies {\n  display: flex;\n  flex-direction: row;\n  align-items: center;\n  justify-content: center;\n  gap: 4px;\n  flex-shrink: 0;\n  padding: 3px 6px;\n  border-radius: 6px;\n  background: rgba(0, 0, 0, 0.12);\n  border: 1px solid rgba(255, 255, 255, 0.07);\n}\n.sidebar .user-section .fx-card__badge {\n  display: block;\n  font-size: 8px;\n  font-weight: 800;\n  line-height: 1;\n  letter-spacing: 0.05em;\n}\n.sidebar .user-section .fx-card__badge--usd {\n  color: #93c5fd;\n}\n.sidebar .user-section .fx-card__badge--mxn {\n  color: #5eead4;\n}\n.sidebar .user-section .fx-card__badge-arrow {\n  display: block;\n  width: 8px;\n  height: 1px;\n  background: rgba(255, 255, 255, 0.25);\n  position: relative;\n  flex-shrink: 0;\n}\n.sidebar .user-section .fx-card__badge-arrow::after {\n  content: "";\n  position: absolute;\n  right: -1px;\n  top: 50%;\n  width: 3px;\n  height: 3px;\n  border-right: 1px solid rgba(255, 255, 255, 0.32);\n  border-bottom: 1px solid rgba(255, 255, 255, 0.32);\n  transform: translateY(-50%) rotate(-45deg);\n}\n.sidebar .user-section .fx-card__content {\n  display: flex;\n  align-items: center;\n  justify-content: space-between;\n  flex: 1;\n  min-width: 0;\n  gap: 6px;\n}\n.sidebar .user-section .fx-card__label {\n  font-size: 8px;\n  font-weight: 600;\n  line-height: 1;\n  letter-spacing: 0.08em;\n  text-transform: uppercase;\n  color: rgba(255, 255, 255, 0.4);\n  white-space: nowrap;\n}\n.sidebar .user-section .fx-card__value {\n  font-size: 13px;\n  font-weight: 700;\n  line-height: 1;\n  color: #fff;\n  font-variant-numeric: tabular-nums;\n  letter-spacing: -0.01em;\n  white-space: nowrap;\n}\n.sidebar .user-section .fx-card__compact-code {\n  font-size: 7px;\n  font-weight: 800;\n  letter-spacing: 0.06em;\n  color: #93c5fd;\n  line-height: 1;\n}\n.sidebar .user-section .fx-card__compact-value {\n  font-size: 10px;\n  font-weight: 700;\n  line-height: 1;\n  color: #fff;\n  font-variant-numeric: tabular-nums;\n}\n.sidebar .user-section .user-info {\n  color: rgba(255, 255, 255, 0.9);\n}\n.sidebar .user-section .user-info .user-name {\n  color: white;\n  font-weight: 600;\n  font-size: 0.875rem;\n}\n.sidebar .user-section .user-info .user-email {\n  color: rgba(255, 255, 255, 0.55);\n  font-size: 0.75rem;\n}\n.sidebar .user-section .user-avatar {\n  background:\n    linear-gradient(\n      135deg,\n      rgba(255, 255, 255, 0.25),\n      rgba(255, 255, 255, 0.15));\n  color: white;\n  font-weight: 700;\n  border: 1.5px solid rgba(255, 255, 255, 0.2);\n}\n.sidebar .user-section button:hover {\n  background: rgba(255, 255, 255, 0.12);\n}\n.sidebar .user-section button lucide-icon {\n  color: rgba(255, 255, 255, 0.65);\n}\n.sidebar .user-section button:hover lucide-icon {\n  color: white;\n}\n.sidebar a,\n.sidebar button,\n.sidebar .nav-item,\n.sidebar .toggle-btn,\n.sidebar .mobile-close-btn {\n  transition: all 0.2s cubic-bezier(0.4, 0, 0.2, 1);\n}\n.sidebar::-webkit-scrollbar {\n  width: 5px;\n}\n.sidebar::-webkit-scrollbar-track {\n  background: rgba(0, 0, 0, 0.1);\n}\n.sidebar::-webkit-scrollbar-thumb {\n  background: rgba(255, 255, 255, 0.2);\n  border-radius: 3px;\n}\n.sidebar::-webkit-scrollbar-thumb:hover {\n  background: rgba(255, 255, 255, 0.3);\n}\n.mobile-close-btn {\n  display: none;\n  position: absolute;\n  top: 1.25rem;\n  right: 1.25rem;\n  z-index: 10;\n  width: 2.5rem;\n  height: 2.5rem;\n  align-items: center;\n  justify-content: center;\n  border-radius: 0.5rem;\n  background: rgba(255, 255, 255, 0.1);\n  border: 1px solid rgba(255, 255, 255, 0.15);\n  color: white;\n  cursor: pointer;\n  transition: background 0.2s ease;\n}\n.mobile-close-btn:hover {\n  background: rgba(255, 255, 255, 0.18);\n}\n@media (max-width: 1023px) {\n  .sidebar {\n    position: fixed;\n    top: 0;\n    left: 0;\n    width: 100vw !important;\n    height: 100vh;\n    z-index: 1000;\n    transform: translateX(-100%);\n    transition: transform 0.3s cubic-bezier(0.4, 0, 0.2, 1);\n  }\n  .sidebar.sidebar--mobile-open {\n    transform: translateX(0);\n  }\n  .sidebar .mobile-close-btn {\n    display: inline-flex;\n  }\n  .sidebar .nav-item {\n    font-size: 1rem;\n    padding-top: 0.75rem !important;\n    padding-bottom: 0.75rem !important;\n  }\n  .sidebar .nav-item.router-link-active::before {\n    left: 0;\n  }\n  .sidebar .logo-section {\n    padding-top: 2.5rem;\n  }\n}\n/*# sourceMappingURL=sidebar.css.map */\n'] }]
  }], () => [{ type: AuthService }, { type: SidebarService }, { type: ExchangeRateService }, { type: Router }], null);
})();
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(Sidebar, { className: "Sidebar", filePath: "src/app/core/components/sidebar/sidebar.ts", lineNumber: 88 });
})();
...
var MainLayout = class _MainLayout {
  ...
  sidebarService;
  icons = { Menu };
  constructor(permissionSyncService, sidebarService) {
  ...
  static \u0275fac = function MainLayout_Factory(__ngFactoryType__) {
    return new (__ngFactoryType__ || _MainLayout)(\u0275\u0275directiveInject(PermissionSyncService), \u0275\u0275directiveInject(SidebarService));
  };
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _MainLayout, selectors: [["app-main-layout"]], decls: 9, vars: 1, consts: [[1, "flex", "flex-col", "h-screen", "overflow-hidden"], [1, "mobile-header", "flex", "items-center", "gap-3", "px-4", "py-3", "bg-gradient-to-r", "from-indigo-950", "via-indigo-900", "to-purple-900", "text-white", "lg:hidden", "shrink-0"], ["type", "button", "aria-label", "Abrir men\xFA", 1, "mobile-menu-btn", 3, "click"], [1, "w-5", "h-5", 3, "img"], [1, "flex", "flex-1", "min-h-0", "overflow-hidden"], [1, "lg:h-full", "lg:overflow-y-auto", "shrink-0"], [1, "flex-1", "p-2", "sm:p-4", "bg-gray-100", "overflow-y-auto", "min-w-0"]], template: function MainLayout_Template(rf, ctx) {
    if (rf & 1) {
      \u0275\u0275elementStart(0, "div", 0)(1, "header", 1)(2, "button", 2);
      \u0275\u0275listener("click", function MainLayout_Template_button_click_2_listener() {
        return ctx.openMobileMenu();
      });
      \u0275\u0275element(3, "lucide-icon", 3);
      \u0275\u0275elementEnd();
      \u0275\u0275element(4, "app-pollux-brand-text");
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(5, "div", 4);
      \u0275\u0275element(6, "app-sidebar", 5);
    ...
    if (rf & 2) {
      \u0275\u0275advance(3);
      \u0275\u0275property("img", ctx.icons.Menu);
    }
  }, dependencies: [RouterOutlet, Sidebar, LucideAngularModule, LucideAngularComponent, PolluxBrandTextComponent], styles: ["\n\n.mobile-header[_ngcontent-%COMP%] {\n  box-shadow: 0 2px 8px rgba(0, 0, 0, 0.15);\n  z-index: 40;\n}\n.mobile-menu-btn[_ngcontent-%COMP%] {\n  display: inline-flex;\n  align-items: center;\n  justify-content: center;\n  width: 2.5rem;\n  height: 2.5rem;\n  border-radius: 0.5rem;\n  background: rgba(255, 255, 255, 0.1);\n  border: 1px solid rgba(255, 255, 255, 0.15);\n  color: white;\n  cursor: pointer;\n  transition: background 0.2s ease;\n}\n.mobile-menu-btn[_ngcontent-%COMP%]:hover {\n  background: rgba(255, 255, 255, 0.18);\n}\n/*# sourceMappingURL=main-layout.css.map */"] });
};
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && setClassMetadata(MainLayout, [{
    type: Component,
    args: [{ selector: "app-main-layout", imports: [RouterOutlet, Sidebar, LucideAngularModule, PolluxBrandTextComponent], template: '<div class="flex flex-col h-screen overflow-hidden">\r\n  <header class="mobile-header flex items-center gap-3 px-4 py-3 bg-gradient-to-r from-indigo-950 via-indigo-900 to-purple-900 text-white lg:hidden shrink-0">\r\n    <button\r\n      type="button"\r\n      class="mobile-menu-btn"\r\n      (click)="openMobileMenu()"\r\n      aria-label="Abrir men\xFA">\r\n      <lucide-icon [img]="icons.Menu" class="w-5 h-5"></lucide-icon>\r\n    </button>\r\n    <app-pollux-brand-text />\r\n  </header>\r\n\r\n  <div class="flex flex-1 min-h-0 overflow-hidden">\r\n    <app-sidebar class="lg:h-full lg:overflow-y-auto shrink-0"></app-sidebar>\r\n    <main class="flex-1 p-2 sm:p-4 bg-gray-100 overflow-y-auto min-w-0">\r\n      <router-outlet></router-outlet>\r\n    </main>\r\n  </div>\r\n</div>\r\n', styles: ["/* src/app/layout/main-layout/main-layout.scss */\n.mobile-header {\n  box-shadow: 0 2px 8px rgba(0, 0, 0, 0.15);\n  z-index: 40;\n}\n.mobile-menu-btn {\n  display: inline-flex;\n  align-items: center;\n  justify-content: center;\n  width: 2.5rem;\n  height: 2.5rem;\n  border-radius: 0.5rem;\n  background: rgba(255, 255, 255, 0.1);\n  border: 1px solid rgba(255, 255, 255, 0.15);\n  color: white;\n  cursor: pointer;\n  transition: background 0.2s ease;\n}\n.mobile-menu-btn:hover {\n  background: rgba(255, 255, 255, 0.18);\n}\n/*# sourceMappingURL=main-layout.css.map */\n"] }]
  }], () => [{ type: PermissionSyncService }, { type: SidebarService }], null);
})();
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(MainLayout, { className: "MainLayout", filePath: "src/app/layout/main-layout/main-layout.ts", lineNumber: 15 });
})();
...
var AuthGuard = class _AuthGuard {
  ...
  auth_service;
  route;
  constructor(router, auth_service, route) {
    this.router = router;
    this.auth_service = auth_service;
    this.route = route;
  }
  ...
  static \u0275fac = function AuthGuard_Factory(__ngFactoryType__) {
    return new (__ngFactoryType__ || _AuthGuard)(\u0275\u0275inject(Router), \u0275\u0275inject(AuthService), \u0275\u0275inject(ActivatedRoute));
  };
...
(() => {
  ...
  }], () => [{ type: Router }, { type: AuthService }, { type: ActivatedRoute }], null);
})();

// src/app/core/guards/logged.guard.ts
var LoggedGuard = class _LoggedGuard {
  router;
  auth_service;
  constructor(router, auth_service) {
    this.router = router;
    this.auth_service = auth_service;
  }
  canActivate(route, state) {
  ...
  static \u0275fac = function LoggedGuard_Factory(__ngFactoryType__) {
    return new (__ngFactoryType__ || _LoggedGuard)(\u0275\u0275inject(Router), \u0275\u0275inject(AuthService));
  };
  static \u0275prov = /* @__PURE__ */ \u0275\u0275defineInjectable({ token: _LoggedGuard, factory: _LoggedGuard.\u0275fac, providedIn: "root" });
};
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && setClassMetadata(LoggedGuard, [{
    type: Injectable,
    args: [{
      providedIn: "root"
    }]
...
// src/app/core/guards/default-route.guard.ts
var defaultRouteGuard = () => {
...
// src/app/core/guards/pos-user-type.guard.ts
var posEntryRedirectGuard = () => {
  const auth = inject(AuthService);
  const router = inject(Router);
  return auth.ensurePosProfile().pipe(map(() => {
...
var routes = [
  // LOGIN (público)
  {
    ...
    loadComponent: () => import("./chunk-QWKE27UQ.js").then((m5) => m5.Login)
  },
  // POS - Tomar Orden y Cobrar Orden (pantalla completa, sin layout)
  {
    path: "pos/pending-orders",
    canActivate: [AuthGuard],
    loadComponent: () => import("./chunk-S6CQOQTZ.js").then((m5) => m5.PendingOrdersComponent),
    data: {
      permission: "pos:Read",
  ...
  // APP PROTEGIDA
  {
    ...
    children: [
      {
        path: "leads",
        loadChildren: () => import("./chunk-3NWNN3V3.js").then((m5) => m5.LEADS_ROUTES)
      },
      {
        path: "customers",
        loadChildren: () => import("./chunk-RO4WZ6VD.js").then((m5) => m5.CUSTOMERS_ROUTES)
      },
      {
        path: "properties",
        loadChildren: () => import("./chunk-TAFZ4COC.js").then((m5) => m5.PROPERTIES_ROUTES)
      },
      {
        path: "contracts",
        loadChildren: () => import("./chunk-QBXDKASC.js").then((m5) => m5.CONTRACTS_ROUTES)
      },
      {
        path: "settings",
        loadChildren: () => import("./chunk-IFXA4D3D.js").then((m5) => m5.RBAC_TENANT_UI_ROUTES)
      },
      {
        path: "marketing",
        loadChildren: () => import("./chunk-NS77LDD3.js").then((m5) => m5.MARKETING_ROUTES)
      },
      {
        path: "purchase-orders",
        loadChildren: () => import("./chunk-LSF2O7EU.js").then((m5) => m5.PURCHASE_ORDERS_ROUTES)
      },
      {
        path: "inventory",
        loadChildren: () => import("./chunk-YD6QBX33.js").then((m5) => m5.INVENTORY_ROUTES)
      },
      {
        path: "sales-orders",
        loadChildren: () => import("./chunk-SLMFHBGT.js").then((m5) => m5.SALES_ORDERS_ROUTES)
      },
      {
        path: "pos/ventas",
        canActivate: [posVentasGuard],
        loadComponent: () => import("./chunk-IQFCB3U4.js").then((m5) => m5.TakeOrderComponent),
        data: {
      ...
      },
      {
        ...
        loadComponent: () => import("./chunk-3BD7UXU7.js").then((m5) => m5.PaymentComponent),
        data: {
      ...
      },
      {
        ...
        loadChildren: () => import("./chunk-WGISFKED.js").then((m5) => m5.ZONA_NORTE_REPORTS_ROUTES)
      },
      {
        path: "accounting",
        loadChildren: () => import("./chunk-7SWS7RX5.js").then((m5) => m5.ACCOUNTING_ROUTES)
      },
      {
        path: "divino-dashboard",
        loadChildren: () => import("./chunk-WMQHSZFJ.js").then((m5) => m5.DIVINO_DASHBOARD_ROUTES)
      },
      {
        path: "",
...
var authInterceptor = (req, next) => {
  ...
  return next(req).pipe(catchError((error) => {
    const permissionsChanged = error.status === 401 && (error.error?.error === "PERMISSIONS_CHANGED" || error.error?.code === "PERMISSIONS_CHANGED" || error.error?.message === "PERMISSIONS_CHANGED");
    if (permissionsChanged) {
      console.log("\u{1F504} Permissions changed detected, refreshing token...");
      return authService.refresh().pipe(switchMap((response) => {
...
// src/app/core/constants/app-version.generated.ts
var APP_BUILD_ID = "0.0.0-1782414637487";

// src/app/core/components/app-update-dialog/app-update-dialog.component.ts
function AppUpdateDialogComponent_Conditional_5_Template(rf, ctx) {
  if (rf & 1) {
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance();
    \u0275\u0275textInterpolate1("Versi\xF3n ", ctx_r0.data.version);
  }
}
var AppUpdateDialogComponent = class _AppUpdateDialogComponent {
  dialogRef;
  data;
  ...
  static \u0275fac = function AppUpdateDialogComponent_Factory(__ngFactoryType__) {
    return new (__ngFactoryType__ || _AppUpdateDialogComponent)(\u0275\u0275directiveInject(MatDialogRef), \u0275\u0275directiveInject(MAT_DIALOG_DATA));
  };
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _AppUpdateDialogComponent, selectors: [["app-update-dialog"]], decls: 11, vars: 1, consts: [[1, "app-update-dialog"], [1, "app-update-dialog__title"], [1, "app-update-dialog__message"], [1, "app-update-dialog__version"], [1, "app-update-dialog__hint"], [1, "app-update-dialog__actions"], ["text", "M\xE1s tarde", "custom_class", "btn_secondary", 3, "clicked"], ["text", "Actualizar ahora", "custom_class", "btn_primary", 3, "clicked"]], template: function AppUpdateDialogComponent_Template(rf, ctx) {
    if (rf & 1) {
      \u0275\u0275elementStart(0, "div", 0)(1, "h2", 1);
      \u0275\u0275text(2, "Hay una actualizaci\xF3n");
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(3, "p", 2);
      \u0275\u0275text(4, " Hay una nueva versi\xF3n de Pollux disponible. ");
      \u0275\u0275conditionalCreate(5, AppUpdateDialogComponent_Conditional_5_Template, 2, 1, "span", 3);
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(6, "p", 4);
      \u0275\u0275text(7, " Actualiza ahora para obtener los \xFAltimos cambios y evitar errores por cach\xE9. ");
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(8, "div", 5)(9, "app-button", 6);
      \u0275\u0275listener("clicked", function AppUpdateDialogComponent_Template_app_button_clicked_9_listener() {
        return ctx.close(false);
      });
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(10, "app-button", 7);
      \u0275\u0275listener("clicked", function AppUpdateDialogComponent_Template_app_button_clicked_10_listener() {
    ...
    if (rf & 2) {
      \u0275\u0275advance(5);
      \u0275\u0275conditional(ctx.data.version ? 5 : -1);
    }
  }, dependencies: [CommonModule, MatDialogModule, ButtonComponent], styles: ["\n\n.app-update-dialog[_ngcontent-%COMP%] {\n  padding: 0.25rem 0;\n}\n.app-update-dialog__title[_ngcontent-%COMP%] {\n  margin: 0 0 0.75rem;\n  font-size: 1.25rem;\n  font-weight: 600;\n  color: #111827;\n}\n.app-update-dialog__message[_ngcontent-%COMP%] {\n  margin: 0 0 0.5rem;\n  font-size: 0.9375rem;\n  color: #374151;\n  line-height: 1.5;\n}\n.app-update-dialog__version[_ngcontent-%COMP%] {\n  display: block;\n  margin-top: 0.35rem;\n  font-weight: 600;\n  color: #4f46e5;\n}\n.app-update-dialog__hint[_ngcontent-%COMP%] {\n  margin: 0 0 1.25rem;\n  font-size: 0.8125rem;\n  color: #6b7280;\n  line-height: 1.45;\n}\n.app-update-dialog__actions[_ngcontent-%COMP%] {\n  display: flex;\n  justify-content: flex-end;\n  gap: 0.75rem;\n}\n/*# sourceMappingURL=app-update-dialog.component.css.map */"] });
};
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && setClassMetadata(AppUpdateDialogComponent, [{
    type: Component,
    args: [{ selector: "app-update-dialog", standalone: true, imports: [CommonModule, MatDialogModule, ButtonComponent], template: `
    <div class="app-update-dialog">
      <h2 class="app-update-dialog__title">Hay una actualizaci\xF3n</h2>
      <p class="app-update-dialog__message">
        Hay una nueva versi\xF3n de Pollux disponible.
        @if (data.version) {
          <span class="app-update-dialog__version">Versi\xF3n {{ data.version }}</span>
        }
      </p>
      <p class="app-update-dialog__hint">
        Actualiza ahora para obtener los \xFAltimos cambios y evitar errores por cach\xE9.
      </p>
  ...
  `, styles: ["/* angular:styles/component:scss;00c17e203409aca931930c6e61cae65489a91ea35c8b5e396c9e064285ed155a;C:/Projects/Synergy/sinergy-erp-frontend-clients/src/app/core/components/app-update-dialog/app-update-dialog.component.ts */\n.app-update-dialog {\n  padding: 0.25rem 0;\n}\n.app-update-dialog__title {\n  margin: 0 0 0.75rem;\n  font-size: 1.25rem;\n  font-weight: 600;\n  color: #111827;\n}\n.app-update-dialog__message {\n  margin: 0 0 0.5rem;\n  font-size: 0.9375rem;\n  color: #374151;\n  line-height: 1.5;\n}\n.app-update-dialog__version {\n  display: block;\n  margin-top: 0.35rem;\n  font-weight: 600;\n  color: #4f46e5;\n}\n.app-update-dialog__hint {\n  margin: 0 0 1.25rem;\n  font-size: 0.8125rem;\n  color: #6b7280;\n  line-height: 1.45;\n}\n.app-update-dialog__actions {\n  display: flex;\n  justify-content: flex-end;\n  gap: 0.75rem;\n}\n/*# sourceMappingURL=app-update-dialog.component.css.map */\n"] }]
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(AppUpdateDialogComponent, { className: "AppUpdateDialogComponent", filePath: "src/app/core/components/app-update-dialog/app-update-dialog.component.ts", lineNumber: 81 });
})();

// src/app/core/services/app-update.service.ts
var AppUpdateService = class _AppUpdateService {
  ...
  init() {
    ...
    interval(3 * 60 * 1e3).pipe(takeUntilDestroyed(this.destroyRef)).subscribe(() => {
      void this.checkForUpdate();
    });
    setTimeout(() => {
      void this.checkForUpdate();
  ...
  static \u0275fac = function AppUpdateService_Factory(__ngFactoryType__) {
    return new (__ngFactoryType__ || _AppUpdateService)();
  };
  static \u0275prov = /* @__PURE__ */ \u0275\u0275defineInjectable({ token: _AppUpdateService, factory: _AppUpdateService.\u0275fac, providedIn: "root" });
};
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && setClassMetadata(AppUpdateService, [{
    type: Injectable,
    args: [{
      providedIn: "root"
    }]
...
// src/app/app.ts
var App = class _App {
  title = signal("sinergy-erp-frontend-clients", ...ngDevMode ? [{ debugName: "title" }] : []);
