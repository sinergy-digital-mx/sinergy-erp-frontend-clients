...
var AsyncAnimationRendererFactory = class _AsyncAnimationRendererFactory {
  ...
  loadImpl() {
    const loadFn = () => this.moduleImpl ?? import("./chunk-SDRW5XIK.js").then((m5) => m5);
...
// src/app/features/settings/config/permissions.config.ts
var SETTINGS_PERMISSIONS = {
  // Module access
...
function Sidebar_For_13_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275conditionalCreate(2, Sidebar_For_13_Conditional_2_Template, 2, 1, "span", 17);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
...
function Sidebar_Conditional_23_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275listener("click", function Sidebar_Conditional_23_Template_button_click_3_listener() {
      \u0275\u0275restoreView(_r3);
      const ctx_r1 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r1.auth_service.logout());
    });
    \u0275\u0275element(4, "lucide-icon", 20);
    \u0275\u0275elementEnd()();
  }
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext();
...
function Sidebar_Conditional_24_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275elementStart(0, "div", 15)(1, "div", 21)(2, "div", 22);
    \u0275\u0275text(3);
    \u0275\u0275elementEnd();
    ...
    \u0275\u0275listener("click", function Sidebar_Conditional_24_Template_button_click_9_listener() {
      \u0275\u0275restoreView(_r4);
      const ctx_r1 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r1.auth_service.logout());
    });
...
var Sidebar = class _Sidebar {
  ...
  constructor(auth_service, sidebarService) {
  ...
  static \u0275fac = function Sidebar_Factory(__ngFactoryType__) {
    return new (__ngFactoryType__ || _Sidebar)(\u0275\u0275directiveInject(AuthService), \u0275\u0275directiveInject(SidebarService));
  };
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _Sidebar, selectors: [["app-sidebar"]], decls: 25, vars: 24, consts: [[1, "toggle-btn", "fixed", "top-6", "z-50", "w-7", "h-7", "bg-white", "rounded-full", "shadow-lg", "flex", "items-center", "justify-center", "hover:scale-110", "transition-transform", 3, "click"], [1, "w-4", "h-4", "text-purple-600", 3, "img"], [1, "flex", "flex-col"], [1, "logo-section", "px-6", "py-6", "border-b", "border-white/10"], [1, "text-center"], [1, "text-white/60", "text-sm", "mt-1", "font-light"], [1, "text-base", "font-semibold", "mb-6", "opacity-80", "tracking-tight", "text-white/70"], [1, "flex", "flex-col", "gap-1.5"], ["routerLinkActive", "router-link-active", 3, "routerLink", "routerLinkActiveOptions", "class", "title"], [1, "mt-6", "mb-4", "border-t", "border-white/20"], ["routerLink", "/notifications", 3, "title"], [1, "w-4", "h-4", "shrink-0", 3, "img"], [1, "font-medium"], ["routerLink", "/settings", 3, "title"], [1, "flex", "flex-col", "items-center", "gap-3"], [1, "flex", "items-center", "justify-between", "text-[14px]"], ["routerLinkActive", "router-link-active", 3, "routerLink", "routerLinkActiveOptions", "title"], [1, "font-medium", "whitespace-nowrap"], [1, "user-avatar", "w-10", "h-10", "rounded-full", "flex", "items-center", "justify-center", "text-xs", "font-semibold"], ["title", "Cerrar sesi\xF3n", 1, "p-2", "rounded-full", "hover:bg-white/10", "transition-colors", 3, "click"], [1, "w-4", "h-4", 3, "img"], [1, "flex", "items-center", "gap-3", "user-info", "min-w-0"], [1, "user-avatar", "w-8", "h-8", "rounded-full", "flex", "items-center", "justify-center", "text-xs", "font-semibold", "shrink-0"], [1, "min-w-0"], [1, "user-name", "font-medium", "leading-tight"], [1, "user-email", "text-[12px]", "truncate", 3, "title"], ["title", "Cerrar sesi\xF3n", 1, "p-1.5", "rounded-full", "hover:bg-white/10", "transition-colors", "shrink-0", "ml-2", 3, "click"]], template: function Sidebar_Template(rf, ctx) {
    if (rf & 1) {
      ...
      \u0275\u0275conditionalCreate(23, Sidebar_Conditional_23_Template, 5, 2, "div", 14)(24, Sidebar_Conditional_24_Template, 11, 5, "div", 15);
      \u0275\u0275elementEnd()();
    }
    if (rf & 2) {
...
\r
\r
        <div class="mt-6 mb-4 border-t border-white/20"></div>\r
\r
        <nav class="flex flex-col gap-1.5">\r
            <a routerLink="/notifications"\r
                [class]="'nav-item flex items-center rounded-lg transition-all duration-200 ' + (isCollapsed() ? 'gap-0 px-2 py-2.5 justify-center' : 'gap-3 px-3 py-2.5')"\r
                [title]="isCollapsed() ? 'Notificaciones' : ''">\r
                <lucide-icon [img]="icons.Bell" class="w-4 h-4 shrink-0"></lucide-icon>\r
                @if (!isCollapsed()) {\r
                    <span class="font-medium">Notificaciones</span>\r
                }\r
            </a>\r
            <a routerLink="/settings" \r
               [class]="'nav-item flex items-center rounded-lg transition-all duration-200 ' + (isCollapsed() ? 'gap-0 px-2 py-2.5 justify-center' : 'gap-3 px-3 py-2.5')"\r
               [title]="isCollapsed() ? 'Configuraci\xF3n' : ''">\r
                <lucide-icon [img]="icons.Settings" class="w-4 h-4 shrink-0"></lucide-icon>\r
                @if (!isCollapsed()) {\r
                    <span class="font-medium">Configuraci\xF3n</span>\r
                }\r
            </a>\r
        </nav>\r
        </div>\r
...
\r
    <div [class]="'user-section py-5 transition-all duration-300 ' + (isCollapsed() ? 'px-2' : 'px-6')">\r
        @if (isCollapsed()) {\r
            <div class="flex flex-col items-center gap-3">\r
                <div class="user-avatar w-10 h-10 rounded-full flex items-center justify-center text-xs font-semibold">\r
                    {{ getInitials(auth_service.user_info?.email) }}\r
                </div>\r
                <button (click)="auth_service.logout()" class="p-2 rounded-full hover:bg-white/10 transition-colors" title="Cerrar sesi\xF3n">\r
                    <lucide-icon [img]="icons.LogOut" class="w-4 h-4"></lucide-icon>\r
                </button>\r
            </div>\r
        } @else {\r
            <div class="flex items-center justify-between text-[14px]">\r
                <div class="flex items-center gap-3 user-info min-w-0">\r
                    <div class="user-avatar w-8 h-8 rounded-full flex items-center justify-center text-xs font-semibold shrink-0">\r
                        {{ getInitials(auth_service.user_info?.email) }}\r
                    </div>\r
                    <div class="min-w-0">\r
                        <div class="user-name font-medium leading-tight">{{ getUserName() }}</div>\r
                        <div class="user-email text-[12px] truncate" [title]="auth_service.user_info?.email">{{ auth_service.user_info?.email }}</div>\r
                    </div>\r
                </div>\r
                <button (click)="auth_service.logout()" class="p-1.5 rounded-full hover:bg-white/10 transition-colors shrink-0 ml-2" title="Cerrar sesi\xF3n">\r
                    <lucide-icon [img]="icons.LogOut" class="w-4 h-4"></lucide-icon>\r
                </button>\r
            </div>\r
        }\r
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(Sidebar, { className: "Sidebar", filePath: "src/app/core/components/sidebar/sidebar.ts", lineNumber: 43 });
})();
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(MainLayout, { className: "MainLayout", filePath: "src/app/layout/main-layout/main-layout.ts", lineNumber: 11 });
})();
...
var routes = [
  ...
  // APP PROTEGIDA
  {
    ...
    children: [
      ...
      {
        path: "marketing",
        loadChildren: () => import("./chunk-4GNBZN5V.js").then((m5) => m5.MARKETING_ROUTES)
      },
      {
      ...
      },
      {
        ...
        loadChildren: () => import("./chunk-KSZ4IIUN.js").then((m5) => m5.ZONA_NORTE_REPORTS_ROUTES)
      },
      {
        path: "",
