...
function ContractDetailPageComponent_div_0_div_83_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 67)(1, "div", 68)(2, "div")(3, "span", 69);
    ...
    \u0275\u0275pipe(7, "currency");
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(8, "div")(9, "span", 69);
    \u0275\u0275text(10, "Abonado");
    \u0275\u0275elementEnd();
    ...
    \u0275\u0275pipe(13, "currency");
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(14, "div")(15, "span", 69);
    \u0275\u0275text(16, "Meses cuotas");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(17, "span", 70);
    \u0275\u0275text(18);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(19, "div")(20, "span", 69);
...
function ContractDetailPageComponent_div_0_mat_option_106_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "mat-option", 75)(1, "span", 76);
...
function ContractDetailPageComponent_div_0_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275template(83, ContractDetailPageComponent_div_0_div_83_Template, 25, 14, "div", 28);
    ...
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(121, "div", 27)(122, "app-contract-hoa-payments", 50);
    ...
    \u0275\u0275element(124, "app-contract-documents", 52);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(125, "div", 27)(126, "div", 53)(127, "div", 54)(128, "p", 55);
    \u0275\u0275text(129, "Descarga el estado de cuenta en formato PDF");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(130, "button", 56);
    ...
    \u0275\u0275elementEnd()()()()();
    \u0275\u0275elementStart(132, "div", 57)(133, "div", 58)(134, "app-button", 59);
    ...
    \u0275\u0275template(136, ContractDetailPageComponent_div_0_app_button_136_Template, 1, 3, "app-button", 61);
    \u0275\u0275elementEnd()()()()();
  }
  if (rf & 2) {
    let tmp_38_0;
    ...
    \u0275\u0275advance();
    \u0275\u0275property("ngClass", \u0275\u0275pureFunction4(107, _c1, ctx_r1.badgeStatus === "activo", ctx_r1.badgeStatus === "completado", ctx_r1.badgeStatus === "cancelado", ctx_r1.badgeStatus === "suspendido"));
    \u0275\u0275advance();
    ...
    \u0275\u0275advance(6);
    \u0275\u0275textInterpolate(\u0275\u0275pipeBind2(43, 95, current_r4.down_payment, current_r4.currency));
    \u0275\u0275advance(6);
    \u0275\u0275textInterpolate(\u0275\u0275pipeBind2(49, 98, current_r4.total_price - current_r4.remaining_balance, current_r4.currency));
    \u0275\u0275advance(5);
    \u0275\u0275property("ngIf", ctx_r1.paymentStats());
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate(\u0275\u0275pipeBind2(56, 101, current_r4.remaining_balance, current_r4.currency));
    \u0275\u0275advance(6);
    \u0275\u0275textInterpolate1("", current_r4.payment_months, " meses");
    \u0275\u0275advance(5);
    \u0275\u0275textInterpolate(\u0275\u0275pipeBind2(67, 104, current_r4.monthly_payment, current_r4.currency));
    \u0275\u0275advance(3);
...
\u2022 Todos los documentos asociados`;
  ...
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _ContractDetailPageComponent, selectors: [["app-contract-detail-page"]], viewQuery: function ContractDetailPageComponent_Query(rf, ctx) {
    ...
    if (rf & 1) {
      \u0275\u0275template(0, ContractDetailPageComponent_div_0_Template, 137, 112, "div", 2)(1, ContractDetailPageComponent_div_1_Template, 2, 0, "div", 3);
    }
    if (rf & 2) {
...
//# sourceMappingURL=chunk-U6UXKVUR.js.map
