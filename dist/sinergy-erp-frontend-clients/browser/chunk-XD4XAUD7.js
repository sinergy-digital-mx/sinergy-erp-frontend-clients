...
function SalesReportComponent_ng_template_57_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275text(5);
    \u0275\u0275elementEnd()()();
    \u0275\u0275elementStart(6, "td", 45)(7, "p", 49);
    \u0275\u0275text(8);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(9, "td", 45)(10, "span", 50);
    \u0275\u0275text(11);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(12, "td", 45)(13, "div", 51)(14, "span", 52);
    \u0275\u0275text(15);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(16, "span", 53);
    \u0275\u0275text(17);
    \u0275\u0275elementEnd()()();
    \u0275\u0275elementStart(18, "td", 45)(19, "p", 54);
    \u0275\u0275text(20);
    \u0275\u0275elementEnd()();
  }
  if (rf & 2) {
    ...
    const ctx_r3 = \u0275\u0275nextContext();
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate1(" ", item_r8.branchInitials, " ");
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate(item_r8.branchName);
    \u0275\u0275advance(3);
...
var SalesReportComponent = class _SalesReportComponent {
  ...
  mapRow(r) {
    return {
      ...
      branchInitials: r.branch_initials,
  ...
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _SalesReportComponent, selectors: [["app-sales-report"]], viewQuery: function SalesReportComponent_Query(rf, ctx) {
    ...
    if (rf & 1) {
      ...
      \u0275\u0275elementEnd()()()();
      \u0275\u0275template(57, SalesReportComponent_ng_template_57_Template, 21, 7, "ng-template", null, 0, \u0275\u0275templateRefExtractor);
    }
    if (rf & 2) {
      let tmp_11_0;
      let tmp_12_0;
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(SalesReportComponent, { className: "SalesReportComponent", filePath: "src/app/features/zona-norte-reports/pages/sales-report/sales-report.component.ts", lineNumber: 409 });
})();
...
//# sourceMappingURL=chunk-XD4XAUD7.js.map
