...
function b(e, t, n = /* @__PURE__ */ new WeakSet()) {
  ...
  for (u = f; u-- !== 0; ) if (T2 = R2[u], !b(e[T2], t[T2], n)) return false;
  return true;
}
function y2(e, t) {
  return b(e, t);
...
var ue = (e = {}, t, r, s3) => {
  if (t) {
    let { variable: i2, options: a2 } = S.defaults || {}, { prefix: n, transform: l2 } = (e == null ? void 0 : e.options) || a2 || {}, o = G(t, k3) ? t : `{${t}}`;
  ...
  for (; o.length; ) {
    ...
    for (let u in m2) {
      ...
      if (i(f)) o.push({ node: f, path: p2 });
        ...
        let y3 = ae2(p2), R2 = Y2(f, p2, s3, [a2]);
        Re(l2, y3, R2);
        let T2 = p2;
...
var b2 = { regex: { rules: { class: { pattern: /^\.([a-zA-Z][\w-]*)$/, resolve(e) {
  ...
  if (s2(a2) && n.transform !== "strict") {
    ...
    d2 = `${et}${tt}`, u = [.../* @__PURE__ */ new Set([...We, ...Ze, ...Je])], g2 = m(a2.css, { dt: E2 });
  }
  ...
  if (s2(t) && r.transform !== "strict") {
    let y3 = e.replace("-directive", ""), m2 = t, { colorScheme: R2, extend: T2, css: j2 } = m2, O = v2(m2, ["colorScheme", "extend", "css"]), d2 = T2 || {}, { colorScheme: M } = d2, z3 = v2(d2, ["colorScheme"]), u = R2 || {}, { dark: V } = u, L = v2(u, ["dark"]), g2 = M || {}, { dark: te } = g2, re2 = v2(g2, ["dark"]), K3 = s2(O) ? this._toVariables({ [y3]: h2(h2({}, O), z3) }, r) : {}, A2 = s2(L) ? this._toVariables({ [y3]: h2(h2({}, L), re2) }, r) : {}, X2 = s2(V) ? this._toVariables({ [y3]: h2(h2({}, V), te) }, r) : {}, [G2, U2] = [(f = K3.declarations) != null ? f : "", K3.tokens || []], [B, I] = [(x2 = A2.declarations) != null ? x2 : "", A2.tokens || []], [H2, W2] = [(p2 = X2.declarations) != null ? p2 : "", X2.tokens || []], q = this.transformCSS(y3, `${G2}${B}`, "light", "variable", r, i2, a2, n), Z = this.transformCSS(y3, H2, "dark", "variable", r, i2, a2, n);
    l2 = `${q}${Z}`, o = [.../* @__PURE__ */ new Set([...U2, ...I, ...W2])], c3 = m(j2, { dt: E2 });
  }
...
var S = { defaults: { variable: { prefix: "p", selector: ":root,:host", excludedKeyRegex: /^(primitive|semantic|components|directives|variables|colorscheme|light|dark|common|root|states|extend|css)$/gi }, options: { prefix: "p", darkModeSelector: "system", cssLayer: false } }, _theme: void 0, _layerNames: /* @__PURE__ */ new Set(), _loadedStyleNames: /* @__PURE__ */ new Set(), _loadingStyles: /* @__PURE__ */ new Set(), _tokens: {}, update(e = {}) {
  let { theme: t } = e;
  t && (this._theme = $3(h2({}, t), { options: h2(h2({}, this.defaults.options), t.options) }), this._tokens = b2.createTokens(this.preset, this.defaults), this.clearLoadedStyleNames());
}, get theme() {
  return this._theme;
}, get preset() {
  var e;
...
//# sourceMappingURL=chunk-X6ESXIRL.js.map
