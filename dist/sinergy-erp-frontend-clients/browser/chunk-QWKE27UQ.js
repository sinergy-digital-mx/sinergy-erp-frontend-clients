...
function Login_p_13_Template(rf, ctx) {
  if (rf & 1) {
...
var Login = class _Login {
  ...
  constructor(fb, router, route, authService) {
    ...
    if (reason === "no-access") {
      this.error.set("Tu cuenta no tiene m\xF3dulos asignados. Contacta al administrador.");
    }
  }
  submit() {
  ...
  static \u0275fac = function Login_Factory(__ngFactoryType__) {
    return new (__ngFactoryType__ || _Login)(\u0275\u0275directiveInject(FormBuilder), \u0275\u0275directiveInject(Router), \u0275\u0275directiveInject(ActivatedRoute), \u0275\u0275directiveInject(AuthService));
  };
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _Login, selectors: [["app-login"]], decls: 20, vars: 6, consts: [[1, "min-h-screen", "flex", "items-center", "justify-center", "px-4", "login-bg"], [1, "w-full", "max-w-md"], [1, "bg-white", "rounded-xl", "shadow-lg", "p-8", "login-fade-card"], [1, "flex", "justify-center", "mb-6"], ["theme", "light", "size", "lg"], [1, "text-2xl", "font-semibold", "text-center", "text-gray-800"], [1, "text-sm", "text-center", "text-gray-500", "mt-1", "mb-6"], [3, "ngSubmit", "formGroup"], [1, "flex", "flex-col", "gap-4"], ["label", "Correo", 3, "form_control"], ["label", "Contrase\xF1a", 3, "form_control"], ["class", "mt-3 text-sm text-red-600", 4, "ngIf"], ["type", "submit", 3, "loading", "customClass"], ["type", "submit", "aria-hidden", "true", "tabindex", "-1", 1, "hidden"], [1, "mt-6", "text-center"], ["href", "#", 1, "text-sm", "text-indigo-600", "hover:underline"], [1, "mt-3", "text-sm", "text-red-600"]], template: function Login_Template(rf, ctx) {
    if (rf & 1) {
      \u0275\u0275elementStart(0, "div", 0)(1, "div", 1)(2, "div", 2)(3, "div", 3);
      \u0275\u0275element(4, "app-pollux-brand-text", 4);
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(5, "h1", 5);
      \u0275\u0275text(6, " Bienvenido ");
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(7, "p", 6);
      \u0275\u0275text(8, " Ingresa a tu cuenta ");
      \u0275\u0275elementEnd();
      ...
      \u0275\u0275element(11, "app-input", 9)(12, "app-password", 10);
      \u0275\u0275elementEnd();
      \u0275\u0275template(13, Login_p_13_Template, 2, 1, "p", 11);
      \u0275\u0275elementStart(14, "app-button", 12);
      \u0275\u0275text(15, " Iniciar sesi\xF3n ");
      \u0275\u0275elementEnd();
...
(() => {
  ...
  \r
        ...
        <div class="flex justify-center mb-6">\r
          <app-pollux-brand-text theme="light" size="lg" />\r
        </div>\r
  \r
        <!-- T\xEDtulo -->\r
...
//# sourceMappingURL=chunk-QWKE27UQ.js.map
