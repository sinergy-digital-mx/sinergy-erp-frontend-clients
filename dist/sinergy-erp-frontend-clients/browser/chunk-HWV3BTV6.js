...
function LeadDetail_ng_template_58_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275template(16, LeadDetail_ng_template_58_p_tag_16_Template, 1, 0, "p-tag", 35);
    \u0275\u0275elementEnd()();
  }
  if (rf & 2) {
...
var LeadDetail = class _LeadDetail {
  ...
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _LeadDetail, selectors: [["app-lead-detail"]], decls: 67, vars: 22, consts: [["noEmail", ""], ["noWebsite", ""], [1, "space-y-6", "sm:space-y-10", "min-h-screen"], [1, "flex", "flex-col", "sm:flex-row", "sm:items-center", "sm:justify-between", "gap-4"], [1, "min-w-0"], [1, "text-2xl", "sm:text-3xl", "font-bold", "text-gray-900", "truncate"], [1, "text-sm", "text-gray-500", "truncate"], ["pButton", "", "label", "Editar lead", "icon", "pi pi-pencil", "size", "small", 1, "p-button-rounded", "p-button-solid", "text-sm", "w-full", "sm:w-auto", 3, "click"], [1, "bg-white", "shadow-md", "rounded-xl", "p-4", "sm:p-6", "border", "border-gray-100"], [1, "text-lg", "font-semibold", "text-gray-800", "mb-4"], [1, "grid", "grid-cols-1", "sm:grid-cols-2", "gap-y-3", "gap-x-10", "text-sm", "text-gray-800"], [1, "font-semibold", "text-gray-500"], ["class", "link-pro link-pro-break", 3, "href", 4, "ngIf", "ngIfElse"], [3, "phone", "countryCode", "countryPhoneCode"], [1, "sm:col-span-2"], ["target", "_blank", "rel", "noopener noreferrer", "class", "link-pro link-pro-break", 3, "href", 4, "ngIf", "ngIfElse"], [1, "flex", "items-center", "gap-2"], ["rounded", "true", 3, "value"], [1, "mt-0.5"], [3, "leadId", "leadEmail"], [1, "flex", "flex-col", "sm:flex-row", "sm:items-center", "sm:justify-between", "gap-3", "mb-4"], [1, "text-lg", "font-semibold", "text-gray-800"], ["pButton", "", "icon", "pi pi-plus", "label", "Agregar direcci\xF3n", 1, "p-button-sm", "p-button-outlined", "w-full", "sm:w-auto"], ["responsiveLayout", "scroll", "styleClass", "p-datatable-sm w-full", 3, "value"], ["pTemplate", "header"], ["pTemplate", "body"], ["pButton", "", "icon", "pi pi-plus", "label", "Agregar actividad", 1, "p-button-sm", "p-button-outlined", "w-full", "sm:w-auto", 3, "click"], [1, "link-pro", "link-pro-break", 3, "href"], [1, "pi", "pi-envelope", "link-pro-icon"], ["target", "_blank", "rel", "noopener noreferrer", 1, "link-pro", "link-pro-break", 3, "href"], [1, "pi", "pi-external-link", "link-pro-icon"], [1, "capitalize"], ["target", "_blank", "rel", "noopener noreferrer", 1, "link-pro", "link-pro-muted", 3, "href"], [1, "pi", "pi-map-marker", "link-pro-icon"], [1, "text-center"], ["value", "Principal", "severity", "success", "rounded", "true", 4, "ngIf"], ["value", "Principal", "severity", "success", "rounded", "true"], ["severity", "info", "rounded", "true", 3, "value"], [1, "font-medium", "text-gray-800"], [1, "text-xs", "text-gray-500"], ["severity", "success", "rounded", "true", 3, "value"]], template: function LeadDetail_Template(rf, ctx) {
    if (rf & 1) {
      const _r1 = \u0275\u0275getCurrentView();
      ...
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(11, "div", 10)(12, "div")(13, "span", 11);
      \u0275\u0275text(14, "Nombre:");
      \u0275\u0275elementEnd();
      \u0275\u0275text(15);
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(16, "div")(17, "span", 11);
      \u0275\u0275text(18, "Apellido:");
      \u0275\u0275elementEnd();
      \u0275\u0275text(19);
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(20, "div")(21, "span", 11);
      \u0275\u0275text(22, "Email:");
      \u0275\u0275elementEnd();
      \u0275\u0275template(23, LeadDetail_a_23_Template, 3, 2, "a", 12)(24, LeadDetail_ng_template_24_Template, 1, 0, "ng-template", null, 0, \u0275\u0275templateRefExtractor);
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(26, "div")(27, "span", 11);
      \u0275\u0275text(28, "Tel\xE9fono:");
      \u0275\u0275elementEnd();
      \u0275\u0275element(29, "app-phone", 13);
      \u0275\u0275elementEnd();
      ...
      \u0275\u0275text(33);
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(34, "div", 14)(35, "span", 11);
      \u0275\u0275text(36, "Sitio web:");
      \u0275\u0275elementEnd();
      \u0275\u0275template(37, LeadDetail_a_37_Template, 3, 2, "a", 15)(38, LeadDetail_ng_template_38_Template, 1, 0, "ng-template", null, 1, \u0275\u0275templateRefExtractor);
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(40, "div", 16)(41, "span", 11);
      \u0275\u0275text(42, "Estado:");
      \u0275\u0275elementEnd();
      \u0275\u0275element(43, "p-tag", 17);
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(44, "div", 14)(45, "span", 11);
      \u0275\u0275text(46, "Creado el:");
      \u0275\u0275elementEnd();
      ...
      \u0275\u0275pipe(49, "date");
      \u0275\u0275elementEnd()()()();
      \u0275\u0275element(50, "app-email-threads-section", 19);
      \u0275\u0275elementStart(51, "div", 8)(52, "div", 20)(53, "h3", 21);
      \u0275\u0275text(54, " Direcciones ");
      \u0275\u0275elementEnd();
      \u0275\u0275element(55, "button", 22);
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(56, "p-table", 23);
      \u0275\u0275template(57, LeadDetail_ng_template_57_Template, 15, 0, "ng-template", 24)(58, LeadDetail_ng_template_58_Template, 17, 8, "ng-template", 25);
      \u0275\u0275elementEnd()();
      \u0275\u0275elementStart(59, "div", 8)(60, "div", 20)(61, "h3", 21);
      ...
      \u0275\u0275elementEnd()();
      \u0275\u0275elementStart(64, "p-table", 23);
      \u0275\u0275template(65, LeadDetail_ng_template_65_Template, 13, 0, "ng-template", 24)(66, LeadDetail_ng_template_66_Template, 17, 10, "ng-template", 25);
      \u0275\u0275elementEnd()()();
    }
    if (rf & 2) {
      let tmp_2_0;
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && setClassMetadata(LeadDetail, [{
    type: Component,
    args: [{ selector: "app-lead-detail", standalone: true, schemas: [NO_ERRORS_SCHEMA], imports: [CommonModule, TagModule, ButtonModule, EmailThreadsSection, PhoneComponent], template: `<div class="space-y-6 sm:space-y-10 min-h-screen">\r
\r
    <!-- HEADER -->\r
    <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">\r
      <div class="min-w-0">\r
        <h2 class="text-2xl sm:text-3xl font-bold text-gray-900 truncate">\r
          {{ lead()?.name }} {{ lead()?.lastname }}\r
        </h2>\r
        <p class="text-sm text-gray-500 truncate">\r
          {{ lead()?.email }}\r
        </p>\r
      </div>\r
  \r
      <button\r
        ...
        label="Editar lead"\r
        icon="pi pi-pencil"\r
        class="p-button-rounded p-button-solid text-sm w-full sm:w-auto"\r
        size="small">\r
      </button>\r
    </div>\r
  \r
<!-- LEAD INFORMATION -->\r
<div class="bg-white shadow-md rounded-xl p-4 sm:p-6 border border-gray-100">\r
  <h3 class="text-lg font-semibold text-gray-800 mb-4">\r
    Informaci\xF3n del Lead\r
  </h3>\r
\r
  <div class="grid grid-cols-1 sm:grid-cols-2 gap-y-3 gap-x-10 text-sm text-gray-800">\r
\r
    <div>\r
...
<div class="bg-white shadow-md rounded-xl p-4 sm:p-6 border border-gray-100">\r
\r
    <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3 mb-4">\r
  ...
  \r
      <button\r
        ...
        class="p-button-sm p-button-outlined w-full sm:w-auto"\r
    >\r
      </button>\r
    </div>\r
  \r
...
//# sourceMappingURL=chunk-HWV3BTV6.js.map
