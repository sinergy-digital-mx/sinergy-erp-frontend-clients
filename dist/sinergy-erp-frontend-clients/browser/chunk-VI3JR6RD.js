...
function ContractPaymentsComponent_div_6_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate1(" ", ctx_r1.isContractCompleted ? "Contrato pagado" : "Sin pagos generados", " ");
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate1(" ", ctx_r1.isContractCompleted ? "Este contrato ya esta completado y no requiere generar pagos." : "Genera los pagos para empezar a registrar cobros del contrato.", " ");
  }
}
...
\r
  ...
  <div *ngIf="!loading() && payments().length === 0" class="payments-empty-state">\r
    ...
    <p class="payments-empty-state__title">\r
      {{ isContractCompleted ? 'Contrato pagado' : 'Sin pagos generados' }}\r
    </p>\r
    <p class="payments-empty-state__subtitle">\r
      {{ isContractCompleted ? 'Este contrato ya esta completado y no requiere generar pagos.' : 'Genera los pagos para empezar a registrar cobros del contrato.' }}\r
    </p>\r
  </div>\r
\r
  <!-- Payments Table -->\r
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(ContractPaymentsComponent, { className: "ContractPaymentsComponent", filePath: "src/app/features/contracts/components/contract-payments/contract-payments.component.ts", lineNumber: 29 });
})();
...
function ContractHoaPaymentsComponent_div_6_Template(rf, ctx) {
  ...
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext();
    \u0275\u0275advance(4);
    \u0275\u0275textInterpolate1(" ", ctx_r1.isContractCompleted ? "Sin pagos HOA pendientes" : "No hay pagos HOA generados", " ");
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate1(" ", ctx_r1.isContractCompleted ? "Este contrato ya fue completado. Si ocupas historial, aparecer\xE1 aqu\xED cuando existan movimientos." : "Genera los pagos HOA para comenzar a registrar y controlar los cobros mensuales.", " ");
  }
}
...
\r
  <div *ngIf="!loading() && payments().length === 0" class="empty-state">\r
    ...
    <p class="empty-state__title">\r
      {{ isContractCompleted ? 'Sin pagos HOA pendientes' : 'No hay pagos HOA generados' }}\r
    </p>\r
    <p class="empty-state__subtitle">\r
      {{ isContractCompleted ? 'Este contrato ya fue completado. Si ocupas historial, aparecer\xE1 aqu\xED cuando existan movimientos.' : 'Genera los pagos HOA para comenzar a registrar y controlar los cobros mensuales.' }}\r
    </p>\r
  </div>\r
\r
  <div *ngIf="!loading() && payments().length > 0" class="overflow-x-auto">\r
...
var DownpaymentPaymentService = class _DownpaymentPaymentService {
  ...
  generate(contractId) {
    return this.http.post(`${this.api}/tenant/contracts/${contractId}/downpayment-payments/generate`, {});
  }
  getPayments(contractId) {
...
function ContractDownpaymentPaymentsComponent_div_3_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275text(6, " Activa el financiamiento de enganche en el contrato para habilitar la generaci\xF3n de pagos en esta secci\xF3n. ");
    \u0275\u0275elementEnd()();
  }
}
function ContractDownpaymentPaymentsComponent_div_4_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275text(20);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(21, "div", 26)(22, "p", 27);
    \u0275\u0275text(23, "Vencidos");
    \u0275\u0275elementEnd();
  ...
  if (rf & 2) {
    const ctx_r0 = \u0275\u0275nextContext();
    \u0275\u0275advance(5);
    \u0275\u0275textInterpolate(ctx_r0.stats().total_payments);
    \u0275\u0275advance(5);
    \u0275\u0275textInterpolate(ctx_r0.stats().paid_count);
    \u0275\u0275advance(5);
    \u0275\u0275textInterpolate(ctx_r0.stats().partial_count);
    \u0275\u0275advance(5);
    \u0275\u0275textInterpolate(ctx_r0.stats().pending_count);
    \u0275\u0275advance(5);
    \u0275\u0275textInterpolate(ctx_r0.stats().overdue_count);
  }
}
...
function ContractDownpaymentPaymentsComponent_div_6_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 31)(1, "div", 10);
    \u0275\u0275text(2, "DP");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(3, "p", 11);
    \u0275\u0275text(4, "No hay pagos de enganche generados");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(5, "p", 12);
    \u0275\u0275text(6, " Genera los pagos de enganche para empezar a registrar abonos y dar seguimiento al saldo. ");
    \u0275\u0275elementEnd()();
  }
}
function ContractDownpaymentPaymentsComponent_div_7_tr_23_button_25_Template(rf, ctx) {
  if (rf & 1) {
    const _r3 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "button", 50);
    \u0275\u0275listener("click", function ContractDownpaymentPaymentsComponent_div_7_tr_23_button_25_Template_button_click_0_listener() {
      \u0275\u0275restoreView(_r3);
      const payment_r4 = \u0275\u0275nextContext().$implicit;
      const ctx_r0 = \u0275\u0275nextContext(2);
      return \u0275\u0275resetView(ctx_r0.registerPayment(payment_r4));
    });
  ...
  if (rf & 2) {
    ...
    \u0275\u0275property("matTooltip", "Registrar Pago");
    \u0275\u0275advance();
    \u0275\u0275property("img", ctx_r0.DollarSign)("size", 16);
  }
}
function ContractDownpaymentPaymentsComponent_div_7_tr_23_button_26_Template(rf, ctx) {
  if (rf & 1) {
    const _r5 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "button", 51);
    \u0275\u0275listener("click", function ContractDownpaymentPaymentsComponent_div_7_tr_23_button_26_Template_button_click_0_listener() {
      \u0275\u0275restoreView(_r5);
      const payment_r4 = \u0275\u0275nextContext().$implicit;
      const ctx_r0 = \u0275\u0275nextContext(2);
      return \u0275\u0275resetView(ctx_r0.editPayment(payment_r4));
    });
    \u0275\u0275element(1, "lucide-icon", 48);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    ...
    \u0275\u0275property("matTooltip", "Editar Pago");
    \u0275\u0275advance();
    \u0275\u0275property("img", ctx_r0.Edit)("size", 16);
  }
}
function ContractDownpaymentPaymentsComponent_div_7_tr_23_button_27_Template(rf, ctx) {
  if (rf & 1) {
    const _r6 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "button", 52);
    \u0275\u0275listener("click", function ContractDownpaymentPaymentsComponent_div_7_tr_23_button_27_Template_button_click_0_listener() {
      \u0275\u0275restoreView(_r6);
      const payment_r4 = \u0275\u0275nextContext().$implicit;
      const ctx_r0 = \u0275\u0275nextContext(2);
      return \u0275\u0275resetView(ctx_r0.resetPayment(payment_r4));
    });
    \u0275\u0275element(1, "lucide-icon", 48);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    ...
    \u0275\u0275property("matTooltip", "Resetear Pago");
    \u0275\u0275advance();
    \u0275\u0275property("img", ctx_r0.RotateCcw)("size", 16);
  }
}
function ContractDownpaymentPaymentsComponent_div_7_tr_23_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275pipe(17, "localDate");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(18, "td", 42)(19, "span");
    \u0275\u0275text(20);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(21, "td", 41);
    \u0275\u0275text(22);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(23, "td", 42)(24, "div", 43);
    \u0275\u0275template(25, ContractDownpaymentPaymentsComponent_div_7_tr_23_button_25_Template, 2, 3, "button", 44)(26, ContractDownpaymentPaymentsComponent_div_7_tr_23_button_26_Template, 2, 3, "button", 45)(27, ContractDownpaymentPaymentsComponent_div_7_tr_23_button_27_Template, 2, 3, "button", 46);
    \u0275\u0275elementStart(28, "button", 47);
    \u0275\u0275listener("click", function ContractDownpaymentPaymentsComponent_div_7_tr_23_Template_button_click_28_listener() {
      const payment_r4 = \u0275\u0275restoreView(_r2).$implicit;
      const ctx_r0 = \u0275\u0275nextContext(2);
      return \u0275\u0275resetView(ctx_r0.cancelPayment(payment_r4));
    });
    \u0275\u0275element(29, "lucide-icon", 48);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(30, "button", 49);
    \u0275\u0275listener("click", function ContractDownpaymentPaymentsComponent_div_7_tr_23_Template_button_click_30_listener() {
      const payment_r4 = \u0275\u0275restoreView(_r2).$implicit;
      const ctx_r0 = \u0275\u0275nextContext(2);
      return \u0275\u0275resetView(ctx_r0.deletePayment(payment_r4));
    });
    \u0275\u0275element(31, "lucide-icon", 48);
    \u0275\u0275elementEnd()()()();
  }
  if (rf & 2) {
    const payment_r4 = ctx.$implicit;
    ...
    \u0275\u0275textInterpolate(payment_r4.payment_number);
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate(\u0275\u0275pipeBind2(5, 19, payment_r4.amount, ctx_r0.currency));
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate(\u0275\u0275pipeBind2(8, 22, payment_r4.amount_paid, ctx_r0.currency));
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate(\u0275\u0275pipeBind2(11, 25, payment_r4.amount_pending, ctx_r0.currency));
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate(\u0275\u0275pipeBind2(14, 28, payment_r4.due_date, "mediumDate"));
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate(payment_r4.paid_date ? \u0275\u0275pipeBind2(17, 31, payment_r4.paid_date, "mediumDate") : "\u2014");
    \u0275\u0275advance(3);
    \u0275\u0275classMap(ctx_r0.getStatusClass(payment_r4.status, payment_r4.is_overdue));
    \u0275\u0275advance();
    \u0275\u0275textInterpolate1(" ", ctx_r0.getStatusLabel(payment_r4.status, payment_r4.is_overdue), " ");
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate(payment_r4.payment_method || "\u2014");
    \u0275\u0275advance(3);
    \u0275\u0275property("ngIf", ctx_r0.canRegisterPayment(payment_r4));
    \u0275\u0275advance();
    \u0275\u0275property("ngIf", ctx_r0.canEdit(payment_r4));
    \u0275\u0275advance();
    \u0275\u0275property("ngIf", ctx_r0.canResetPayment(payment_r4));
    \u0275\u0275advance();
    ...
    \u0275\u0275advance();
    \u0275\u0275property("img", ctx_r0.Trash2)("size", 16);
  }
}
function ContractDownpaymentPaymentsComponent_div_7_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275text(21, "Acciones");
    \u0275\u0275elementEnd()()();
    \u0275\u0275elementStart(22, "tbody", 36);
    \u0275\u0275template(23, ContractDownpaymentPaymentsComponent_div_7_tr_23_Template, 32, 34, "tr", 37);
    \u0275\u0275elementEnd()()();
  }
  if (rf & 2) {
    const ctx_r0 = \u0275\u0275nextContext();
    \u0275\u0275advance(23);
    \u0275\u0275property("ngForOf", ctx_r0.paginatedPayments);
  }
}
function ContractDownpaymentPaymentsComponent_div_8_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275listener("click", function ContractDownpaymentPaymentsComponent_div_8_Template_button_click_4_listener() {
      \u0275\u0275restoreView(_r7);
      const ctx_r0 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r0.setPage(ctx_r0.currentPage() - 1));
    });
    \u0275\u0275text(5, "Anterior");
    \u0275\u0275elementEnd();
    ...
    \u0275\u0275listener("click", function ContractDownpaymentPaymentsComponent_div_8_Template_button_click_8_listener() {
      \u0275\u0275restoreView(_r7);
      const ctx_r0 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r0.setPage(ctx_r0.currentPage() + 1));
    });
  ...
  if (rf & 2) {
    const ctx_r0 = \u0275\u0275nextContext();
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate3(" Mostrando ", (ctx_r0.currentPage() - 1) * ctx_r0.pageSize + 1, " - ", ctx_r0.Math.min(ctx_r0.currentPage() * ctx_r0.pageSize, ctx_r0.payments().length), " de ", ctx_r0.payments().length, " pagos ");
    \u0275\u0275advance(2);
    \u0275\u0275property("disabled", ctx_r0.currentPage() === 1);
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate2("P\xE1gina ", ctx_r0.currentPage(), " / ", ctx_r0.totalPages);
    \u0275\u0275advance();
...
(() => {
  ...
  <div class="flex items-center justify-end mb-2 gap-2">\r
    <app-button\r
      text="Generar pagos de enganche"\r
      custom_class="btn_primary"\r
      size="sm"\r
      [loading]="generating()"\r
      [disabled]="!contract?.down_payment_financed || payments().length > 0"\r
      (clicked)="generatePayments()">\r
    </app-button>\r
  </div>\r
\r
  <div *ngIf="!contract?.down_payment_financed" class="empty-state empty-state--neutral">\r
    <div class="empty-state__icon">DP</div>\r
    <p class="empty-state__title">Enganche no financiado</p>\r
    <p class="empty-state__subtitle">\r
      Activa el financiamiento de enganche en el contrato para habilitar la generaci\xF3n de pagos en esta secci\xF3n.\r
    </p>\r
  </div>\r
\r
  <div *ngIf="contract?.down_payment_financed && stats() && payments().length > 0" class="grid grid-cols-5 gap-4 mb-6 w-full">\r
    <div class="bg-gray-50 p-4 rounded-lg border border-gray-200">\r
      <p class="text-sm font-medium text-gray-600">Total pagos</p>\r
      <p class="text-2xl font-bold text-gray-900 mt-1">{{ stats()!.total_payments }}</p>\r
    </div>\r
...
\r
  <div *ngIf="contract?.down_payment_financed && !loading() && payments().length === 0" class="empty-state">\r
    <div class="empty-state__icon">DP</div>\r
    <p class="empty-state__title">No hay pagos de enganche generados</p>\r
    <p class="empty-state__subtitle">\r
      Genera los pagos de enganche para empezar a registrar abonos y dar seguimiento al saldo.\r
    </p>\r
  </div>\r
\r
  <div *ngIf="!loading() && payments().length > 0" class="overflow-x-auto">\r
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(ContractDownpaymentPaymentsComponent, { className: "ContractDownpaymentPaymentsComponent", filePath: "src/app/features/contracts/components/contract-downpayment-payments/contract-downpayment-payments.component.ts", lineNumber: 21 });
})();
...
//# sourceMappingURL=chunk-VI3JR6RD.js.map
