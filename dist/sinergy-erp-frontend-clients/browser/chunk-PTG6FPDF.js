    ...
    this.propertyService.createProperty(payload).subscribe({
      ...
      error: (err) => {
        ...
        this.interceptor_service.openSnackbar({
          type: "error",
          title: "Error",
          message: this.resolveApiErrorMessage(err, "No pudimos crear el lote. Por favor intenta de nuevo.")
        });
      }
    });
  }
    ...
    this.propertyService.updateProperty(this.data.property.id, payload).subscribe({
      ...
      error: (err) => {
        ...
        this.interceptor_service.openSnackbar({
          type: "error",
          title: "Error",
          message: this.resolveApiErrorMessage(err, "No pudimos actualizar el lote. Por favor intenta de nuevo.")
        });
      }
    });
  }
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(PropertyEditModalComponent, { className: "PropertyEditModalComponent", filePath: "src/app/features/properties/components/property-edit-modal/property-edit-modal.component.ts", lineNumber: 29 });
})();
...
//# sourceMappingURL=chunk-PTG6FPDF.js.map
