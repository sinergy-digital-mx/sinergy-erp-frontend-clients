...
var CustomSnackbarComponent = class _CustomSnackbarComponent {
  ...
  get fallbackTitle() {
    switch (this.type) {
      case "success":
        return "Operaci\xF3n exitosa";
      case "error":
        return "Ocurri\xF3 un error";
      case "warning":
        return "Revisa esta informaci\xF3n";
      case "highlight":
        return "Aviso";
      default:
  ...
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _CustomSnackbarComponent, selectors: [["app-custom-snackbar"]], decls: 9, vars: 6, consts: [["role", "status", 1, "toast", 3, "click"], ["aria-hidden", "true", 1, "toast__icon-wrap"], [1, "toast__icon", 3, "img"], [1, "toast__content"], [1, "toast__title"], [1, "toast__message"], ["type", "button", "aria-label", "Cerrar", 1, "toast__close", 3, "click"], [1, "toast__close-icon", 3, "img"]], template: function CustomSnackbarComponent_Template(rf, ctx) {
    if (rf & 1) {
      \u0275\u0275elementStart(0, "div", 0);
      \u0275\u0275listener("click", function CustomSnackbarComponent_Template_div_click_0_listener() {
        return ctx.dismiss();
      });
      ...
      \u0275\u0275text(5);
      \u0275\u0275elementEnd();
      \u0275\u0275conditionalCreate(6, CustomSnackbarComponent_Conditional_6_Template, 2, 1, "p", 5);
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(7, "button", 6);
      \u0275\u0275listener("click", function CustomSnackbarComponent_Template_button_click_7_listener($event) {
        ctx.dismiss();
    ...
    if (rf & 2) {
      \u0275\u0275classMap("toast--" + ctx.type);
      \u0275\u0275advance(2);
      \u0275\u0275property("img", ctx.iconForType());
      \u0275\u0275advance(3);
      \u0275\u0275textInterpolate(ctx.displayTitle);
      \u0275\u0275advance();
      \u0275\u0275conditional(ctx.displayMessage ? 6 : -1);
      \u0275\u0275advance(2);
      \u0275\u0275property("img", ctx.X);
    }
  }, dependencies: [CommonModule, LucideAngularModule, LucideAngularComponent], styles: ["\n\n.toast[_ngcontent-%COMP%] {\n  display: flex;\n  align-items: flex-start;\n  gap: 0.75rem;\n  min-width: 280px;\n  max-width: min(420px, 100vw - 2rem);\n  padding: 0.875rem 1rem;\n  border-radius: 0.875rem;\n  border: 1px solid transparent;\n  box-shadow: 0 10px 25px rgba(15, 23, 42, 0.12), 0 2px 8px rgba(15, 23, 42, 0.06);\n  cursor: pointer;\n  -webkit-user-select: none;\n  user-select: none;\n  -webkit-backdrop-filter: blur(8px);\n  backdrop-filter: blur(8px);\n}\n.toast__icon-wrap[_ngcontent-%COMP%] {\n  flex-shrink: 0;\n  width: 2rem;\n  height: 2rem;\n  border-radius: 9999px;\n  display: flex;\n  align-items: center;\n  justify-content: center;\n}\n.toast__icon[_ngcontent-%COMP%] {\n  width: 1.125rem;\n  height: 1.125rem;\n}\n.toast__content[_ngcontent-%COMP%] {\n  flex: 1;\n  min-width: 0;\n  display: flex;\n  flex-direction: column;\n  gap: 0.125rem;\n  padding-top: 0.1rem;\n}\n.toast__title[_ngcontent-%COMP%] {\n  margin: 0;\n  font-size: 0.8125rem;\n  font-weight: 700;\n  letter-spacing: -0.01em;\n  line-height: 1.25;\n}\n.toast__message[_ngcontent-%COMP%] {\n  margin: 0;\n  font-size: 0.8125rem;\n  font-weight: 500;\n  line-height: 1.4;\n  opacity: 0.92;\n}\n.toast__message--solo[_ngcontent-%COMP%] {\n  font-size: 0.875rem;\n  font-weight: 600;\n  opacity: 1;\n}\n.toast__close[_ngcontent-%COMP%] {\n  flex-shrink: 0;\n  width: 1.75rem;\n  height: 1.75rem;\n  border: none;\n  border-radius: 0.5rem;\n  background: transparent;\n  display: inline-flex;\n  align-items: center;\n  justify-content: center;\n  cursor: pointer;\n  opacity: 0.55;\n  transition: opacity 0.2s, background-color 0.2s;\n  margin: -0.15rem -0.25rem 0 0;\n}\n.toast__close[_ngcontent-%COMP%]:hover {\n  opacity: 1;\n  background: rgba(15, 23, 42, 0.06);\n}\n.toast__close-icon[_ngcontent-%COMP%] {\n  width: 1rem;\n  height: 1rem;\n}\n.toast--success[_ngcontent-%COMP%] {\n  background:\n    linear-gradient(\n      135deg,\n      #f0fdf4 0%,\n      #ecfdf5 100%);\n  border-color: #86efac;\n  color: #14532d;\n}\n.toast--success[_ngcontent-%COMP%]   .toast__icon-wrap[_ngcontent-%COMP%] {\n  background: #dcfce7;\n  color: #16a34a;\n}\n.toast--error[_ngcontent-%COMP%] {\n  background:\n    linear-gradient(\n      135deg,\n      #fef2f2 0%,\n      #fff1f2 100%);\n  border-color: #fca5a5;\n  color: #7f1d1d;\n}\n.toast--error[_ngcontent-%COMP%]   .toast__icon-wrap[_ngcontent-%COMP%] {\n  background: #fee2e2;\n  color: #dc2626;\n}\n.toast--warning[_ngcontent-%COMP%] {\n  background:\n    linear-gradient(\n      135deg,\n      #fffbeb 0%,\n      #fefce8 100%);\n  border-color: #fde047;\n  color: #713f12;\n}\n.toast--warning[_ngcontent-%COMP%]   .toast__icon-wrap[_ngcontent-%COMP%] {\n  background: #fef9c3;\n  color: #ca8a04;\n}\n.toast--info[_ngcontent-%COMP%] {\n  background:\n    linear-gradient(\n      135deg,\n      #eff6ff 0%,\n      #f0f9ff 100%);\n  border-color: #93c5fd;\n  color: #1e3a8a;\n}\n.toast--info[_ngcontent-%COMP%]   .toast__icon-wrap[_ngcontent-%COMP%] {\n  background: #dbeafe;\n  color: #2563eb;\n}\n.toast--highlight[_ngcontent-%COMP%] {\n  background:\n    linear-gradient(\n      135deg,\n      #f5f3ff 0%,\n      #faf5ff 100%);\n  border-color: #c4b5fd;\n  color: #4c1d95;\n}\n.toast--highlight[_ngcontent-%COMP%]   .toast__icon-wrap[_ngcontent-%COMP%] {\n  background: #ede9fe;\n  color: #7c3aed;\n}\n/*# sourceMappingURL=custom-snackbar.component.css.map */"] });
};
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && setClassMetadata(CustomSnackbarComponent, [{
    type: Component,
    args: [{ selector: "app-custom-snackbar", standalone: true, imports: [CommonModule, LucideAngularModule], template: `<div class="toast" [class]="'toast--' + type" role="status" (click)="dismiss()">\r
  <div class="toast__icon-wrap" aria-hidden="true">\r
    <lucide-icon [img]="iconForType()" class="toast__icon"></lucide-icon>\r
  </div>\r
\r
  <div class="toast__content">\r
    <p class="toast__title">{{ displayTitle }}</p>\r
    @if (displayMessage) {\r
      <p class="toast__message">{{ displayMessage }}</p>\r
    }\r
  </div>\r
\r
  <button type="button" class="toast__close" (click)="dismiss(); $event.stopPropagation()" aria-label="Cerrar">\r
    <lucide-icon [img]="X" class="toast__close-icon"></lucide-icon>\r
  </button>\r
</div>\r
`, styles: ["/* src/app/core/components/custom-snackbar/custom-snackbar.component.scss */\n.toast {\n  display: flex;\n  align-items: flex-start;\n  gap: 0.75rem;\n  min-width: 280px;\n  max-width: min(420px, 100vw - 2rem);\n  padding: 0.875rem 1rem;\n  border-radius: 0.875rem;\n  border: 1px solid transparent;\n  box-shadow: 0 10px 25px rgba(15, 23, 42, 0.12), 0 2px 8px rgba(15, 23, 42, 0.06);\n  cursor: pointer;\n  -webkit-user-select: none;\n  user-select: none;\n  -webkit-backdrop-filter: blur(8px);\n  backdrop-filter: blur(8px);\n}\n.toast__icon-wrap {\n  flex-shrink: 0;\n  width: 2rem;\n  height: 2rem;\n  border-radius: 9999px;\n  display: flex;\n  align-items: center;\n  justify-content: center;\n}\n.toast__icon {\n  width: 1.125rem;\n  height: 1.125rem;\n}\n.toast__content {\n  flex: 1;\n  min-width: 0;\n  display: flex;\n  flex-direction: column;\n  gap: 0.125rem;\n  padding-top: 0.1rem;\n}\n.toast__title {\n  margin: 0;\n  font-size: 0.8125rem;\n  font-weight: 700;\n  letter-spacing: -0.01em;\n  line-height: 1.25;\n}\n.toast__message {\n  margin: 0;\n  font-size: 0.8125rem;\n  font-weight: 500;\n  line-height: 1.4;\n  opacity: 0.92;\n}\n.toast__message--solo {\n  font-size: 0.875rem;\n  font-weight: 600;\n  opacity: 1;\n}\n.toast__close {\n  flex-shrink: 0;\n  width: 1.75rem;\n  height: 1.75rem;\n  border: none;\n  border-radius: 0.5rem;\n  background: transparent;\n  display: inline-flex;\n  align-items: center;\n  justify-content: center;\n  cursor: pointer;\n  opacity: 0.55;\n  transition: opacity 0.2s, background-color 0.2s;\n  margin: -0.15rem -0.25rem 0 0;\n}\n.toast__close:hover {\n  opacity: 1;\n  background: rgba(15, 23, 42, 0.06);\n}\n.toast__close-icon {\n  width: 1rem;\n  height: 1rem;\n}\n.toast--success {\n  background:\n    linear-gradient(\n      135deg,\n      #f0fdf4 0%,\n      #ecfdf5 100%);\n  border-color: #86efac;\n  color: #14532d;\n}\n.toast--success .toast__icon-wrap {\n  background: #dcfce7;\n  color: #16a34a;\n}\n.toast--error {\n  background:\n    linear-gradient(\n      135deg,\n      #fef2f2 0%,\n      #fff1f2 100%);\n  border-color: #fca5a5;\n  color: #7f1d1d;\n}\n.toast--error .toast__icon-wrap {\n  background: #fee2e2;\n  color: #dc2626;\n}\n.toast--warning {\n  background:\n    linear-gradient(\n      135deg,\n      #fffbeb 0%,\n      #fefce8 100%);\n  border-color: #fde047;\n  color: #713f12;\n}\n.toast--warning .toast__icon-wrap {\n  background: #fef9c3;\n  color: #ca8a04;\n}\n.toast--info {\n  background:\n    linear-gradient(\n      135deg,\n      #eff6ff 0%,\n      #f0f9ff 100%);\n  border-color: #93c5fd;\n  color: #1e3a8a;\n}\n.toast--info .toast__icon-wrap {\n  background: #dbeafe;\n  color: #2563eb;\n}\n.toast--highlight {\n  background:\n    linear-gradient(\n      135deg,\n      #f5f3ff 0%,\n      #faf5ff 100%);\n  border-color: #c4b5fd;\n  color: #4c1d95;\n}\n.toast--highlight .toast__icon-wrap {\n  background: #ede9fe;\n  color: #7c3aed;\n}\n/*# sourceMappingURL=custom-snackbar.component.css.map */\n"] }]
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(CustomSnackbarComponent, { className: "CustomSnackbarComponent", filePath: "src/app/core/components/custom-snackbar/custom-snackbar.component.ts", lineNumber: 22 });
})();
...
var ToastService = class _ToastService {
  ...
  static \u0275fac = function ToastService_Factory(__ngFactoryType__) {
    return new (__ngFactoryType__ || _ToastService)(\u0275\u0275inject(MatSnackBar));
  };
...
//# sourceMappingURL=chunk-OP2NIPTP.js.map
