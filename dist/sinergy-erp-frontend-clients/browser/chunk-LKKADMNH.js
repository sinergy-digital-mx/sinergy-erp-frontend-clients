...
} from "./chunk-HFX4HJCD.js";
import {
  PurchaseOrderService
} from "./chunk-LGI3IR5X.js";
import {
...
var OrderHeaderComponent = class _OrderHeaderComponent {
  ...
  canEdit = false;
  displayStatus() {
    return this.order.general_status ?? this.order.status;
  }
  canDelete = false;
  ...
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _OrderHeaderComponent, selectors: [["app-order-header"]], inputs: { order: "order", canEdit: "canEdit", canDelete: "canDelete", canChangeStatus: "canChangeStatus" }, outputs: { edit: "edit", changeStatus: "changeStatus", cancel: "cancel", delete: "delete" }, decls: 49, vars: 19, consts: [["role", "region", "aria-label", "Encabezado de orden de compra", 1, "order-header"], [1, "order-header__info"], [1, "order-header__row"], [1, "order-header__field"], [1, "label"], [1, "value"], ["role", "status", 3, "ngClass"], [1, "order-header__field", "order-header__field--full"], ["class", "order-header__row", 4, "ngIf"], ["role", "group", "aria-label", "Acciones de orden", 1, "order-header__actions"], ["type", "button", "class", "btn btn--primary", "aria-label", "Editar orden de compra", 3, "click", 4, "ngIf"], ["type", "button", "class", "btn btn--success", "aria-label", "Cambiar estado de orden", 3, "click", 4, "ngIf"], ["type", "button", "class", "btn btn--warning", "aria-label", "Cancelar orden de compra", 3, "click", 4, "ngIf"], ["type", "button", "class", "btn btn--danger", "aria-label", "Eliminar orden de compra", 3, "click", 4, "ngIf"], [1, "value", "value--warning"], ["type", "button", "aria-label", "Editar orden de compra", 1, "btn", "btn--primary", 3, "click"], ["type", "button", "aria-label", "Cambiar estado de orden", 1, "btn", "btn--success", 3, "click"], ["type", "button", "aria-label", "Cancelar orden de compra", 1, "btn", "btn--warning", 3, "click"], ["type", "button", "aria-label", "Eliminar orden de compra", 1, "btn", "btn--danger", 3, "click"]], template: function OrderHeaderComponent_Template(rf, ctx) {
    ...
    if (rf & 2) {
      ...
      \u0275\u0275advance(4);
      \u0275\u0275property("ngClass", ctx.getStatusClass(ctx.displayStatus()));
      \u0275\u0275advance();
      \u0275\u0275textInterpolate1(" ", ctx.displayStatus(), " ");
      \u0275\u0275advance(6);
  ...
  <div class="order-header__info">
    ...
    <div class="order-header__row">
      <div class="order-header__field">
        ...
        <span class="value">{{ order.vendor?.name || 'N/A' }}</span>
      </div>
      <div class="order-header__field">
        <span class="label">ALMAC\xC9N:</span>
        <span class="value">{{ order.warehouse?.name || 'N/A' }}</span>
      </div>
    </div>

    <div class="order-header__row">
      <div class="order-header__field">
        <span class="label">FECHA TENTATIVA DE RECEPCI\xD3N:</span>
        <span class="value">{{ order.tentative_receipt_date | date: 'dd/MM/yyyy' }}</span>
      </div>
      <div class="order-header__field">
        <span class="label">FECHA DE CREACI\xD3N:</span>
        <span class="value">{{ order.created_at | date: 'dd/MM/yyyy HH:mm' }}</span>
      </div>
    </div>

    <div class="order-header__row">
      <div class="order-header__field order-header__field--full">
        <span class="label">PROP\xD3SITO:</span>
        <span class="value">{{ order.purpose }}</span>
      </div>
    </div>

    <div *ngIf="order.cancellation_reason" class="order-header__row">
      <div class="order-header__field order-header__field--full">
        <span class="label">RAZ\xD3N DE CANCELACI\xD3N:</span>
        <span class="value value--warning">{{ order.cancellation_reason }}</span>
      </div>
    </div>
  </div>

  <!-- Action Buttons Section -->
  <div class="order-header__actions" role="group" aria-label="Acciones de orden">
    <button
    ...
    <button
      *ngIf="shouldShowChangeStatusButton()"
      type="button"
...
function LineItemsTableComponent_div_2_tr_22_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate(ctx_r1.formatCurrency(item_r1.unit_price ?? item_r1.unit_total ?? 0));
    \u0275\u0275advance(2);
...
function LineItemsTableComponent_table_3_tr_20_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate(ctx_r1.formatCurrency(item_r3.unit_price ?? item_r3.unit_total ?? 0));
    \u0275\u0275advance(2);
...
function LineItemsTableComponent_div_6_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance(5);
    \u0275\u0275textInterpolate(ctx_r1.formatCurrency(item_r4.unit_price ?? item_r4.unit_total ?? 0));
    \u0275\u0275advance(5);
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && setClassMetadata(LineItemsTableComponent, [{
    type: Component,
    args: [{ selector: "app-line-items-table", standalone: true, imports: [CommonModule, ScrollingModule], changeDetection: ChangeDetectionStrategy.OnPush, template: `<div class="line-items-table-container">
  <!-- Desktop/Tablet Table View -->
  <div class="table-view" role="region" aria-label="Tabla de l\xEDneas de productos">
    <!-- Virtual Scrolling for > 50 items -->
    <div *ngIf="useVirtualScroll" class="virtual-scroll-wrapper">
      <cdk-virtual-scroll-viewport itemSize="50" class="line-items-viewport">
        <table class="line-items-table" role="table">
          <thead>
            <tr role="row">
              <th role="columnheader" scope="col">PRODUCTO</th>
              <th role="columnheader" scope="col">UOM</th>
              <th role="columnheader" scope="col" class="text-right">CANTIDAD</th>
              <th role="columnheader" scope="col" class="text-right">COSTO UNIT.</th>
              <th role="columnheader" scope="col" class="text-right">SUBTOTAL</th>
              <th role="columnheader" scope="col" class="text-right">IVA</th>
              <th role="columnheader" scope="col" class="text-right">IEPS</th>
              <th role="columnheader" scope="col" class="text-right">TOTAL</th>
            </tr>
          </thead>
          <tbody>
            <tr
              *cdkVirtualFor="let item of lineItems; trackBy: trackByLineItem"
              role="row"
              class="line-item-row"
            >
              <td role="cell" data-label="PRODUCTO">{{ item.product?.name || 'N/A' }}</td>
              <td role="cell" data-label="UOM">{{ item.uom?.code || item.uom?.name || 'N/A' }}</td>
              <td role="cell" data-label="CANTIDAD" class="text-right">{{ item.quantity }}</td>
              <td role="cell" data-label="COSTO UNIT." class="text-right">{{ formatCurrency(item.unit_price ?? item.unit_total ?? 0) }}</td>
              <td role="cell" data-label="SUBTOTAL" class="text-right">{{ formatCurrency(item.subtotal) }}</td>
              <td role="cell" data-label="IVA" class="text-right">{{ formatCurrency(item.iva_amount) }}</td>
              <td role="cell" data-label="IEPS" class="text-right">{{ formatCurrency(item.ieps_amount) }}</td>
              <td role="cell" data-label="TOTAL" class="text-right font-weight-bold">{{ formatCurrency(item.line_total) }}</td>
            </tr>
          </tbody>
        </table>
    ...
    <!-- Regular Table for <= 50 items -->
    <table *ngIf="!useVirtualScroll" class="line-items-table" role="table">
      <thead>
        <tr role="row">
          <th role="columnheader" scope="col">PRODUCTO</th>
          <th role="columnheader" scope="col">UOM</th>
      ...
      <tbody>
        <tr
          *ngFor="let item of lineItems; trackBy: trackByLineItem"
          role="row"
          class="line-item-row"
        >
          <td role="cell" data-label="PRODUCTO">{{ item.product?.name || 'N/A' }}</td>
        ...
        <tr *ngIf="lineItems.length === 0" role="row">
          <td colspan="8" class="empty-state" role="cell">
            <div class="empty-message">
              <p>No hay l\xEDneas de productos</p>
            </div>
          </td>
        </tr>
      </tbody>
      <!-- Totals Row -->
      <tfoot *ngIf="lineItems.length > 0">
        <tr role="row" class="totals-row">
          <td colspan="4" class="text-right font-weight-bold">TOTALES:</td>
          <td class="text-right font-weight-bold">{{ formatCurrency(totals.total_subtotal) }}</td>
          <td class="text-right font-weight-bold">{{ formatCurrency(totals.total_iva) }}</td>
          <td class="text-right font-weight-bold">{{ formatCurrency(totals.total_ieps) }}</td>
          <td class="text-right font-weight-bold total-grand">{{ formatCurrency(totals.grand_total) }}</td>
        </tr>
      </tfoot>
    </table>

    <!-- Totals Row for Virtual Scroll (outside viewport) -->
    <div *ngIf="useVirtualScroll && lineItems.length > 0" class="totals-summary">
      <div class="totals-grid">
        <div class="totals-item">
          <span class="totals-label">SUBTOTAL:</span>
          <span class="totals-value">{{ formatCurrency(totals.total_subtotal) }}</span>
        </div>
        <div class="totals-item">
          <span class="totals-label">IVA:</span>
          <span class="totals-value">{{ formatCurrency(totals.total_iva) }}</span>
        </div>
        <div class="totals-item">
          <span class="totals-label">IEPS:</span>
          <span class="totals-value">{{ formatCurrency(totals.total_ieps) }}</span>
        </div>
        <div class="totals-item totals-item--grand">
          <span class="totals-label">TOTAL:</span>
          <span class="totals-value">{{ formatCurrency(totals.grand_total) }}</span>
        </div>
      </div>
    </div>
  </div>
  ...
  <!-- Mobile Card View -->
  <div class="card-view" role="list" aria-label="Lista de l\xEDneas de productos">
    <div
      *ngFor="let item of lineItems; trackBy: trackByLineItem"
    ...
    >
      <div class="line-item-card__header">
        <div class="line-item-card__product">
          <span class="label">PRODUCTO:</span>
          <span class="value">{{ item.product?.name || 'N/A' }}</span>
        </div>
      </div>
      
      <div class="line-item-card__body">
        <div class="line-item-card__row">
          <span class="label">UOM:</span>
          <span class="value">{{ item.uom?.code || item.uom?.name || 'N/A' }}</span>
        </div>
        <div class="line-item-card__row">
        ...
        <div class="line-item-card__row">
          ...
          <span class="value">{{ formatCurrency(item.unit_price ?? item.unit_total ?? 0) }}</span>
        </div>
        <div class="line-item-card__row">
        ...
        <div class="line-item-card__row">
          ...
          <span class="value">{{ formatCurrency(item.iva_amount) }}</span>
        </div>
        <div class="line-item-card__row">
          <span class="label">IEPS:</span>
          <span class="value">{{ formatCurrency(item.ieps_amount) }}</span>
        </div>
        <div class="line-item-card__row line-item-card__row--total">
          <span class="label">TOTAL:</span>
          <span class="value">{{ formatCurrency(item.line_total) }}</span>
        </div>
      </div>
    </div>

    <div *ngIf="lineItems.length === 0" class="empty-state" role="status">
      <p>No hay l\xEDneas de productos</p>
    </div>

    <!-- Mobile Totals Summary -->
    <div *ngIf="lineItems.length > 0" class="mobile-totals-summary">
      <div class="mobile-totals-row">
        <span class="label">SUBTOTAL:</span>
        <span class="value">{{ formatCurrency(totals.total_subtotal) }}</span>
      </div>
      <div class="mobile-totals-row">
        <span class="label">IVA:</span>
        <span class="value">{{ formatCurrency(totals.total_iva) }}</span>
      </div>
      <div class="mobile-totals-row">
        <span class="label">IEPS:</span>
        <span class="value">{{ formatCurrency(totals.total_ieps) }}</span>
      </div>
      <div class="mobile-totals-row mobile-totals-row--grand">
        <span class="label">TOTAL:</span>
        <span class="value">{{ formatCurrency(totals.grand_total) }}</span>
      </div>
    </div>
  </div>
</div>
...
function PaymentsListComponent_table_6_tr_14_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate(ctx_r1.formatCurrency(payment_r3.amount, payment_r3.currency));
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate(payment_r3.payment_method);
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate(payment_r3.reference_number || payment_r3.reference || "N/A");
    \u0275\u0275advance(2);
...
function PaymentsListComponent_div_9_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate1(" ", ctx_r1.formatCurrency(payment_r4.amount, payment_r4.currency), " ");
    \u0275\u0275advance(6);
    \u0275\u0275textInterpolate(payment_r4.payment_method);
    \u0275\u0275advance(5);
    \u0275\u0275textInterpolate(payment_r4.reference_number || payment_r4.reference || "N/A");
    \u0275\u0275advance();
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && setClassMetadata(PaymentsListComponent, [{
    type: Component,
    args: [{ selector: "app-payments-list", standalone: true, imports: [CommonModule], changeDetection: ChangeDetectionStrategy.OnPush, template: `<div class="payments-list-container">
  <!-- Header with Add Payment Button -->
  <div class="payments-list-header">
    <h3 class="payments-list-title">Pagos Registrados</h3>
    <button
      *ngIf="canAddPayment"
      type="button"
  ...
  <!-- Desktop/Tablet Table View -->
  <div class="table-view" role="region" aria-label="Tabla de pagos">
    <table *ngIf="payments.length > 0" class="payments-table" role="table">
      <thead>
        <tr role="row">
          <th role="columnheader" scope="col">FECHA</th>
          <th role="columnheader" scope="col" class="text-right">MONTO</th>
          <th role="columnheader" scope="col">M\xC9TODO</th>
          <th role="columnheader" scope="col">REFERENCIA</th>
          <th role="columnheader" scope="col">NOTAS</th>
        </tr>
      </thead>
      <tbody>
        <tr
          *ngFor="let payment of payments; trackBy: trackByPayment"
          role="row"
          class="payment-row"
        >
          <td role="cell" data-label="FECHA">{{ formatDate(payment.payment_date) }}</td>
          <td role="cell" data-label="MONTO" class="text-right font-weight-bold">{{ formatCurrency(payment.amount, payment.currency) }}</td>
          <td role="cell" data-label="M\xC9TODO">{{ payment.payment_method }}</td>
          <td role="cell" data-label="REFERENCIA">{{ payment.reference_number || payment.reference || 'N/A' }}</td>
          <td role="cell" data-label="NOTAS">{{ payment.notes || '-' }}</td>
        </tr>
      </tbody>
    </table>

    <!-- Empty State -->
    <div *ngIf="payments.length === 0" class="empty-state" role="status">
      <div class="empty-icon">\u{1F4B3}</div>
      <p class="empty-message">No hay pagos registrados</p>
      <p class="empty-hint" *ngIf="canAddPayment">Haz clic en "Registrar Pago" para agregar el primer pago</p>
    </div>
  </div>

  <!-- Mobile Card View -->
  <div class="card-view" role="list" aria-label="Lista de pagos">
    <div
      *ngFor="let payment of payments; trackBy: trackByPayment"
      class="payment-card"
      role="listitem"
    >
      ...
      <div class="payment-card__body">
        <div class="payment-card__row">
          <span class="label">M\xC9TODO:</span>
          <span class="value">{{ payment.payment_method }}</span>
        </div>
        <div class="payment-card__row">
          <span class="label">REFERENCIA:</span>
          <span class="value">{{ payment.reference_number || payment.reference || 'N/A' }}</span>
        </div>
        <div class="payment-card__row" *ngIf="payment.notes">
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(PaymentsListComponent, { className: "PaymentsListComponent", filePath: "src/app/features/purchase-orders/components/payments-list/payments-list.component.ts", lineNumber: 19 });
})();
...
function PurchaseOrderDetailComponent_Conditional_3_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance(2);
    \u0275\u0275property("payments", ctx_r1.order().payments || \u0275\u0275pureFunction0(10, _c02))("canAddPayment", ctx_r1.canAddPayment())("defaultCurrency", ((tmp_10_0 = ctx_r1.order().payments_summary) == null ? null : tmp_10_0.currency) || ctx_r1.order().payment_currency || "MXN");
  }
}
var PurchaseOrderDetailComponent = class _PurchaseOrderDetailComponent {
  ...
  registerPayment() {
    ...
    const totalAmount = order.payments_summary ? Math.round((Number(order.payments_summary.amount_paid ?? 0) + Number(order.payments_summary.amount_pending ?? 0)) * 100) / 100 : Number(order.grand_total ?? 0);
  ...
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _PurchaseOrderDetailComponent, selectors: [["app-purchase-order-detail"]], decls: 4, vars: 3, consts: [[1, "purchase-order-detail"], [1, "loading"], [1, "error"], [1, "order-content"], [3, "click"], [1, "header"], [1, "btn-back", 3, "click"], [3, "edit", "changeStatus", "cancel", "delete", "order", "canEdit", "canDelete", "canChangeStatus"], [1, "section"], [3, "lineItems", "editable"], [3, "addPayment", "payments", "canAddPayment", "defaultCurrency"]], template: function PurchaseOrderDetailComponent_Template(rf, ctx) {
    if (rf & 1) {
      ...
      \u0275\u0275conditionalCreate(3, PurchaseOrderDetailComponent_Conditional_3_Template, 13, 11, "div", 3);
      \u0275\u0275elementEnd();
    }
    if (rf & 2) {
      \u0275\u0275advance();
    ...
    <div class="order-content">
      ...
      <div class="section">
        <app-payments-list
          ...
          [defaultCurrency]="order()!.payments_summary?.currency || order()!.payment_currency || 'MXN'"
...
//# sourceMappingURL=chunk-LKKADMNH.js.map
