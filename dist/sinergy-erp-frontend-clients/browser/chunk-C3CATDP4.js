...
// src/app/features/contracts/models/contract.model.ts
...
var DownpaymentPaymentService = class _DownpaymentPaymentService {
  ...
  updateTarget(contractId, data) {
    return this.http.put(`${this.api}/tenant/contracts/${contractId}/downpayment-payments/target`, data);
  }
  cancelPayment(contractId, paymentId) {
...
// src/app/features/contracts/models/hoa-payment.model.ts
function getSuggestedHoaFirstPaymentDate(payments) {
...
function getSuggestedHoaMonthlyAmount(payments) {
  const active = payments.filter((p) => p.status !== "cancelado");
  if (!active.length)
    return null;
...
function GenerateHoaDialogComponent_p_14_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "p", 24);
    \u0275\u0275text(1, " Sugerencia: el mes siguiente al \xFAltimo vencimiento existente es ");
    \u0275\u0275elementStart(2, "strong");
    \u0275\u0275text(3);
    \u0275\u0275elementEnd();
    \u0275\u0275text(4, " (puedes cambiarlo). ");
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    const ctx_r0 = \u0275\u0275nextContext();
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate(ctx_r0.data.suggestedFirstPaymentDate);
  }
}
function GenerateHoaDialogComponent_p_20_Template(rf, ctx) {
  if (rf & 1) {
...
function GenerateHoaDialogComponent_p_25_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "p", 25);
...
function GenerateHoaDialogComponent_p_30_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "p", 25);
...
function GenerateHoaDialogComponent_p_38_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "p", 25);
...
var GenerateHoaDialogComponent = class _GenerateHoaDialogComponent {
  ...
  constructor(dialogRef, data, fb) {
    ...
    this.data = data;
    this.fb = fb;
    const defaultFirstDate = this.data.suggestedFirstPaymentDate || this.data.contract.first_payment_date || this.data.contract.contract_date;
    this.form = this.fb.group({
  ...
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _GenerateHoaDialogComponent, selectors: [["app-generate-hoa-dialog"]], decls: 44, vars: 17, consts: [[1, "dialog-overlay"], [1, "dialog-container"], [1, "dialog-header"], [1, "text-xl", "font-semibold", "text-gray-900"], ["type", "button", 1, "text-gray-400", "hover:text-gray-600", "transition-colors", 3, "click"], [3, "ngSubmit", "formGroup"], [1, "dialog-body"], [1, "text-sm", "text-gray-600", "mb-4"], ["class", "text-xs text-blue-700 bg-blue-50 border border-blue-200 rounded-lg px-3 py-2 mb-4", 4, "ngIf"], [1, "space-y-4"], ["for", "first_payment_date", 1, "block", "text-sm", "font-medium", "text-gray-700", "mb-1"], ["id", "first_payment_date", "type", "date", "formControlName", "first_payment_date", 1, "w-full", "rounded-lg", "border", "border-gray-300", "px-3", "py-2", "text-sm", "focus:border-blue-500", "focus:outline-none"], ["class", "mt-1 text-xs text-red-600", 4, "ngIf"], ["for", "payments_count", 1, "block", "text-sm", "font-medium", "text-gray-700", "mb-1"], ["id", "payments_count", "type", "number", "min", "1", "step", "1", "formControlName", "payments_count", 1, "w-full", "rounded-lg", "border", "border-gray-300", "px-3", "py-2", "text-sm", "focus:border-blue-500", "focus:outline-none"], ["for", "payment_day", 1, "block", "text-sm", "font-medium", "text-gray-700", "mb-1"], ["id", "payment_day", "type", "number", "min", "1", "max", "31", "step", "1", "formControlName", "payment_day", 1, "w-full", "rounded-lg", "border", "border-gray-300", "px-3", "py-2", "text-sm", "focus:border-blue-500", "focus:outline-none"], ["for", "monthly_amount", 1, "block", "text-sm", "font-medium", "text-gray-700", "mb-1"], [1, "relative"], [1, "absolute", "left-3", "top-1/2", "transform", "-translate-y-1/2", "text-gray-500", "text-sm"], ["id", "monthly_amount", "type", "number", "step", "0.01", "min", "0.01", "formControlName", "monthly_amount", "placeholder", "Ej. 1500.00", 1, "w-full", "rounded-lg", "border", "border-gray-300", "pl-7", "pr-3", "py-2", "text-sm", "focus:border-blue-500", "focus:outline-none"], [1, "dialog-footer"], ["type", "button", 1, "px-4", "py-2", "text-sm", "font-medium", "text-gray-700", "bg-white", "border", "border-gray-300", "rounded-lg", "hover:bg-gray-50", "transition-colors", 3, "click"], ["type", "submit", 1, "px-4", "py-2", "text-sm", "font-medium", "text-white", "bg-green-600", "rounded-lg", "hover:bg-green-700", "transition-colors", "disabled:opacity-50", "disabled:cursor-not-allowed", 3, "disabled"], [1, "text-xs", "text-blue-700", "bg-blue-50", "border", "border-blue-200", "rounded-lg", "px-3", "py-2", "mb-4"], [1, "mt-1", "text-xs", "text-red-600"]], template: function GenerateHoaDialogComponent_Template(rf, ctx) {
    if (rf & 1) {
      ...
      \u0275\u0275text(10, " Genera cuotas mensuales de HOA para el contrato ");
      \u0275\u0275elementStart(11, "strong");
      \u0275\u0275text(12);
      \u0275\u0275elementEnd();
      \u0275\u0275text(13, ". Puedes ejecutar esta acci\xF3n varias veces para agregar m\xE1s meses. ");
      \u0275\u0275elementEnd();
      \u0275\u0275template(14, GenerateHoaDialogComponent_p_14_Template, 5, 1, "p", 8);
      \u0275\u0275elementStart(15, "div", 9)(16, "div")(17, "label", 10);
      \u0275\u0275text(18, " Fecha del primer mes ");
      \u0275\u0275elementEnd();
      \u0275\u0275element(19, "input", 11);
      \u0275\u0275template(20, GenerateHoaDialogComponent_p_20_Template, 2, 0, "p", 12);
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(21, "div")(22, "label", 13);
      \u0275\u0275text(23, " Cantidad de meses ");
      \u0275\u0275elementEnd();
      \u0275\u0275element(24, "input", 14);
      \u0275\u0275template(25, GenerateHoaDialogComponent_p_25_Template, 2, 0, "p", 12);
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(26, "div")(27, "label", 15);
      \u0275\u0275text(28, " D\xEDa de vencimiento (default 5) ");
      \u0275\u0275elementEnd();
      \u0275\u0275element(29, "input", 16);
      \u0275\u0275template(30, GenerateHoaDialogComponent_p_30_Template, 2, 0, "p", 12);
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(31, "div")(32, "label", 17);
      \u0275\u0275text(33, " Monto Mensual ");
      \u0275\u0275elementEnd();
      ...
      \u0275\u0275elementEnd();
      \u0275\u0275template(38, GenerateHoaDialogComponent_p_38_Template, 2, 0, "p", 12);
      \u0275\u0275elementEnd()()();
      \u0275\u0275elementStart(39, "div", 21)(40, "button", 22);
      \u0275\u0275listener("click", function GenerateHoaDialogComponent_Template_button_click_40_listener() {
        return ctx.closeDialog();
      });
      \u0275\u0275text(41, " Cancelar ");
      \u0275\u0275elementEnd();
    ...
    if (rf & 2) {
      ...
      \u0275\u0275advance(2);
      \u0275\u0275property("ngIf", ctx.data.suggestedFirstPaymentDate);
      \u0275\u0275advance(5);
      \u0275\u0275classProp("border-red-500", ((tmp_3_0 = ctx.form.get("first_payment_date")) == null ? null : tmp_3_0.invalid) && ((tmp_3_0 = ctx.form.get("first_payment_date")) == null ? null : tmp_3_0.touched));
      \u0275\u0275advance();
      \u0275\u0275property("ngIf", ((tmp_4_0 = ctx.form.get("first_payment_date")) == null ? null : tmp_4_0.invalid) && ((tmp_4_0 = ctx.form.get("first_payment_date")) == null ? null : tmp_4_0.touched));
      \u0275\u0275advance(4);
      \u0275\u0275classProp("border-red-500", ((tmp_5_0 = ctx.form.get("payments_count")) == null ? null : tmp_5_0.invalid) && ((tmp_5_0 = ctx.form.get("payments_count")) == null ? null : tmp_5_0.touched));
      \u0275\u0275advance();
      \u0275\u0275property("ngIf", ((tmp_6_0 = ctx.form.get("payments_count")) == null ? null : tmp_6_0.invalid) && ((tmp_6_0 = ctx.form.get("payments_count")) == null ? null : tmp_6_0.touched));
      \u0275\u0275advance(4);
      \u0275\u0275classProp("border-red-500", ((tmp_7_0 = ctx.form.get("payment_day")) == null ? null : tmp_7_0.invalid) && ((tmp_7_0 = ctx.form.get("payment_day")) == null ? null : tmp_7_0.touched));
      \u0275\u0275advance();
      \u0275\u0275property("ngIf", ((tmp_8_0 = ctx.form.get("payment_day")) == null ? null : tmp_8_0.invalid) && ((tmp_8_0 = ctx.form.get("payment_day")) == null ? null : tmp_8_0.touched));
      \u0275\u0275advance(7);
      \u0275\u0275classProp("border-red-500", ((tmp_9_0 = ctx.form.get("monthly_amount")) == null ? null : tmp_9_0.invalid) && ((tmp_9_0 = ctx.form.get("monthly_amount")) == null ? null : tmp_9_0.touched));
      \u0275\u0275advance();
      \u0275\u0275property("ngIf", ((tmp_10_0 = ctx.form.get("monthly_amount")) == null ? null : tmp_10_0.invalid) && ((tmp_10_0 = ctx.form.get("monthly_amount")) == null ? null : tmp_10_0.touched));
      \u0275\u0275advance(4);
        ...
        <form [formGroup]="form" (ngSubmit)="onSubmit()">
          <div class="dialog-body">
            <p class="text-sm text-gray-600 mb-4">
              ...
              Puedes ejecutar esta acci\xF3n varias veces para agregar m\xE1s meses.
            </p>
            <p *ngIf="data.suggestedFirstPaymentDate" class="text-xs text-blue-700 bg-blue-50 border border-blue-200 rounded-lg px-3 py-2 mb-4">
              Sugerencia: el mes siguiente al \xFAltimo vencimiento existente es
            ...
            <div class="space-y-4">
              ...
              <div>
                <label for="payment_day" class="block text-sm font-medium text-gray-700 mb-1">
                  D\xEDa de vencimiento (default 5)
                </label>
                <input
                  id="payment_day"
                  type="number"
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(GenerateHoaDialogComponent, { className: "GenerateHoaDialogComponent", filePath: "src/app/features/contracts/components/generate-hoa-dialog/generate-hoa-dialog.component.ts", lineNumber: 186 });
})();
...
var HoaPaymentService = class _HoaPaymentService {
  ...
  getPayment(contractId, paymentId) {
    return this.http.get(`${this.api}/tenant/contracts/${contractId}/hoa-payments/${paymentId}`);
  }
...
var EditHoaPaymentModalComponent = class _EditHoaPaymentModalComponent {
  ...
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _EditHoaPaymentModalComponent, selectors: [["app-edit-hoa-payment-modal"]], features: [\u0275\u0275ProvidersFeature([DatePipe])], decls: 32, vars: 16, consts: [[1, "dialog-container"], [1, "dialog-header"], [1, "dialog-title"], [1, "close-button", 3, "click"], [3, "img", "size"], [1, "dialog-content", 3, "formGroup"], [1, "mb-3", "p-2", "bg-blue-50", "rounded-lg", "border", "border-blue-200"], [1, "text-sm", "text-blue-900"], [1, "font-semibold"], [1, "space-y-4"], ["label", "Monto Pagado", "type", "number", 3, "form_control"], ["label", "Fecha de Vencimiento", "type", "date", 3, "form_control"], ["type", "date", 3, "label", "form_control"], [1, "block", "text-sm", "font-medium", "text-gray-700", "mb-1"], [3, "config"], ["formControlName", "notes", "rows", "3", "placeholder", "Notas adicionales sobre el pago HOA...", 1, "w-full", "px-3", "py-2", "border", "border-gray-300", "rounded-lg", "focus:ring-2", "focus:ring-blue-500", "focus:border-transparent"], [1, "dialog-footer"], ["text", "Cancelar", "custom_class", "btn_secondary", 3, "clicked"], ["text", "Guardar Cambios", "custom_class", "btn_primary", 3, "clicked", "loading"]], template: function EditHoaPaymentModalComponent_Template(rf, ctx) {
    if (rf & 1) {
      ...
      \u0275\u0275element(24, "app-select", 14);
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(25, "div")(26, "label", 13);
      \u0275\u0275text(27, "Notas");
      \u0275\u0275elementEnd();
      \u0275\u0275element(28, "textarea", 15);
      \u0275\u0275elementEnd()()();
      \u0275\u0275elementStart(29, "div", 16)(30, "app-button", 17);
      \u0275\u0275listener("clicked", function EditHoaPaymentModalComponent_Template_app_button_clicked_30_listener() {
        return ctx.close();
      });
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(31, "app-button", 18);
      \u0275\u0275listener("clicked", function EditHoaPaymentModalComponent_Template_app_button_clicked_31_listener() {
        return ctx.save();
      });
      \u0275\u0275elementEnd()()();
    }
    if (rf & 2) {
      ...
      \u0275\u0275textInterpolate1(" ", ctx.data.payment.status);
      \u0275\u0275advance(4);
      \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind2(16, 13, ctx.data.payment.due_date, "mediumDate"));
      \u0275\u0275advance(3);
      \u0275\u0275property("form_control", ctx.form.controls["amount_paid"]);
      \u0275\u0275advance();
      \u0275\u0275property("form_control", ctx.form.controls["due_date"]);
...
\r
      <app-input label="Fecha de Vencimiento" type="date" [form_control]="form.controls['due_date']"></app-input>\r
\r
      <app-input\r
        [label]="'Fecha de Pago' + (data.payment.status === 'pagado' ? ' *' : '')"\r
        type="date"\r
...
function ContractHoaPaymentsComponent_div_6_div_7_Template(rf, ctx) {
  if (rf & 1) {
    const _r4 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "div", 40)(1, "app-button", 9);
    \u0275\u0275listener("clicked", function ContractHoaPaymentsComponent_div_6_div_7_Template_app_button_clicked_1_listener() {
      \u0275\u0275restoreView(_r4);
      const ctx_r1 = \u0275\u0275nextContext(2);
      return \u0275\u0275resetView(ctx_r1.generatePayments());
    });
...
function ContractHoaPaymentsComponent_div_6_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275text(6);
    \u0275\u0275elementEnd();
    \u0275\u0275template(7, ContractHoaPaymentsComponent_div_6_div_7_Template, 2, 2, "div", 39);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext();
    ...
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate1(" ", ctx_r1.isContractCancelled ? "No se pueden generar pagos HOA en un contrato cancelado." : "Genera las cuotas HOA para registrar y controlar los cobros mensuales. Disponible en contratos activos y completados.", " ");
    \u0275\u0275advance();
    \u0275\u0275property("ngIf", ctx_r1.canGeneratePayments);
  }
}
function ContractHoaPaymentsComponent_div_7_tr_21_span_22_Template(rf, ctx) {
  if (rf & 1) {
...
function ContractHoaPaymentsComponent_div_7_tr_21_button_27_Template(rf, ctx) {
  if (rf & 1) {
    const _r5 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "button", 64);
    \u0275\u0275listener("click", function ContractHoaPaymentsComponent_div_7_tr_21_button_27_Template_button_click_0_listener() {
      \u0275\u0275restoreView(_r5);
...
function ContractHoaPaymentsComponent_div_7_tr_21_button_28_Template(rf, ctx) {
  if (rf & 1) {
    const _r7 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "button", 66);
    \u0275\u0275listener("click", function ContractHoaPaymentsComponent_div_7_tr_21_button_28_Template_button_click_0_listener() {
      \u0275\u0275restoreView(_r7);
      const payment_r6 = \u0275\u0275nextContext().$implicit;
      const ctx_r1 = \u0275\u0275nextContext(2);
  ...
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext(3);
    \u0275\u0275property("matTooltip", "Editar");
    \u0275\u0275advance();
    \u0275\u0275property("img", ctx_r1.Edit)("size", 16);
  }
}
function ContractHoaPaymentsComponent_div_7_tr_21_button_29_Template(rf, ctx) {
  if (rf & 1) {
    const _r8 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "button", 67);
    \u0275\u0275listener("click", function ContractHoaPaymentsComponent_div_7_tr_21_button_29_Template_button_click_0_listener() {
      \u0275\u0275restoreView(_r8);
      const payment_r6 = \u0275\u0275nextContext().$implicit;
      const ctx_r1 = \u0275\u0275nextContext(2);
  ...
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext(3);
    \u0275\u0275property("matTooltip", "Resetear");
    \u0275\u0275advance();
    \u0275\u0275property("img", ctx_r1.RotateCcw)("size", 16);
  }
}
function ContractHoaPaymentsComponent_div_7_tr_21_button_30_Template(rf, ctx) {
  if (rf & 1) {
    const _r9 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "button", 68);
    \u0275\u0275listener("click", function ContractHoaPaymentsComponent_div_7_tr_21_button_30_Template_button_click_0_listener() {
      \u0275\u0275restoreView(_r9);
      const payment_r6 = \u0275\u0275nextContext().$implicit;
      const ctx_r1 = \u0275\u0275nextContext(2);
  ...
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext(3);
    \u0275\u0275property("matTooltip", "Cancelar");
    \u0275\u0275advance();
    \u0275\u0275property("img", ctx_r1.X)("size", 16);
  }
}
function ContractHoaPaymentsComponent_div_7_tr_21_button_31_Template(rf, ctx) {
  if (rf & 1) {
    const _r10 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "button", 69);
    \u0275\u0275listener("click", function ContractHoaPaymentsComponent_div_7_tr_21_button_31_Template_button_click_0_listener() {
      \u0275\u0275restoreView(_r10);
      const payment_r6 = \u0275\u0275nextContext().$implicit;
      const ctx_r1 = \u0275\u0275nextContext(2);
  ...
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext(3);
    \u0275\u0275property("matTooltip", "Eliminar");
    \u0275\u0275advance();
    \u0275\u0275property("img", ctx_r1.Trash2)("size", 16);
  }
}
function ContractHoaPaymentsComponent_div_7_tr_21_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "tr", 47)(1, "td", 48);
    \u0275\u0275text(2);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(3, "td", 49)(4, "div", 50);
    \u0275\u0275text(5);
    \u0275\u0275elementEnd();
    ...
    \u0275\u0275pipe(17, "currency");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(18, "td", 53)(19, "div", 54)(20, "span");
    \u0275\u0275text(21);
    \u0275\u0275elementEnd();
    \u0275\u0275template(22, ContractHoaPaymentsComponent_div_7_tr_21_span_22_Template, 2, 0, "span", 55);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(23, "td", 56);
    \u0275\u0275text(24);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(25, "td", 53)(26, "div", 57);
    \u0275\u0275template(27, ContractHoaPaymentsComponent_div_7_tr_21_button_27_Template, 2, 3, "button", 58)(28, ContractHoaPaymentsComponent_div_7_tr_21_button_28_Template, 2, 3, "button", 59)(29, ContractHoaPaymentsComponent_div_7_tr_21_button_29_Template, 2, 3, "button", 60)(30, ContractHoaPaymentsComponent_div_7_tr_21_button_30_Template, 2, 3, "button", 61)(31, ContractHoaPaymentsComponent_div_7_tr_21_button_31_Template, 2, 3, "button", 62);
    \u0275\u0275elementEnd()()();
  }
  if (rf & 2) {
    ...
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate(ctx_r1.getPaymentMonthLabel(payment_r6));
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate(\u0275\u0275pipeBind2(8, 24, payment_r6.due_date, "mediumDate"));
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate(\u0275\u0275pipeBind2(11, 27, payment_r6.amount, ctx_r1.currency));
    \u0275\u0275advance(2);
    \u0275\u0275classProp("text-blue-600", payment_r6.status === "parcial")("font-medium", payment_r6.status === "parcial");
    \u0275\u0275advance();
    \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind2(14, 30, payment_r6.amount_paid, ctx_r1.currency), " ");
    \u0275\u0275advance(2);
    \u0275\u0275classProp("text-orange-600", payment_r6.status === "parcial")("font-medium", payment_r6.status === "parcial");
    \u0275\u0275advance();
    \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind2(17, 33, payment_r6.amount_pending, ctx_r1.currency), " ");
    \u0275\u0275advance(4);
    \u0275\u0275classMap(ctx_r1.getStatusClass(payment_r6.status));
    \u0275\u0275advance();
    \u0275\u0275textInterpolate1(" ", ctx_r1.getStatusLabel(payment_r6.status), " ");
    \u0275\u0275advance();
    \u0275\u0275property("ngIf", payment_r6.is_overdue);
    \u0275\u0275advance(2);
    ...
    \u0275\u0275advance();
    \u0275\u0275property("ngIf", ctx_r1.canCancelPayment(payment_r6));
    \u0275\u0275advance();
    \u0275\u0275property("ngIf", ctx_r1.canDeletePayment(payment_r6));
  }
}
function ContractHoaPaymentsComponent_div_7_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275text(17, "M\xE9todo");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(18, "th", 44);
    \u0275\u0275text(19, "Acciones");
    \u0275\u0275elementEnd()()();
    \u0275\u0275elementStart(20, "tbody", 45);
    \u0275\u0275template(21, ContractHoaPaymentsComponent_div_7_tr_21_Template, 32, 36, "tr", 46);
    \u0275\u0275elementEnd()()();
  }
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext();
...
function ContractHoaPaymentsComponent_div_8_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275elementStart(0, "div", 70)(1, "div", 51);
    \u0275\u0275text(2);
    \u0275\u0275elementEnd();
...
var ContractHoaPaymentsComponent = class _ContractHoaPaymentsComponent {
  ...
  generatePayments() {
    if (!this.contract || !this.canGeneratePayments)
      return;
      ...
      this.hoaPaymentService.generatePayments(this.contractId, {
        ...
        next: (created) => {
          ...
          this.interceptorService.openSnackbar({
            type: "success",
            title: "\xC9xito",
            message: count > 0 ? `${count} cuota${count === 1 ? "" : "s"} HOA generada${count === 1 ? "" : "s"} correctamente` : "Pagos HOA generados correctamente"
          });
        },
        error: (err) => {
          this.generating.set(false);
  ...
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _ContractHoaPaymentsComponent, selectors: [["app-contract-hoa-payments"]], inputs: { contractId: "contractId", contract: "contract", currency: "currency", contractStatus: "contractStatus" }, outputs: { dataChanged: "dataChanged" }, decls: 9, vars: 7, consts: [[1, "payments-container"], [1, "flex", "items-center", "justify-end", "mb-2", "gap-2"], ["text", "Generar cuotas HOA", "custom_class", "btn_primary", "size", "sm", 3, "icon", "loading", "clicked", 4, "ngIf"], ["text", "Marcar Vencidos", "custom_class", "btn_secondary", "size", "sm", 3, "clicked", 4, "ngIf"], ["class", "grid grid-cols-5 gap-4 mb-6 w-full", 4, "ngIf"], ["class", "text-center py-8", 4, "ngIf"], ["class", "empty-state", 4, "ngIf"], ["class", "overflow-x-auto", 4, "ngIf"], ["class", "payments-pagination", 4, "ngIf"], ["text", "Generar cuotas HOA", "custom_class", "btn_primary", "size", "sm", 3, "clicked", "icon", "loading"], ["text", "Marcar Vencidos", "custom_class", "btn_secondary", "size", "sm", 3, "clicked"], [1, "grid", "grid-cols-5", "gap-4", "mb-6", "w-full"], [1, "bg-gray-50", "p-4", "rounded-lg", "border", "border-gray-200"], [1, "text-sm", "font-medium", "text-gray-600"], [1, "text-2xl", "font-bold", "text-gray-900", "mt-1"], [1, "text-sm", "font-medium", "text-gray-700", "mt-2"], [1, "bg-green-50", "p-4", "rounded-lg", "border", "border-green-200"], [1, "text-sm", "font-medium", "text-green-700"], [1, "text-2xl", "font-bold", "text-green-800", "mt-1"], [1, "text-sm", "font-medium", "text-green-700", "mt-2"], [1, "bg-blue-50", "p-4", "rounded-lg", "border", "border-blue-200"], [1, "text-sm", "font-medium", "text-blue-700"], [1, "text-2xl", "font-bold", "text-blue-800", "mt-1"], ["class", "text-xs text-blue-700 mt-2", 4, "ngIf"], [1, "bg-yellow-50", "p-4", "rounded-lg", "border", "border-yellow-200"], [1, "text-sm", "font-medium", "text-yellow-700"], [1, "text-2xl", "font-bold", "text-yellow-800", "mt-1"], [1, "text-sm", "font-medium", "text-yellow-700", "mt-2"], [1, "bg-red-50", "p-4", "rounded-lg", "border", "border-red-200"], [1, "text-sm", "font-medium", "text-red-700"], [1, "text-2xl", "font-bold", "text-red-800", "mt-1"], [1, "text-xs", "text-red-700", "mt-2"], [1, "text-xs", "text-blue-700", "mt-2"], [1, "text-center", "py-8"], [1, "text-sm", "text-gray-500"], [1, "empty-state"], [1, "empty-state__icon"], [1, "empty-state__title"], [1, "empty-state__subtitle"], ["class", "mt-4 flex justify-center", 4, "ngIf"], [1, "mt-4", "flex", "justify-center"], [1, "overflow-x-auto"], [1, "min-w-full", "divide-y", "divide-gray-200"], [1, "bg-gray-50"], [1, "px-3", "py-2", "text-left", "text-xs", "font-medium", "text-gray-500", "uppercase"], [1, "bg-white", "divide-y", "divide-gray-200"], ["class", "hover:bg-gray-50", 4, "ngFor", "ngForOf"], [1, "hover:bg-gray-50"], [1, "px-3", "py-2", "text-sm", "font-medium", "text-gray-900"], [1, "px-3", "py-2", "text-sm", "text-gray-900"], [1, "font-medium", "capitalize"], [1, "text-xs", "text-gray-500"], [1, "px-3", "py-2", "text-sm"], [1, "px-3", "py-2"], [1, "flex", "items-center", "gap-2", "flex-wrap"], ["class", "inline-flex items-center px-2 py-0.5 rounded-full text-xs font-semibold bg-red-100 text-red-700 border border-red-200", "title", "Vencido", 4, "ngIf"], [1, "px-3", "py-2", "text-sm", "text-gray-600"], [1, "flex", "gap-1.5"], ["class", "action-btn action-btn--blue", 3, "matTooltip", "click", 4, "ngIf"], ["class", "action-btn action-btn--gray", 3, "matTooltip", "click", 4, "ngIf"], ["class", "action-btn action-btn--purple", 3, "matTooltip", "click", 4, "ngIf"], ["class", "action-btn action-btn--amber", 3, "matTooltip", "click", 4, "ngIf"], ["class", "action-btn action-btn--red", 3, "matTooltip", "click", 4, "ngIf"], ["title", "Vencido", 1, "inline-flex", "items-center", "px-2", "py-0.5", "rounded-full", "text-xs", "font-semibold", "bg-red-100", "text-red-700", "border", "border-red-200"], [1, "action-btn", "action-btn--blue", 3, "click", "matTooltip"], [3, "img", "size"], [1, "action-btn", "action-btn--gray", 3, "click", "matTooltip"], [1, "action-btn", "action-btn--purple", 3, "click", "matTooltip"], [1, "action-btn", "action-btn--amber", 3, "click", "matTooltip"], [1, "action-btn", "action-btn--red", 3, "click", "matTooltip"], [1, "payments-pagination"], [1, "flex", "items-center", "gap-1"], ["type", "button", 1, "pagination-btn", 3, "click", "disabled"], [1, "pagination-page"]], template: function ContractHoaPaymentsComponent_Template(rf, ctx) {
    if (rf & 1) {
      ...
      \u0275\u0275elementEnd();
      \u0275\u0275template(4, ContractHoaPaymentsComponent_div_4_Template, 38, 19, "div", 4)(5, ContractHoaPaymentsComponent_div_5_Template, 3, 0, "div", 5)(6, ContractHoaPaymentsComponent_div_6_Template, 8, 3, "div", 6)(7, ContractHoaPaymentsComponent_div_7_Template, 22, 1, "div", 7)(8, ContractHoaPaymentsComponent_div_8_Template, 10, 7, "div", 8);
      \u0275\u0275elementEnd();
    }
    if (rf & 2) {
      \u0275\u0275advance(2);
      \u0275\u0275property("ngIf", ctx.canGeneratePayments);
      \u0275\u0275advance();
...
(() => {
  ...
  <div class="flex items-center justify-end mb-2 gap-2">\r
    <app-button\r
      *ngIf="canGeneratePayments"\r
      text="Generar cuotas HOA"\r
      custom_class="btn_primary"\r
      size="sm"\r
      [icon]="Plus"\r
      [loading]="generating()"\r
...
\r
  <div *ngIf="stats() && !loading()" class="grid grid-cols-5 gap-4 mb-6 w-full">\r
    <div class="bg-gray-50 p-4 rounded-lg border border-gray-200">\r
    ...
    <p class="empty-state__subtitle">\r
      {{\r
        isContractCancelled\r
          ...
          : 'Genera las cuotas HOA para registrar y controlar los cobros mensuales. Disponible en contratos activos y completados.'\r
      }}\r
    </p>\r
    <div *ngIf="canGeneratePayments" class="mt-4 flex justify-center">\r
      <app-button\r
        text="Generar cuotas HOA"\r
        custom_class="btn_primary"\r
        size="sm"\r
  ...
  <div *ngIf="!loading() && payments().length > 0" class="overflow-x-auto">\r
    <table class="min-w-full divide-y divide-gray-200">\r
      <thead class="bg-gray-50">\r
        <tr>\r
          <th class="px-3 py-2 text-left text-xs font-medium text-gray-500 uppercase">#</th>\r
          <th class="px-3 py-2 text-left text-xs font-medium text-gray-500 uppercase">Mes / Vencimiento</th>\r
          <th class="px-3 py-2 text-left text-xs font-medium text-gray-500 uppercase">Monto</th>\r
          <th class="px-3 py-2 text-left text-xs font-medium text-gray-500 uppercase">Pagado</th>\r
          <th class="px-3 py-2 text-left text-xs font-medium text-gray-500 uppercase">Pendiente</th>\r
          <th class="px-3 py-2 text-left text-xs font-medium text-gray-500 uppercase">Estado</th>\r
      ...
      <tbody class="bg-white divide-y divide-gray-200">\r
        <tr *ngFor="let payment of paginatedPayments" class="hover:bg-gray-50">\r
          <td class="px-3 py-2 text-sm font-medium text-gray-900">{{ payment.payment_number }}</td>\r
          <td class="px-3 py-2 text-sm text-gray-900">\r
            <div class="font-medium capitalize">{{ getPaymentMonthLabel(payment) }}</div>\r
            <div class="text-xs text-gray-500">{{ payment.due_date | localDate:'mediumDate' }}</div>\r
          </td>\r
          <td class="px-3 py-2 text-sm text-gray-900">{{ payment.amount | currency:currency }}</td>\r
          <td class="px-3 py-2 text-sm" [class.text-blue-600]="payment.status === 'parcial'" [class.font-medium]="payment.status === 'parcial'">\r
            {{ payment.amount_paid | currency:currency }}\r
          ...
          <td class="px-3 py-2">\r
            <div class="flex items-center gap-2 flex-wrap">\r
              <span [class]="getStatusClass(payment.status)">\r
                {{ getStatusLabel(payment.status) }}\r
              </span>\r
              <span\r
                *ngIf="payment.is_overdue"\r
                class="inline-flex items-center px-2 py-0.5 rounded-full text-xs font-semibold bg-red-100 text-red-700 border border-red-200"\r
                title="Vencido">\r
                Vencido\r
              </span>\r
            </div>\r
            ...
            <div class="flex gap-1.5">\r
              ...
              <button\r
                *ngIf="canResetPayment(payment)"\r
                ...
                [matTooltip]="'Resetear'">\r
                <lucide-icon [img]="RotateCcw" [size]="16"></lucide-icon>\r
              </button>\r
              <button\r
                *ngIf="canCancelPayment(payment)"\r
                (click)="cancelPayment(payment)"\r
                class="action-btn action-btn--amber"\r
                [matTooltip]="'Cancelar'">\r
                <lucide-icon [img]="X" [size]="16"></lucide-icon>\r
              </button>\r
              <button\r
                *ngIf="canDeletePayment(payment)"\r
...
var EditDownpaymentPaymentModalComponent = class _EditDownpaymentPaymentModalComponent {
  ...
  save() {
    ...
    const amountPaid = amountPaidRaw === "" || amountPaidRaw == null ? void 0 : Number(amountPaidRaw);
  ...
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _EditDownpaymentPaymentModalComponent, selectors: [["app-edit-downpayment-payment-modal"]], decls: 32, vars: 14, consts: [[1, "dialog-container"], [1, "dialog-header"], [1, "dialog-title"], ["type", "button", "aria-label", "Cerrar", 1, "close-button", 3, "click"], [3, "img", "size"], [1, "dialog-content", 3, "formGroup"], [1, "mb-3", "p-2", "bg-blue-50", "rounded-lg", "border", "border-blue-200"], [1, "text-sm", "text-blue-900"], [1, "font-semibold"], [1, "space-y-4"], ["label", "Monto *", "type", "number", 3, "form_control"], ["label", "Vencimiento", "type", "date", 3, "form_control"], ["label", "Monto pagado", "type", "number", 3, "form_control"], [1, "block", "text-sm", "font-medium", "text-gray-700", "mb-1"], [3, "config"], ["formControlName", "notes", "rows", "3", "placeholder", "Notas adicionales sobre la cuota...", 1, "w-full", "px-3", "py-2", "border", "border-gray-300", "rounded-lg", "focus:ring-2", "focus:ring-blue-500", "focus:border-transparent"], [1, "dialog-footer"], ["text", "Cancelar", "custom_class", "btn_secondary", 3, "clicked"], ["text", "Guardar Cambios", "custom_class", "btn_primary", 3, "clicked", "loading"]], template: function EditDownpaymentPaymentModalComponent_Template(rf, ctx) {
    if (rf & 1) {
      \u0275\u0275elementStart(0, "div", 0)(1, "div", 1)(2, "h2", 2);
      \u0275\u0275text(3);
      \u0275\u0275elementEnd();
      ...
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(31, "app-button", 18);
      \u0275\u0275listener("clicked", function EditDownpaymentPaymentModalComponent_Template_app_button_clicked_31_listener() {
        return ctx.save();
      });
      \u0275\u0275elementEnd()()();
    }
    if (rf & 2) {
      \u0275\u0275advance(3);
      \u0275\u0275textInterpolate1("Editar cuota #", ctx.data.payment.payment_number);
      \u0275\u0275advance(2);
      \u0275\u0275property("img", ctx.X)("size", 20);
      \u0275\u0275advance();
      \u0275\u0275property("formGroup", ctx.form);
      ...
      \u0275\u0275textInterpolate1(" ", ctx.data.payment.status);
      \u0275\u0275advance(4);
      \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind2(16, 11, ctx.data.payment.amount_paid, ctx.data.currency), " ");
      \u0275\u0275advance(3);
      \u0275\u0275property("form_control", ctx.form.controls["amount"]);
      \u0275\u0275advance();
      \u0275\u0275property("form_control", ctx.form.controls["due_date"]);
      \u0275\u0275advance();
      \u0275\u0275property("form_control", ctx.form.controls["amount_paid"]);
...
(() => {
  ...
  <div class="dialog-header">\r
    <h2 class="dialog-title">Editar cuota #{{ data.payment.payment_number }}</h2>\r
    <button type="button" (click)="close()" class="close-button" aria-label="Cerrar">\r
      <lucide-icon [img]="X" [size]="20"></lucide-icon>\r
    </button>\r
  </div>\r
\r
  <div class="dialog-content" [formGroup]="form">\r
    <div class="mb-3 p-2 bg-blue-50 rounded-lg border border-blue-200">\r
      <p class="text-sm text-blue-900"><span class="font-semibold">Estado:</span> {{ data.payment.status }}</p>\r
      <p class="text-sm text-blue-900">\r
        <span class="font-semibold">Pagado actual:</span>\r
        {{ data.payment.amount_paid | currency:data.currency }}\r
      </p>\r
    </div>\r
\r
    <div class="space-y-4">\r
      <app-input label="Monto *" type="number" [form_control]="form.controls['amount']"></app-input>\r
\r
      <app-input label="Vencimiento" type="date" [form_control]="form.controls['due_date']"></app-input>\r
\r
      <app-input label="Monto pagado" type="number" [form_control]="form.controls['amount_paid']"></app-input>\r
\r
      <div>\r
        <label class="block text-sm font-medium text-gray-700 mb-1">M\xE9todo de pago</label>\r
        <app-select [config]="paymentMethodSelectConfig"></app-select>\r
      </div>\r
\r
      <div>\r
        ...
        <textarea\r
          ...
          rows="3"\r
          class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent"\r
          placeholder="Notas adicionales sobre la cuota..."></textarea>\r
      </div>\r
    </div>\r
  </div>\r
\r
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(EditDownpaymentPaymentModalComponent, { className: "EditDownpaymentPaymentModalComponent", filePath: "src/app/features/contracts/components/edit-downpayment-payment-modal/edit-downpayment-payment-modal.component.ts", lineNumber: 28 });
})();
...
// src/app/features/contracts/components/edit-downpayment-target-modal/edit-downpayment-target-modal.component.ts
var EditDownpaymentTargetModalComponent = class _EditDownpaymentTargetModalComponent {
  data;
  dialogRef;
  fb;
  downpaymentService;
  ...
  static \u0275fac = function EditDownpaymentTargetModalComponent_Factory(__ngFactoryType__) {
    return new (__ngFactoryType__ || _EditDownpaymentTargetModalComponent)(\u0275\u0275directiveInject(MAT_DIALOG_DATA), \u0275\u0275directiveInject(MatDialogRef), \u0275\u0275directiveInject(FormBuilder), \u0275\u0275directiveInject(DownpaymentPaymentService), \u0275\u0275directiveInject(InterceptorService));
  };
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _EditDownpaymentTargetModalComponent, selectors: [["app-edit-downpayment-target-modal"]], decls: 18, vars: 9, consts: [[1, "dialog-container"], [1, "dialog-header"], [1, "dialog-title"], ["type", "button", "aria-label", "Cerrar", 1, "close-button", 3, "click"], [3, "img", "size"], [1, "dialog-content", 3, "formGroup"], [1, "help-text"], [1, "applied-text"], ["label", "Meta de enganche *", "type", "number", 3, "form_control"], [1, "dialog-footer"], ["text", "Cancelar", "custom_class", "btn_secondary", 3, "clicked"], ["text", "Guardar", "custom_class", "btn_primary", 3, "clicked", "loading"]], template: function EditDownpaymentTargetModalComponent_Template(rf, ctx) {
    if (rf & 1) {
      \u0275\u0275elementStart(0, "div", 0)(1, "div", 1)(2, "h2", 2);
      \u0275\u0275text(3, "Editar meta de enganche");
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(4, "button", 3);
      \u0275\u0275listener("click", function EditDownpaymentTargetModalComponent_Template_button_click_4_listener() {
        return ctx.close();
      });
      \u0275\u0275element(5, "lucide-icon", 4);
      \u0275\u0275elementEnd()();
      \u0275\u0275elementStart(6, "div", 5)(7, "p", 6);
      \u0275\u0275text(8, " Esta meta define el pago mensual del contrato: (precio total \u2212 meta) / meses. ");
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(9, "p", 7);
      \u0275\u0275text(10, " Abonado hasta ahora: ");
      \u0275\u0275elementStart(11, "strong");
      \u0275\u0275text(12);
      \u0275\u0275pipe(13, "currency");
      \u0275\u0275elementEnd()();
      \u0275\u0275element(14, "app-input", 8);
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(15, "div", 9)(16, "app-button", 10);
      \u0275\u0275listener("clicked", function EditDownpaymentTargetModalComponent_Template_app_button_clicked_16_listener() {
        return ctx.close();
      });
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(17, "app-button", 11);
      \u0275\u0275listener("clicked", function EditDownpaymentTargetModalComponent_Template_app_button_clicked_17_listener() {
        return ctx.save();
      });
      \u0275\u0275elementEnd()()();
    }
    if (rf & 2) {
      ...
      \u0275\u0275property("formGroup", ctx.form);
      \u0275\u0275advance(6);
      \u0275\u0275textInterpolate(\u0275\u0275pipeBind2(13, 6, ctx.data.appliedAmount, ctx.data.currency));
      \u0275\u0275advance(2);
      \u0275\u0275property("form_control", ctx.form.controls["down_payment_target"]);
      \u0275\u0275advance(3);
      \u0275\u0275property("loading", ctx.saving());
    }
  }, dependencies: [
    ...
    LucideAngularComponent,
    CurrencyPipe
  ], styles: ["\n\n.dialog-container[_ngcontent-%COMP%] {\n  display: flex;\n  flex-direction: column;\n  max-height: 90vh;\n  width: 100%;\n  max-width: 420px;\n}\n.dialog-header[_ngcontent-%COMP%] {\n  display: flex;\n  justify-content: space-between;\n  align-items: center;\n  padding: 1.25rem 1.5rem;\n  border-bottom: 1px solid #e5e7eb;\n}\n.dialog-title[_ngcontent-%COMP%] {\n  font-size: 1.125rem;\n  font-weight: 600;\n  color: #111827;\n  margin: 0;\n}\n.close-button[_ngcontent-%COMP%] {\n  background: none;\n  border: none;\n  cursor: pointer;\n  color: #6b7280;\n  padding: 0.5rem;\n  border-radius: 0.375rem;\n}\n.close-button[_ngcontent-%COMP%]:hover {\n  background-color: #f3f4f6;\n  color: #111827;\n}\n.dialog-content[_ngcontent-%COMP%] {\n  padding: 1.5rem;\n}\n.help-text[_ngcontent-%COMP%] {\n  margin: 0 0 0.75rem;\n  font-size: 0.8125rem;\n  color: #6b7280;\n  line-height: 1.45;\n}\n.applied-text[_ngcontent-%COMP%] {\n  margin: 0 0 1rem;\n  font-size: 0.875rem;\n  color: #374151;\n}\n.dialog-footer[_ngcontent-%COMP%] {\n  display: flex;\n  justify-content: flex-end;\n  gap: 0.75rem;\n  padding: 1.25rem 1.5rem;\n  border-top: 1px solid #e5e7eb;\n}\n@media (max-width: 639px) {\n  .dialog-container[_ngcontent-%COMP%] {\n    max-width: 100%;\n  }\n  .dialog-footer[_ngcontent-%COMP%] {\n    flex-direction: column-reverse;\n  }\n  .dialog-footer[_ngcontent-%COMP%]   app-button[_ngcontent-%COMP%] {\n    width: 100%;\n  }\n}\n/*# sourceMappingURL=edit-downpayment-target-modal.component.css.map */"] });
};
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && setClassMetadata(EditDownpaymentTargetModalComponent, [{
    type: Component,
    args: [{ selector: "app-edit-downpayment-target-modal", standalone: true, imports: [
      CommonModule,
      ReactiveFormsModule,
      MatDialogModule,
      ButtonComponent,
  ...
  <div class="dialog-header">\r
    <h2 class="dialog-title">Editar meta de enganche</h2>\r
    <button type="button" (click)="close()" class="close-button" aria-label="Cerrar">\r
      <lucide-icon [img]="X" [size]="20"></lucide-icon>\r
    </button>\r
  </div>\r
\r
  <div class="dialog-content" [formGroup]="form">\r
    <p class="help-text">\r
      Esta meta define el pago mensual del contrato: (precio total \u2212 meta) / meses.\r
    </p>\r
    <p class="applied-text">\r
      Abonado hasta ahora: <strong>{{ data.appliedAmount | currency:data.currency }}</strong>\r
    </p>\r
\r
    <app-input\r
      label="Meta de enganche *"\r
      type="number"\r
      [form_control]="form.controls['down_payment_target']">\r
    </app-input>\r
  </div>\r
\r
  <div class="dialog-footer">\r
...
`, styles: ["/* src/app/features/contracts/components/edit-downpayment-target-modal/edit-downpayment-target-modal.component.scss */\n.dialog-container {\n  display: flex;\n  flex-direction: column;\n  max-height: 90vh;\n  width: 100%;\n  max-width: 420px;\n}\n.dialog-header {\n  display: flex;\n  justify-content: space-between;\n  align-items: center;\n  padding: 1.25rem 1.5rem;\n  border-bottom: 1px solid #e5e7eb;\n}\n.dialog-title {\n  font-size: 1.125rem;\n  font-weight: 600;\n  color: #111827;\n  margin: 0;\n}\n.close-button {\n  background: none;\n  border: none;\n  cursor: pointer;\n  color: #6b7280;\n  padding: 0.5rem;\n  border-radius: 0.375rem;\n}\n.close-button:hover {\n  background-color: #f3f4f6;\n  color: #111827;\n}\n.dialog-content {\n  padding: 1.5rem;\n}\n.help-text {\n  margin: 0 0 0.75rem;\n  font-size: 0.8125rem;\n  color: #6b7280;\n  line-height: 1.45;\n}\n.applied-text {\n  margin: 0 0 1rem;\n  font-size: 0.875rem;\n  color: #374151;\n}\n.dialog-footer {\n  display: flex;\n  justify-content: flex-end;\n  gap: 0.75rem;\n  padding: 1.25rem 1.5rem;\n  border-top: 1px solid #e5e7eb;\n}\n@media (max-width: 639px) {\n  .dialog-container {\n    max-width: 100%;\n  }\n  .dialog-footer {\n    flex-direction: column-reverse;\n  }\n  .dialog-footer app-button {\n    width: 100%;\n  }\n}\n/*# sourceMappingURL=edit-downpayment-target-modal.component.css.map */\n"] }]
  }], () => [{ type: void 0, decorators: [{
    type: Inject,
    args: [MAT_DIALOG_DATA]
  }] }, { type: MatDialogRef }, { type: FormBuilder }, { type: DownpaymentPaymentService }, { type: InterceptorService }], null);
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(EditDownpaymentTargetModalComponent, { className: "EditDownpaymentTargetModalComponent", filePath: "src/app/features/contracts/components/edit-downpayment-target-modal/edit-downpayment-target-modal.component.ts", lineNumber: 25 });
})();
...
function ContractDownpaymentPaymentsComponent_div_5_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275listener("click", function ContractDownpaymentPaymentsComponent_div_5_Template_button_click_1_listener() {
      \u0275\u0275restoreView(_r4);
      const ctx_r1 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r1.editTarget());
    });
    \u0275\u0275elementStart(2, "div", 19)(3, "p", 20);
    \u0275\u0275text(4, "Meta de enganche");
    \u0275\u0275elementEnd();
    \u0275\u0275element(5, "lucide-icon", 21);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(6, "p", 22);
    \u0275\u0275text(7);
    \u0275\u0275pipe(8, "currency");
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(9, "div", 23)(10, "p", 24);
    \u0275\u0275text(11, "Abonado");
    \u0275\u0275elementEnd();
    ...
    \u0275\u0275text(17, "Pendiente de meta");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(18, "p", 28);
    \u0275\u0275text(19);
    \u0275\u0275pipe(20, "currency");
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(21, "div", 29)(22, "p", 30);
    \u0275\u0275text(23, "Estado");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(24, "p", 31);
    \u0275\u0275text(25);
    \u0275\u0275elementEnd()()();
  }
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext();
    \u0275\u0275advance();
    \u0275\u0275property("matTooltip", "Editar meta de enganche");
    \u0275\u0275advance(4);
    \u0275\u0275property("img", ctx_r1.Pencil)("size", 14);
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate1(" ", ctx_r1.targetAmount != null ? \u0275\u0275pipeBind2(8, 7, ctx_r1.targetAmount, ctx_r1.currency) : "Sin definir", " ");
    \u0275\u0275advance(6);
    \u0275\u0275textInterpolate(\u0275\u0275pipeBind2(14, 10, ctx_r1.appliedAmount, ctx_r1.currency));
    \u0275\u0275advance(6);
    \u0275\u0275textInterpolate1(" ", ctx_r1.pendingAmount != null ? \u0275\u0275pipeBind2(20, 13, ctx_r1.pendingAmount, ctx_r1.currency) : "\u2014", " ");
    \u0275\u0275advance(6);
    \u0275\u0275textInterpolate(ctx_r1.financingStatusLabel);
  }
}
function ContractDownpaymentPaymentsComponent_div_6_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275text(10);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(11, "div", 39)(12, "p", 40);
    \u0275\u0275text(13, "Parciales");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(14, "p", 41);
    \u0275\u0275text(15);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(16, "div", 42)(17, "p", 43);
    \u0275\u0275text(18, "Pendientes");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(19, "p", 44);
    \u0275\u0275text(20);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(21, "div", 45)(22, "p", 46);
    \u0275\u0275text(23, "Vencidos");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(24, "p", 47);
    \u0275\u0275text(25);
    \u0275\u0275elementEnd()()();
  }
  if (rf & 2) {
...
function ContractDownpaymentPaymentsComponent_div_9_tr_23_button_25_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275listener("click", function ContractDownpaymentPaymentsComponent_div_9_tr_23_button_25_Template_button_click_0_listener() {
      \u0275\u0275restoreView(_r6);
      const payment_r7 = \u0275\u0275nextContext().$implicit;
      const ctx_r1 = \u0275\u0275nextContext(2);
      return \u0275\u0275resetView(ctx_r1.registerPayment(payment_r7));
    });
...
function ContractDownpaymentPaymentsComponent_div_9_tr_23_button_26_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275listener("click", function ContractDownpaymentPaymentsComponent_div_9_tr_23_button_26_Template_button_click_0_listener() {
      ...
      const payment_r7 = \u0275\u0275nextContext().$implicit;
      const ctx_r1 = \u0275\u0275nextContext(2);
      return \u0275\u0275resetView(ctx_r1.editPayment(payment_r7));
    });
    \u0275\u0275element(1, "lucide-icon", 67);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext(3);
    \u0275\u0275property("matTooltip", "Editar cuota");
    \u0275\u0275advance();
    \u0275\u0275property("img", ctx_r1.Edit)("size", 16);
  }
}
function ContractDownpaymentPaymentsComponent_div_9_tr_23_button_27_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275listener("click", function ContractDownpaymentPaymentsComponent_div_9_tr_23_button_27_Template_button_click_0_listener() {
      ...
      const payment_r7 = \u0275\u0275nextContext().$implicit;
      const ctx_r1 = \u0275\u0275nextContext(2);
      return \u0275\u0275resetView(ctx_r1.resetPayment(payment_r7));
    });
    \u0275\u0275element(1, "lucide-icon", 67);
    \u0275\u0275elementEnd();
  }
...
function ContractDownpaymentPaymentsComponent_div_9_tr_23_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275pipe(17, "localDate");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(18, "td", 61)(19, "span");
    \u0275\u0275text(20);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(21, "td", 60);
    \u0275\u0275text(22);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(23, "td", 61)(24, "div", 62);
    \u0275\u0275template(25, ContractDownpaymentPaymentsComponent_div_9_tr_23_button_25_Template, 2, 3, "button", 63)(26, ContractDownpaymentPaymentsComponent_div_9_tr_23_button_26_Template, 2, 3, "button", 64)(27, ContractDownpaymentPaymentsComponent_div_9_tr_23_button_27_Template, 2, 3, "button", 65);
    ...
    \u0275\u0275listener("click", function ContractDownpaymentPaymentsComponent_div_9_tr_23_Template_button_click_28_listener() {
      const payment_r7 = \u0275\u0275restoreView(_r5).$implicit;
      const ctx_r1 = \u0275\u0275nextContext(2);
      return \u0275\u0275resetView(ctx_r1.cancelPayment(payment_r7));
    });
    \u0275\u0275element(29, "lucide-icon", 67);
    \u0275\u0275elementEnd();
    ...
    \u0275\u0275listener("click", function ContractDownpaymentPaymentsComponent_div_9_tr_23_Template_button_click_30_listener() {
      const payment_r7 = \u0275\u0275restoreView(_r5).$implicit;
      const ctx_r1 = \u0275\u0275nextContext(2);
      return \u0275\u0275resetView(ctx_r1.deletePayment(payment_r7));
    });
    \u0275\u0275element(31, "lucide-icon", 67);
    \u0275\u0275elementEnd()()()();
  }
  if (rf & 2) {
    ...
    const ctx_r1 = \u0275\u0275nextContext(2);
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate(payment_r7.payment_number);
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate(\u0275\u0275pipeBind2(5, 19, payment_r7.amount, ctx_r1.currency));
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate(\u0275\u0275pipeBind2(8, 22, payment_r7.amount_paid, ctx_r1.currency));
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate(\u0275\u0275pipeBind2(11, 25, payment_r7.amount_pending, ctx_r1.currency));
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate(\u0275\u0275pipeBind2(14, 28, payment_r7.due_date, "mediumDate"));
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate(payment_r7.paid_date ? \u0275\u0275pipeBind2(17, 31, payment_r7.paid_date, "mediumDate") : "\u2014");
    \u0275\u0275advance(3);
    \u0275\u0275classMap(ctx_r1.getStatusClass(payment_r7.status, payment_r7.is_overdue));
    \u0275\u0275advance();
    \u0275\u0275textInterpolate1(" ", ctx_r1.getStatusLabel(payment_r7.status, payment_r7.is_overdue), " ");
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate(payment_r7.payment_method || "\u2014");
    \u0275\u0275advance(3);
    \u0275\u0275property("ngIf", ctx_r1.canRegisterPayment(payment_r7));
    \u0275\u0275advance();
    \u0275\u0275property("ngIf", ctx_r1.canEdit(payment_r7));
    \u0275\u0275advance();
    \u0275\u0275property("ngIf", ctx_r1.canResetPayment(payment_r7));
    \u0275\u0275advance();
...
function ContractDownpaymentPaymentsComponent_div_9_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 51)(1, "table", 52)(2, "thead", 53)(3, "tr")(4, "th", 54);
    \u0275\u0275text(5, "#");
    \u0275\u0275elementEnd();
    ...
    \u0275\u0275text(15, "Fecha Pago");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(16, "th", 54);
    \u0275\u0275text(17, "Estado");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(18, "th", 54);
    \u0275\u0275text(19, "M\xE9todo");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(20, "th", 54);
    \u0275\u0275text(21, "Acciones");
    \u0275\u0275elementEnd()()();
    \u0275\u0275elementStart(22, "tbody", 55);
    \u0275\u0275template(23, ContractDownpaymentPaymentsComponent_div_9_tr_23_Template, 32, 34, "tr", 56);
    \u0275\u0275elementEnd()()();
  }
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext();
...
\r
  <div *ngIf="isFinanced" class="mb-4 grid grid-cols-2 md:grid-cols-4 gap-3">\r
    <button\r
      type="button"\r
      class="stat-card stat-card--editable"\r
      (click)="editTarget()"\r
      [matTooltip]="'Editar meta de enganche'"\r
      matTooltipPosition="above">\r
      <div class="stat-card__header">\r
        <p class="text-xs font-medium text-amber-700">Meta de enganche</p>\r
        <lucide-icon [img]="Pencil" [size]="14" class="stat-card__edit-icon"></lucide-icon>\r
      </div>\r
    ...
    <div class="bg-blue-50 p-3 rounded-lg border border-blue-200">\r
      ...
      <p class="text-lg font-bold text-blue-800 mt-1">\r
        {{ pendingAmount != null ? (pendingAmount | currency:currency) : '\u2014' }}\r
      </p>\r
    </div>\r
    <div class="bg-gray-50 p-3 rounded-lg border border-gray-200">\r
      <p class="text-xs font-medium text-gray-600">Estado</p>\r
      <p class="text-sm font-semibold text-gray-900 mt-1">{{ financingStatusLabel }}</p>\r
    </div>\r
  </div>\r
\r
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(ContractDownpaymentPaymentsComponent, { className: "ContractDownpaymentPaymentsComponent", filePath: "src/app/features/contracts/components/contract-downpayment-payments/contract-downpayment-payments.component.ts", lineNumber: 25 });
})();
...
//# sourceMappingURL=chunk-C3CATDP4.js.map
