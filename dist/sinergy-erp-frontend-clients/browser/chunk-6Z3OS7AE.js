...
import "./chunk-I62MUB3O.js";
import {
  MatOption
} from "./chunk-TRKRWHC4.js";
import {
  SearchComponent
} from "./chunk-GGN2G6ME.js";
import {
  DatatableWrapperComponent
} from "./chunk-QC5NG4X3.js";
import "./chunk-RWWGQKW7.js";
import {
  SelectComponent
...
function ContractCreateModalComponent_Conditional_69_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 38);
    \u0275\u0275element(1, "app-input", 33)(2, "app-input", 33)(3, "app-input", 32);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    const ctx_r3 = \u0275\u0275nextContext();
    \u0275\u0275advance();
    \u0275\u0275property("label", "Meses de enganche *")("placeholder", "Ej. 10")("form_control", ctx_r3.form.get("down_payment_months"))("type", "number");
    \u0275\u0275advance();
    \u0275\u0275property("label", "D\xEDa de pago mensual (enganche) *")("placeholder", "1\u201331")("form_control", ctx_r3.form.get("down_payment_payment_day"))("type", "number");
    \u0275\u0275advance();
    \u0275\u0275property("label", "Fecha primer pago de enganche *")("form_control", ctx_r3.form.get("down_payment_first_payment_date"))("type", "date");
  }
}
...
var ContractCreateModalComponent = class _ContractCreateModalComponent {
    ...
    const apply = (isFinanced) => {
      if (isFinanced) {
        ...
        if (day.value == null && this.form.get("first_payment_date")?.value) {
          const d = new Date(this.form.get("first_payment_date").value);
  ...
  submit() {
    ...
    if (downPaymentFinanced) {
      ...
      payload.down_payment_months = Math.max(1, Math.round(Number(this.form.get("down_payment_months").value)));
  ...
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _ContractCreateModalComponent, selectors: [["app-contract-create-modal"]], viewQuery: function ContractCreateModalComponent_Query(rf, ctx) {
    ...
    if (rf & 1) {
      ...
      \u0275\u0275text(66, "Financiar enganche en pagos");
      \u0275\u0275elementEnd()();
      \u0275\u0275elementStart(67, "p", 37);
      \u0275\u0275text(68, " El enganche se divide en cuotas separadas del plan normal. No enviamos el monto mensual de enganche: lo calcula el backend al guardar. ");
      \u0275\u0275elementEnd();
      \u0275\u0275conditionalCreate(69, ContractCreateModalComponent_Conditional_69_Template, 4, 11, "div", 38);
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(70, "div", 39)(71, "label", 40);
      \u0275\u0275text(72, " Saldo Pendiente ");
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(73, "div", 41);
      \u0275\u0275text(74);
      \u0275\u0275elementEnd()();
      \u0275\u0275element(75, "app-input", 33);
      \u0275\u0275elementStart(76, "div", 39)(77, "label", 40);
      \u0275\u0275text(78, " Pago Mensual ");
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(79, "div", 41);
      \u0275\u0275text(80);
      \u0275\u0275elementEnd()();
      \u0275\u0275element(81, "app-input", 32)(82, "app-select", 42)(83, "app-select", 42);
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(84, "div", 43);
      \u0275\u0275element(85, "app-input", 33);
      \u0275\u0275elementEnd()()()();
      \u0275\u0275elementStart(86, "div", 44)(87, "app-button", 24);
      \u0275\u0275listener("clicked", function ContractCreateModalComponent_Template_app_button_clicked_87_listener() {
        \u0275\u0275restoreView(_r1);
        return \u0275\u0275resetView(ctx.close());
      });
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(88, "app-button", 45);
      \u0275\u0275listener("clicked", function ContractCreateModalComponent_Template_app_button_clicked_88_listener() {
        \u0275\u0275restoreView(_r1);
    ...
    if (rf & 2) {
      ...
      \u0275\u0275advance();
      \u0275\u0275property("label", "Enganche *")("placeholder", "Ej. 0 o 36,000")("form_control", ctx.form.get("down_payment"))("type", "text");
      \u0275\u0275advance(8);
      \u0275\u0275conditional(((tmp_47_0 = ctx.form.get("down_payment_financed")) == null ? null : tmp_47_0.value) ? 69 : -1);
      \u0275\u0275advance(5);
...
\r
          <div class="col-span-2 downpayment-financing">\r
            ...
            <p class="financing-hint">\r
              El enganche se divide en cuotas separadas del plan normal. No enviamos el monto mensual de enganche: lo calcula el backend al guardar.\r
            </p>\r
            @if (form.get('down_payment_financed')?.value) {\r
              <div class="grid grid-cols-2 gap-4 mt-4">\r
                <app-input\r
                  [label]="'Meses de enganche *'"\r
                  [placeholder]="'Ej. 10'"\r
                  [form_control]="form.get('down_payment_months')"\r
                  [type]="'number'">\r
                </app-input>\r
                <app-input\r
                  [label]="'D\xEDa de pago mensual (enganche) *'"\r
                  [placeholder]="'1\u201331'"\r
                  [form_control]="form.get('down_payment_payment_day')"\r
                  [type]="'number'">\r
                </app-input>\r
                <app-input\r
                  [label]="'Fecha primer pago de enganche *'"\r
                  [form_control]="form.get('down_payment_first_payment_date')"\r
                  [type]="'date'">\r
                </app-input>\r
              </div>\r
            }\r
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(ContractCreateModalComponent, { className: "ContractCreateModalComponent", filePath: "src/app/features/contracts/components/contract-create-modal/contract-create-modal.component.ts", lineNumber: 79 });
})();
...
function ContractsListComponent_div_9_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275listener("click", function ContractsListComponent_div_9_Template_button_click_1_listener() {
      \u0275\u0275restoreView(_r2);
    ...
    \u0275\u0275listener("click", function ContractsListComponent_div_9_Template_button_click_13_listener() {
      \u0275\u0275restoreView(_r2);
      const ctx_r2 = \u0275\u0275nextContext();
    ...
    \u0275\u0275listener("click", function ContractsListComponent_div_9_Template_button_click_25_listener() {
      \u0275\u0275restoreView(_r2);
      const ctx_r2 = \u0275\u0275nextContext();
    ...
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(31, "div", 16)(32, "p", 17);
    \u0275\u0275text(33);
    \u0275\u0275pipe(34, "currency");
    \u0275\u0275elementEnd();
    ...
    \u0275\u0275listener("click", function ContractsListComponent_div_9_Template_button_click_48_listener() {
      \u0275\u0275restoreView(_r2);
      const ctx_r2 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r2.applyFilter("overdue"));
    });
    \u0275\u0275elementStart(49, "div", 13)(50, "p", 14);
    \u0275\u0275text(51, "Vencidos");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(52, "p", 15);
    \u0275\u0275text(53, "Con pagos atrasados");
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(54, "div", 16)(55, "p", 17);
    \u0275\u0275text(56);
    \u0275\u0275pipe(57, "currency");
    \u0275\u0275elementEnd();
...
function ContractsListComponent_ng_template_11_div_23_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275template(2, ContractsListComponent_ng_template_11_div_23_span_2_Template, 2, 1, "span", 38);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    const item_r6 = \u0275\u0275nextContext().$implicit;
...
function ContractsListComponent_ng_template_11_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275elementStart(0, "td")(1, "span", 25);
    \u0275\u0275text(2);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(3, "td");
    \u0275\u0275template(4, ContractsListComponent_ng_template_11_span_4_Template, 2, 2, "span", 26)(5, ContractsListComponent_ng_template_11_span_5_Template, 2, 0, "span", 27);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(6, "td");
    \u0275\u0275template(7, ContractsListComponent_ng_template_11_span_7_Template, 2, 1, "span", 28)(8, ContractsListComponent_ng_template_11_span_8_Template, 2, 0, "span", 27);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(9, "td");
    \u0275\u0275text(10);
    \u0275\u0275pipe(11, "date");
    ...
    \u0275\u0275pipe(17, "currency");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(18, "td")(19, "div", 29)(20, "span");
    \u0275\u0275text(21);
    \u0275\u0275pipe(22, "date");
    \u0275\u0275elementEnd();
    \u0275\u0275template(23, ContractsListComponent_ng_template_11_div_23_Template, 3, 3, "div", 30);
    \u0275\u0275elementEnd()();
    ...
    \u0275\u0275elementStart(28, "app-button", 32);
...
var ContractsListComponent = class _ContractsListComponent {
  ...
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _ContractsListComponent, selectors: [["app-contracts-list"]], viewQuery: function ContractsListComponent_Query(rf, ctx) {
    ...
    if (rf & 1) {
      ...
      \u0275\u0275elementEnd();
      \u0275\u0275template(9, ContractsListComponent_div_9_Template, 69, 50, "div", 9);
...
//# sourceMappingURL=chunk-6Z3OS7AE.js.map
