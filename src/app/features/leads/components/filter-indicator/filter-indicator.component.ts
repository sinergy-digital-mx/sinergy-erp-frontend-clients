...
export class FilterIndicatorComponent {
  @Input() activeStatusFilter: CommunicationStatus | null = null;
  @Input() activeGroupId: string | null = null;
  @Input() activeGroupName: string | null = null;
  @Output() filterClear = new EventEmitter<'status' | 'group' | 'all'>();
   ...
   */
  clearFilter(filterType: 'status' | 'group') {
   ...
   */
  getFilterIcon(filterType: 'status' | 'group'): string {
